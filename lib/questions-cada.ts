...
export const cadaQuestions: {
  ...
  },
  {
    ...
    options: [
      ...
      'It costs more height than most pilots expect, often 300–700 ft or more for the turn',
  ...
  },
  {
    ...
    options: [
      'Produce less drag, because a turning propeller slices through the air more cleanly',
      'Have no effect on the glide, a propeller only matters when it is producing thrust',
      'Produce more drag, steepening the glide and reducing the distance achieved',
      'Reduce the stalling speed by adding a lifting force ahead of the wing',
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      'Absorb more power for a given diameter, at a small cost in peak efficiency',
      'Produce less thrust, because each narrower blade is structurally weaker',
      'Turn at a much higher RPM with no change in the power it can absorb',
      'Remove the slipstream effect acting on the fin and rudder',
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
      'Increases, so the wing can be held at a much higher attitude before it stalls',
      'Decreases, so the flapped wing reaches its stalling angle at a lower angle of attack',
      'Stays exactly the same, flap changes the lift but never the stalling angle',
      'Falls to zero, a flapped wing cannot be stalled at any attitude',
    ],
    correct: 1,
