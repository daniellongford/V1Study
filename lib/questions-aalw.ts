...

{
  ...
  options: [
    'A. Pilot in command of any aircraft engaged in air transport operations only',
    ...
    'C. Pilot in command of multi-engine aeroplanes above 5,700 kg MTOW only',
...

{
  ...
  options: [
    ...
    'C. CASA approval on a case by case basis for each operation',
...

{
  ...
  options: [
    'A. Only act as co-pilot on aircraft not exceeding 5,700 kg MTOW',
...

{
  ...
  options: [
    ...
    'B. Acting as PIC on any RPT operation carrying passengers',
    'C. Acting as PIC only — a Class 2 medical is sufficient for co-pilot operations',
    'D. Flying aircraft above 5,700 kg MTOW regardless of the role'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Every 2 years by passing a written examination',
...

{
  ...
  options: [
    'A. Obtain an ATPL type rating for the A320 from CASA',
...

{
  ...
  options: [
    'A. An ATPL automatically grants all lower privileges including single pilot operations — this does not reflect the correct Australian regulatory position',
    'B. A separate single-pilot endorsement must be added to the ATPL for solo operations — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. An ATPL holder cannot legally fly as sole pilot — they must always have a co-pilot — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. 1,500 hours total time including 500 hours cross-country and 100 hours night — this does not reflect the correct Australian regulatory position',
    'B. 1,000 hours total including 250 hours on multi-engine types according to CASR and applicable CAO requirements',
    'C. 3,000 hours total time of which 1,500 hours must be on multi-crew operations as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'C. Pass a written examination on the B737 systems and limitations',
...

{
  ...
  options: [
    'A. An annual theoretical examination on the aircraft type and company procedures — this does not reflect the correct Australian regulatory position',
    ...
    'C. A simulator check focusing on emergency procedures and abnormal operations according to CASR and applicable CAO requirements',
    'D. A check conducted by CASA on a random basis to ensure operational standards as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Not permitted — type ratings are operator-specific under CASR Part 121 — this does not reflect the correct Australian regulatory position',
    'C. Permitted only with written approval from CASA — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Permitted only if the leave period does not exceed 28 days — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. No additional rating — the ATPL covers all aeroplanes',
    'C. A separate CPL(A) with a single-engine rating — the ATPL only covers multi-engine types',
    'D. A Class 3 command check with a Grade 1 Flight Instructor'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Conducting the flight under the IFR — ATPL privileges are IFR only — this does not reflect the correct Australian regulatory position',
    'B. The aircraft is operated by an AOC holder — private ATPL operations with passengers are prohibited according to CASR and applicable CAO requirements',
    'C. The pilot has logged at least 100 hours in the preceding 12 months as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Continue to act as co-pilot provided the other pilot holds an ATPL — this does not reflect the correct Australian regulatory position',
    'B. Continue to conduct simulator training only as this does not involve actual flight according to CASR and applicable CAO requirements',
    'C. Act as an observer on the flight deck but not as an active crew member as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'B. Conducting a single touch-and-go landing to demonstrate currency — this does not reflect the correct Australian regulatory position',
    'C. Completing a full proficiency check with a Type Rating Examiner according to CASR and applicable CAO requirements',
    'D. Flying 3 hours on the type to restore all recency requirements as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Only a current ATPL — no additional ratings are needed to conduct simulator training — this does not reflect the correct Australian regulatory position',
    'B. A Grade 1 Flight Instructor Rating and a type rating examiner authority according to CASR and applicable CAO requirements',
    'C. A Class 1 medical even when conducting simulator-only duties as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Remains valid for an additional 30-day grace period after the due date',
...

{
  ...
  options: [
    'A. Declare an emergency and land at the nearest aerodrome regardless of fuel state — this does not reflect the correct Australian regulatory position',
    ...
    'C. Contact company operations before taking any action to change the flight plan according to CASR and applicable CAO requirements',
    'D. Transfer PIC responsibilities to the senior cabin crew member while contacting company as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'C. Perform any flight crew duty at any time at the captain\\\'s discretion',
...

{
  ...
  options: [
    'A. No additional requirements — the ATPL covers all commercial operations — this does not reflect the correct Australian regulatory position',
    'B. A separate aerial application rating from CASA according to CASR and applicable CAO requirements',
    ...
    'D. Written authorisation from the aircraft owner for each aerial work flight as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. The aircraft registration certificate only — other documents are the responsibility of the operator — this does not reflect the correct Australian regulatory position',
    'C. Only the maintenance release and radio licence — other documents are kept at base according to CASR and applicable CAO requirements',
    'D. A copy of the relevant CASR Parts applicable to the operation as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The standard documents plus a ferry permit if the CofA is not yet issued',
    'B. Only a manufacturer\\\'s authorisation letter — no CASA documentation is required for delivery flights',
    'C. An experimental aircraft certificate issued by CASA for each delivery flight',
...

{
  ...
  options: [
    'A. The deviation is authorised in advance by CASA Operations — this does not reflect the correct Australian regulatory position',
    'B. Weather conditions make strict compliance impossible — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The operator\\\'s Operations Manual authorises such deviation as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Co-pilot time only — PICUS cannot be logged as PIC time — this does not reflect the correct Australian regulatory position',
    ...
    'C. Flight time but not toward specific PIC hour requirements for licence applications according to CASR and applicable CAO requirements',
    'D. Training time only — it cannot be logged as PIC or co-pilot as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. A theoretical examination on the aerodrome\\\'s procedures and NOTAMs only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only the operator to confirm familiarity through its documentation system — no physical visit or flight is required according to CASR and applicable CAO requirements',
    'D. A minimum of 3 flights on the route as co-pilot before assuming PIC duties — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Must carry both their CPL and ATPL on all flights — this does not reflect the correct Australian regulatory position',
    'B. Must renew the CPL separately to maintain the commercial flying privileges according to CASR and applicable CAO requirements',
    'C. Requires a separate endorsement to exercise PPL privileges while holding an ATPL as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Continue the flight — minor anomalies do not need investigation before departure — this does not reflect the correct Australian regulatory position',
    'B. Delegate the assessment to the first officer and ground engineer without reviewing it personally according to CASR and applicable CAO requirements',
    'C. File a safety report after landing but proceed with the departure — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. They are responsible only for events occurring after engine start — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. They share equal responsibility with the operator for regulatory compliance — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Their responsibility is limited to in-flight decisions — pre-flight planning is the operator\\\'s responsibility as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Limited — the company must be consulted before removing a crew member from duty — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only exercisable if the first officer is formally declared medically unfit — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Not applicable — fatigue is a self-declaration matter for the first officer alone — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Any ATPL holder with more than 5,000 hours total time',
...

{
  ...
  options: [
    ...
    'B. Follow the CASR requirement — regulations always take precedence over company manuals — this does not reflect the correct Australian regulatory position',
    'C. Request clarification from CASA before each flight where a conflict exists according to CASR and applicable CAO requirements',
    'D. Use their own judgment to determine the most appropriate requirement for each situation as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. TCAS I only — TCAS II is optional above FL290',
...

{
  ...
  options: [
    ...
    'C. Declare an emergency before refusing any ATC clearance',
...

{
  ...
  options: [
    'A. The pilot can only fly multi-engine aircraft — this does not reflect the correct Australian regulatory position',
    'B. The pilot is limited to operations within 100 nm of their home base according to CASR and applicable CAO requirements',
    'C. The pilot requires co-pilot assistance for all instrument approaches as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Comply with the schedule and file a report after the flight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Discuss the matter with the union and await a policy decision before taking any action — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Ask the first officer to monitor more carefully to compensate for any fatigue effects — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    ...
    'B. Both roles may be exercised simultaneously on different frequencies — this does not reflect the correct Australian regulatory position',
    'C. ATPL privileges take precedence and ATC duties must cease once any flight is commenced according to CASR and applicable CAO requirements',
    'D. There is no restriction on holding and exercising both licences on the same day as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. One crew member is always monitoring the autopilot while the other monitors the cabin — this does not reflect the correct Australian regulatory position',
    'B. Both pilots must be at the controls simultaneously during all phases of flight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The first officer must be monitoring the captain for signs of incapacitation at all times as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. For 12 months from the date of issue — this does not reflect the correct Australian regulatory position',
    ...
    'C. For 24 months from the last major inspection — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Until the next C-check maintenance event regardless of calendar time as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Ensure maintenance has been carried out — the actual review of the release is the operator\\\'s responsibility — this does not reflect the correct Australian regulatory position',
    'B. Sign the maintenance release to acknowledge they have accepted the aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only check the fuel and oil quantities listed in the maintenance release — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. The PIC if the aircraft is operated under an AOC and a licensed engineer is unavailable — this does not reflect the correct Australian regulatory position',
    ...
    'C. Any person holding a CASR Part 66 category B1 or B2 licence regardless of type rating according to CASR and applicable CAO requirements',
    'D. The airline\\\'s chief engineer by remote authorisation via maintenance data link as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. The captain approves the dispatch in writing before departure — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The defect is minor and will be rectified within 10 flight hours — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The MEL item has been deferred by the operator\\\'s chief engineer — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. A list of items that must be working for the aircraft to be dispatched on any flight — this does not reflect the correct Australian regulatory position',
    'B. A list of items that may be deferred indefinitely provided no passenger complaints are received according to CASR and applicable CAO requirements',
    'C. A maintenance planning document used by engineers — it has no operational significance for the pilot as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Is a recommendation that operators should consider applying to their aircraft — this does not reflect the correct Australian regulatory position',
    'B. Applies only to aircraft operated under an AOC — privately operated aircraft are exempt according to CASR and applicable CAO requirements',
    'C. May be deferred indefinitely provided the operator notifies CASA of the deferral as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'B. The PIC of each individual flight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The LAME who last signed the maintenance release — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Jointly shared between CASA and the operator with neither having primary responsibility as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The aircraft exceeds the normal maintenance interval by more than 5% — this does not reflect the correct Australian regulatory position',
    'B. The operator fails to pay the CASA registration fee within 30 days — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The PIC reports a defect that requires investigation — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Ignore the malfunction and report it after landing — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Shut down the affected system immediately regardless of the impact on the flight according to CASR and applicable CAO requirements',
    'D. Contact the manufacturer directly by radio for technical advice — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Report the damage only if it appears structurally significant — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Leave a note for the maintenance crew and proceed to the next duty period — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Complete a CASA incident report but the aircraft may continue to operate if no structural damage is visible as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Assess the dent using the MEL dent criteria and dispatch if within limits — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Depart only if the total dent area is less than 5 square centimetres — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Apply speed tape over the dent and enter it in the technical log for repair within 10 days as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The PIC to defer any inoperative item for up to 30 days on their own authority — this does not reflect the correct Australian regulatory position',
    'B. Operation with any inoperative item provided the PIC determines it does not affect safety according to CASR and applicable CAO requirements',
    'C. Operators to bypass airworthiness requirements on older aircraft with high maintenance costs as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'B. Any pilot to carry out any maintenance provided it is entered in the maintenance release — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. The pilot to carry out all scheduled maintenance on aircraft under 5,700 kg — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. The pilot to defer AD compliance with CASA permission — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. The engineer signs a dispatch authority override in the technical log',
...

{
  ...
  options: [
    ...
    'B. Carried on board the aircraft during all flights — this does not reflect the correct Australian regulatory position',
    'C. Submitted to CASA before each flight departure — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Retained at the maintenance base and not required to be accessible to the flight crew as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. After each flight sector, requiring revalidation before the next sector — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Every 7 days regardless of defects or incidents — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. After each calendar day of operations — a new maintenance release is required for each new day — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. CASA, through its ongoing audit of the operator\\\'s maintenance activities — this does not reflect the correct Australian regulatory position',
    'B. The aircraft manufacturer, through mandatory service bulletins — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Jointly the AOC holder and the LAME who last released the aircraft to service as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'B. Apply the AD only if CASA issues an equivalent Australian AD within 30 days — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Seek an exemption from CASA as Australian ADs take precedence over foreign ADs — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Consult with Boeing directly to determine if the AD applies to their specific aircraft serial numbers — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Be operated at a reduced maximum operating altitude until repaired — this does not reflect the correct Australian regulatory position',
    'B. Have the crack monitored for growth over the next 50 flight hours before repair is required according to CASR and applicable CAO requirements',
    'C. Be repaired by any person provided the repair is entered in the maintenance release as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'B. The item must be repaired before the next flight in all cases — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The item may be deferred for one day (24 hours) from the time of discovery — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Category A is the most critical category — items must be repaired within 1 hour on the ground as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Only when operating in mountainous terrain areas designated by CASA',
...

{
  ...
  options: [
    ...
    'B. Only aircraft operating over water more than 50 nm from land — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only helicopters — fixed-wing aircraft are not required to carry an ELT — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. All Australian-registered aircraft regardless of the area or type of operation as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Traffic Collision Avoidance System (TCAS) — this does not reflect the correct Australian regulatory position',
    'C. Enhanced Weather Radar with terrain mapping mode according to CASR and applicable CAO requirements',
    'D. Radio altimeter only — CFIT is not addressed by any specific mandatory equipment as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. The PIC is satisfied with its general condition after a pre-flight inspection — this does not reflect the correct Australian regulatory position',
    'C. The maintenance release has been signed by a LAME within the previous 30 days according to CASR and applicable CAO requirements',
    'D. It has been operated successfully on the previous flight without any reported defects as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. The co-pilot on multi-crew aircraft',
...

{
  ...
  options: [
    'A. Remains valid provided the damage is less than the MEL minimum damage limits — this does not reflect the correct Australian regulatory position',
    'B. Is rendered invalid only if both engines are damaged according to CASR and applicable CAO requirements',
    'C. Remains valid for ferry flight purposes at the PIC\\\'s discretion as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Any person holding a private pilot licence or higher — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only the manufacturer\\\'s authorised service centres — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The operator\\\'s own staff regardless of their engineering qualifications as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Operator\\\'s Operations Manual and may be modified by the operator — this does not reflect the correct Australian regulatory position',
    'B. Manufacturer\\\'s proprietary documents with no regulatory standing according to CASR and applicable CAO requirements',
    'C. Advisory material only — pilots may deviate from AFM procedures at their discretion as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. The maximum altitude at which the aircraft may operate — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The aircraft\\\'s registration category (experimental, certified, restricted) — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The maintenance schedule category applicable to the aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Consult the co-pilot — if both agree the condition is acceptable, depart — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Photograph the condition, enter it in the log, and accept the aircraft with a note that the defect is under review according to CASR and applicable CAO requirements',
    'D. Apply the "captain\\\'s discretion" authority to accept the aircraft with verbal notification to the operator as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Obtain CASA permission before moving the aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Secure the aircraft and await instructions from the AOC holder\\\'s maintenance department — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Remove the aircraft to a maintenance facility within 24 hours to facilitate repairs as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Ensure the engine produces exactly the rated thrust on every flight — this does not reflect the correct Australian regulatory position',
    'C. Verify the engine fuel flow is within the flight planning assumptions according to CASR and applicable CAO requirements',
    'D. Check compliance with noise abatement requirements at departure airports as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Replacing a malfunctioning fuel control unit on a turbine engine — this does not reflect the correct Australian regulatory position',
    ...
    'C. Any maintenance task on aircraft under 1,500 kg MTOW — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Replacing avionics equipment provided the aircraft is not operated commercially as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Been in service for a minimum of 2 years with the operator — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Three independent hydraulic systems — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Only CASA authorisation on a per-flight basis — ongoing approval is not possible for ETOPS — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The PIC accepts the false alert risk in writing before each flight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The cargo bay is loaded with non-flammable cargo only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The engineer confirms in the technical log that the detector produces false alerts but is otherwise serviceable as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Continue to the destination and report the defect verbally to the owner — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Declare an emergency and land at the nearest aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The defect only needs to be recorded if it affected safe operation of the flight — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Only when operating in remote area operations as defined in the operator\\\'s AOC — this does not reflect the correct Australian regulatory position',
    'B. Only on international overwater flights — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. On all flights regardless of route — life jackets must always be carried — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Only scheduled inspections and overhauls — unscheduled repairs are excluded — this does not reflect the correct Australian regulatory position',
    'B. Only repairs to the airframe — engine and avionics work is excluded from the definition according to CASR and applicable CAO requirements',
    'C. Any work done by the operator — external maintenance contracts are classified as "contracted services" not maintenance as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Continue all operations including low visibility operations using the pilot monitoring role only — this does not reflect the correct Australian regulatory position',
    'B. Continue all operations with both pilots using ground-based guidance only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Use the HUD in its last known serviceable mode until repair — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Certificate of Airworthiness is automatically cancelled and must be reissued — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Maintenance programme remains unchanged — STCs do not affect airworthiness requirements — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. AFM does not need updating — the STC is self-contained documentation — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Comply with the passenger safety briefing requirements — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Satisfy the maintenance release door serviceability requirement — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Ensure cabin crew have completed the pre-departure safety brief — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Accept the entry as informational only and clear it without action since normal performance was restored — this does not reflect the correct Australian regulatory position',
    ...
    'C. Close the defect if the same crew operates the next flight and monitors the system according to CASR and applicable CAO requirements',
    'D. Seek the PIC\\\'s further approval before deciding whether investigation is required as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. VHF radio, Mode C transponder, and ACAS — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only a serviceable transponder — VHF radio is discretionary in controlled airspace — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. HF radio, Mode S transponder with ADS-B, and TCAS II for all controlled airspace operations — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. An aircraft with expired maintenance to continue regular operations while awaiting maintenance — this does not reflect the correct Australian regulatory position',
    ...
    'C. Any pilot to operate an aircraft type for which they do not hold a type rating in an emergency — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. An aircraft to exceed its certified maximum speeds for test purposes — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Provide the only legally acceptable method of complying with a regulation — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Replace the requirement for LAME supervision of maintenance on older aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Automatically authorise deviations from the relevant CASR requirements — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Every flight regardless of any previously completed inspection — this does not reflect the correct Australian regulatory position',
    'B. Each flight that carries passengers under an AOC — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Only before the first flight of the operator\\\'s rostered duty period as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Advise ATC and await further instructions before responding — this does not reflect the correct Australian regulatory position',
    'B. Respond only if the conflicting traffic is confirmed on radar according to CASR and applicable CAO requirements',
    'C. Cross-check with ATC\\\'s traffic advisories before manoeuvring as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'B. A total weight within 5% above the maximum take-off weight — this does not reflect the correct Australian regulatory position',
    'C. The aircraft exceeding maximum landing weight at the departure airport according to CASR and applicable CAO requirements',
    'D. The nose-up moment exceeding that specified in the last W&B document issued as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Provide meteorological information to IFR pilots — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Manage noise abatement procedures at all Australian airports — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Issue clearances for instrument approaches only — other phases of flight are the responsibility of the crew as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. All IFR and all VFR flights — this does not reflect the correct Australian regulatory position',
    'B. IFR from IFR, and IFR from VFR — VFR to VFR is not separated by ATC but VFR aircraft are given traffic information',
    'C. Only IFR from IFR — all VFR operations are self-separating according to CASR and applicable CAO requirements',
    'D. All flights including VFR to VFR separation at all altitudes as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. No later than 30 minutes before the requested departure time — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. At least 2 hours before departure for all IFR flights — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only when operating in Class A or Class C airspace — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. An instruction that may be modified by the pilot if a better route is available — this does not reflect the correct Australian regulatory position',
    'B. A recommendation from ATC that the pilot should follow when practical according to CASR and applicable CAO requirements',
    ...
    'D. Valid only until the aircraft enters the next ATC sector as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Powered aircraft always have priority over unpowered aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. VFR aircraft always have right of way over IFR aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The largest aircraft by MTOW has right of way over all smaller aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Only VFR pilots — IFR pilots are provided full separation by ATC — this does not reflect the correct Australian regulatory position',
    'B. Only the pilot in command — the co-pilot\\\'s sole duty is aircraft monitoring according to CASR and applicable CAO requirements',
    ...
    'D. ATC for aircraft it has identified on radar — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'D. Is only applicable above FL600 in Australian airspace'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. ATC provides separation to all IFR flights in Class G — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. VFR operations are not permitted in Class G airspace — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. All flights in Class G require a transponder with Mode C — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Aircraft callsign and estimated time of arrival at destination only',
    'C. Aircraft callsign, altitude, and fuel remaining',
...

{
  ...
  options: [
    'A. Continue to the destination using the last cleared route and altitude — ATC will adjust other traffic — this does not reflect the correct Australian regulatory position',
    ...
    'C. Squawk 7700 and land at the nearest aerodrome immediately — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Descend to VMC and continue VFR to the destination — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Only during oceanic operations beyond VHF range — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. At every position report in non-radar airspace — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Only on international flights where position reporting is required by the destination country as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. VFR cloud clearances when in VMC — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. A separation of at least 5 nm from other IFR traffic by use of TCAS according to CASR and applicable CAO requirements',
    'C. Visual reference to the ground at all times below 10,000 ft as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. QFE — the altimeter is set to aerodrome elevation',
...

{
  ...
  options: [
    'A. Routine weather deterioration at terminal aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Fog and low cloud at aerodromes only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Wind shear alerts at specific runways — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Urgency, Alert, Emergency — this does not reflect the correct Australian regulatory position',
    'B. INCERFA (Uncertainty Phase), ALERFA (Alert Phase), DISTRESFA (Distress Phase)',
    'C. Warning, Danger, Critical according to CASR and applicable CAO requirements',
    'D. Monitor, Alert, Response as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Achieve FL120 at the pilot\\\'s discretion and then maintain it',
    'C. Maintain FL120 only while in the current ATC sector — change when contacting the next sector',
    'D. Not descend below FL120 but may climb above it without further clearance'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Achieved when there is at least 30 minutes between estimated times overhead the same point — this does not reflect the correct Australian regulatory position',
    'C. 5 minutes for jet aircraft and 10 minutes for turboprops — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. 50 nm at all altitudes and for all aircraft categories — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The aircraft is above the highest cloud layer in the area — this does not reflect the correct Australian regulatory position',
    'B. The aircraft remains in controlled airspace throughout the route segment according to CASR and applicable CAO requirements',
    ...
    'D. The aircraft will receive adequate VOR/NDB signal coverage for navigation as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Always the PIC — ATC is never responsible for terrain clearance — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The pilot must independently verify terrain clearance using charts even when being vectored — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Neither party — GPWS provides the primary terrain clearance mechanism during vectoring — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Acknowledge the distress call and immediately transfer the aircraft to the nearest aerodrome tower — this does not reflect the correct Australian regulatory position',
    ...
    'C. Sound the crash alarm at the nearest aerodrome only if the aircraft has declared fuel emergency according to CASR and applicable CAO requirements',
    'D. Monitor the frequency and wait for the aircraft to identify its position before taking action as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Is issued by ATC to an individual aircraft on initial contact — this does not reflect the correct Australian regulatory position',
    ...
    'C. Is broadcast on the emergency frequency 121.5 MHz — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Is only broadcast during instrument meteorological conditions — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. To provide terrain clearance for VFR departures from busy aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. To define noise-preferred routes that override obstacle clearance requirements — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. To sequence arriving aircraft into the final approach sequence — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. A mandatory approach sequence that cannot be changed by ATC — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. An alternative approach route when the primary instrument approach is unavailable according to CASR and applicable CAO requirements',
    ...
    'D. Terrain clearance only — it has no traffic management function — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Contact ATC to confirm the holding pattern details',
    'C. Enter right-hand holding at the fix using standard entry procedures regardless of what is published',
    'D. Hold at the fix until further clearance, using any convenient holding pattern'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Pass to the left of the aircraft being overtaken',
    'B. Pass above the aircraft being overtaken',
...

{
  ...
  options: [
    'A. The aircraft AFM only — no separate regulatory fuel minimum exists — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The operator\\\'s Operations Manual only — CASR does not specify fuel requirements — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. AIP ENR 1.1 which specifies minimum fuel as 30 minutes at cruise power for all aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. ATC clearance only for IFR operations — VFR may enter without clearance — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. A transponder with Mode C only — no radio communication is required — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Clearance only when arriving — departures may commence without clearance in Class D — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Whenever IFR operations are being conducted — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. When the aerodrome is above sea level capacity for movements per hour — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. VFR operations cannot be suspended — pilots always retain the right to fly VFR in VMC — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. VFR flight at night regardless of weather conditions — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Any aircraft to fly VFR in Class A airspace with ATC permission — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. IFR aircraft to cancel IFR and proceed VFR in the terminal area — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. ATC is unable to provide any services and the aircraft must operate independently — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The aircraft is cleared to conduct a visual approach to the destination — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Instrument separation is suspended pending radar contact establishment — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Any aircraft is within 50 nm of the IFR aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only when the other aircraft is operating without ATC communication — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Essential traffic information is never provided — ATC provides separation without informing the pilot as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. At least 5 minutes before the estimated approach time — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. Only when the aircraft is within 50 nm of the destination — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. The estimate for approach must be provided at departure — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Area Control Centre (ACC) — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Aerodrome Control Tower — responsible for all aircraft within 25 nm of the aerodrome according to CASR and applicable CAO requirements',
    'D. Flight Service — responsible for all non-IFR traffic in the terminal area as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Deviate without communicating with ATC — weather avoidance is at the PIC\\\'s absolute discretion — this does not reflect the correct Australian regulatory position',
    ...
    'C. Squawk 7700 before deviating to alert ATC to the weather deviation — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Only advise ATC after the deviation is complete and the aircraft is back on track as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Asking the pilot to confirm their altitude only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only through direct visual observation of the aircraft from the tower — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The aircraft simply being in the radar coverage area — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Applied immediately at the time of receipt — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Implemented only after passing the next reporting point — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Subject to the PIC\\\'s approval before implementation — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    ...
    'B. Continue and land — the approach clearance implies landing authority — this does not reflect the correct Australian regulatory position',
    'C. Conduct a low pass and request landing clearance on the next circuit according to CASR and applicable CAO requirements',
    'D. Only abort if other aircraft are visible on the runway as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. An aircraft has not arrived at its destination 30 minutes after ETA and all communications attempts have failed — this does not reflect the correct Australian regulatory position',
    'B. An aircraft has transmitted a Mayday call on 121.5 MHz — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. A pilot reports that weather conditions are deteriorating rapidly — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Land immediately to provide medical assistance — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Proceed to the nearest aerodrome and report the sighting — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Circle the site once to confirm, then continue to the original destination — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The intercepting aircraft is experiencing an emergency',
...

{
  ...
  options: [
    'A. Within 72 hours of the occurrence — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Within 7 days by written report only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Notification is only required if the accident results in fatalities as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. To determine the cause of the accident and assign blame to responsible parties — this does not reflect the correct Australian regulatory position',
    'B. Jointly with CASA which assigns regulatory sanctions based on the findings — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. To determine insurance liability for the parties involved in the accident — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. No specific obligations — the pilot should continue to their destination and file a report — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Immediately descending and landing nearby to render assistance — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Transmitting the position once only on 121.5 MHz and then proceeding to destination — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. IATA Dangerous Goods Regulations (DGR) — which override Australian law for international flights — this does not reflect the correct Australian regulatory position',
    'C. The operator\\\'s cargo manifest procedures only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The customs regulations for each country of destination — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Allow them onboard if the quantity is small — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Call ATC and declare an emergency — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Ignore the report if the batteries are consumer electronics — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Unlimited — the captain may invite anyone to the flight deck — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Limited to the operating flight crew only — no additional persons are permitted — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Subject to passenger vote for privately-chartered flights — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Accept the captain\\\'s decision without comment — the captain is the final authority — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Refuse to continue the flight if they believe safety is compromised — the first officer has an independent authority to cease operations — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Contact company operations directly to override the captain\\\'s decision — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Flight crew only — passengers are not entitled to supplemental oxygen under any circumstances — this does not reflect the correct Australian regulatory position',
    'B. Everyone on board whenever the aircraft is above 10,000 ft indicated altitude according to CASR and applicable CAO requirements',
    ...
    'D. Passengers only if specifically requested and only for aircraft above 5,700 kg MTOW as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Cargo may be placed anywhere in the cabin if the passenger manifest allows it — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Cargo is only permitted in dedicated cargo holds — no cargo is permitted in the passenger cabin under any circumstances according to CASR and applicable CAO requirements',
    'D. Cargo must weigh less than 10 kg per item regardless of total weight — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Operations Manual only — no other documents are required',
    ...
    'D. Crew training manual only — all other documentation is at the operator\\\'s discretion'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Refuse unless accompanied by a CASA inspector — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Contact their union representative before allowing any search — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Only allow a search if the aircraft is on the ground and engines are shut down — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. File a flight plan with CASA — no other requirements apply — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Obtain a special clearance from the Department of Defence before entering the zone — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. ADIZ requirements only apply to international flights entering Australian airspace — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Only the aircraft\\\'s direct operational activities — ground handling and catering are excluded — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only the flight operations — maintenance is the aircraft owner\\\'s responsibility — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Ensuring compliance only during scheduled operations — ad hoc charter flights are exempt — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. The ability to suspend a licence immediately if a serious breach of safety is observed — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only the ability to issue infringement notices — all enforcement action requires a court order — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The right to fly the aircraft to demonstrate proper techniques to the licence holder — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. The leasing operator (who provides the aircraft and crew) — they retain full responsibility — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. The aircraft owner regardless of the lease arrangement — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. The crew members personally — individual responsibility overrides corporate arrangements — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. CASA only — the ATSB only investigates accidents, not incidents — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only to their insurance company — regulatory notification is voluntary — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only the operator\\\'s chief pilot — external notification is not required for incidents as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Only on initial boarding — repeat briefings are not required on subsequent sectors — this does not reflect the correct Australian regulatory position',
    'B. Only when the aircraft will be operating over water — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only if requested by passengers — the briefing is at the crew\\\'s discretion as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'B. Only fatal accidents to be reported — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Voluntary reporting only — the MOR is not mandatory for certificated personnel — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Reporting only by AOC holders — private pilots are exempt — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. On any aircraft type regardless of category — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Exclusively on aircraft above 5,700 kg MTOW to count toward the ATPL — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. On commercially operated aircraft only — private flying does not count — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Cancel the SARTIME on landing only if carrying passengers — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. File a new SARTIME if the flight is delayed by more than 30 minutes — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Only activate SARTIME for flights in remote areas — populated area flights are exempt — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The weather at destination is below VFR minima — IFR is always an option — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The PIC has less than 5 years flying experience — minimum experience is an absolute rule — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. ATIS has not been obtained for all aerodromes on the route — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. More than 9 passenger seats — this does not reflect the correct Australian regulatory position',
    ...
    'C. More than 30 passenger seats — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. More than 50 seats or 15,000 kg MTOW as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. To comply with the noise abatement procedure at the departure aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. It is a radio call to advise ground crew to remove the door safety pins — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. It confirms to ATC that passenger boarding is complete and the aircraft is ready for pushback — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Functional at any time — the equipment can be switched on after ice begins to accumulate — this does not reflect the correct Australian regulatory position',
    ...
    'C. Only used when the RAT (Ram Air Turbine) is deployed — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Operated continuously throughout all phases of flight regardless of temperature as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. The PIC\\\'s discretion only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only for international flights — domestic remote area flights have no mandatory survival equipment requirements according to CASR and applicable CAO requirements',
    'D. Only AOC operators — private flights in remote areas have no regulatory requirement for survival equipment as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Only comply with the taxi clearance — responsibility for collision avoidance is ATC\\\'s on the ground — this does not reflect the correct Australian regulatory position',
    ...
    'C. Follow the instructions of the marshaller at all times regardless of ATC clearance — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Use the aircraft\\\'s ground proximity system as the primary collision avoidance tool — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Any occurrence where an aircraft deviates from the assigned runway heading during take-off — this does not reflect the correct Australian regulatory position',
    'B. Only an occurrence involving two aircraft on the same runway simultaneously — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. An occurrence where the landing aircraft uses more runway than planned — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. The aircraft\\\'s AFM — ELT requirements vary by aircraft design — this does not reflect the correct Australian regulatory position',
    ...
    'C. Only the AIP — ELTs have no regulatory basis in Australian law according to CASR and applicable CAO requirements',
    'D. CASR Part 65 (ATC) — the requirement is specified by ATC services as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Only a life raft — no other additional equipment is required — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Only a single life raft regardless of the number of persons on board — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Full survival equipment for all persons for all overwater operations regardless of distance — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. 5,700 kg MTOW',
    'C. Up to 8,618 kg MTOW on multi-engine piston aeroplanes',
...

{
  ...
  options: [
    ...
    'B. Only duties specified in the CASR — no common law duty exists — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only duties related to in-flight safety — pre-boarding and post-flight are excluded — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Only contractual obligations under the passenger ticket terms and conditions — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. CASA as part of the Civil Aviation Regulations — this does not reflect the correct Australian regulatory position',
    'B. The Bureau of Meteorology as part of aeronautical meteorological information according to CASR and applicable CAO requirements',
    ...
    'D. The Department of Infrastructure — it is a government gazetting document as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Check the NOTAM only if conditions are below published minima — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Only check NOTAMs for your departure aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Rely on ATIS to advise of relevant NOTAMs — a separate NOTAM check is not required — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Daily weather briefings for IFR pilots — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Temporary flight restrictions and airspace changes — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Aircraft type certificate information — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Provide temporary changes to the AIP with immediate effect — this does not reflect the correct Australian regulatory position',
    ...
    'C. Cancel superseded NOTAMs in a formal administrative process — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Provide charts for airways and approach procedures — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. A 7-day weekly publication cycle for aeronautical information — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. A 6-month cycle for major AIP amendments only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. A cycle used only for international operations — domestic Australian operations use a different schedule as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. What the airport operator considers achievable based on local knowledge — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The lowest observed visibility conditions at the aerodrome in the last 12 months — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The landing performance of a typical commercial aircraft at the aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. The altitude at which the aircraft must already be on the visual glide path — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The minimum altitude to which the approach must be flown before a landing is attempted — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The altitude published for the outer marker crossing — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Only lateral navigation (LNAV) guidance — VNAV indicates the chart type not vertical guidance — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. GPS lateral guidance combined with ILS vertical guidance — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The same guidance as a CAT II ILS but using satellite navigation — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. 1.68 nm from the runway threshold — this does not reflect the correct Australian regulatory position',
    'C. 2.66 nm from the aerodrome reference point according to CASR and applicable CAO requirements',
    'D. 5.28 nm for all aircraft categories as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Instrument approaches are only authorised during the day — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The aerodrome is closed at night — no operations are permitted — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Night operations require special CASA approval for each individual flight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    ...
    'B. The published ILS CAT I minimums with no additional buffer — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. VFR conditions (5,000 m visibility and 1,500 ft ceiling) regardless of approach available — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Alternate minimums are not published in Australian procedures — pilots use their judgment — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. When the runway is not in sight at the MDA — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. When the aircraft descends below the MDA — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Any point along the final approach where the pilot decides to go around — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. Always at least 800 m regardless of the approach type — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Greater than 1,500 m for all non-precision approaches — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The same as the reported RVR for the specific runway — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. A small strip with basic equipment only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. The aerodrome provides 24-hour RFFS services regardless of aircraft operations — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Category 6 is the minimum for IFR operations at any controlled aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. Always 5 nm radius from the aerodrome reference point — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. A fixed 10 nm radius from the aerodrome — this is standardised across Australia according to CASR and applicable CAO requirements',
    'D. The radar coverage range of the aerodrome\\\'s approach radar system as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. 1,000 ft AMSL throughout Australia — this does not reflect the correct Australian regulatory position',
    ...
    'C. FL100 for all aircraft in a CTA — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The LSALT for the route segment — no minimum CTA altitude is published as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Obtain an ATC clearance before entry at all times — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Only broadcast when the aerodrome lighting is on — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. File a flight plan before entry into the MBZ — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Only the certificate of registration — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. Only a valid passport for each crew member — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. A customs approval letter from each destination country — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. The point from which all instrument approach procedures are referenced — this does not reflect the correct Australian regulatory position',
    ...
    'C. The highest point on the aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The intersection of the two longest runways at an aerodrome as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. No effect — approach lighting is supplementary only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. The approach is not permitted until ALS is restored — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The pilot may use the minimums at their discretion regardless of ALS status — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. 2.0° above horizontal — this does not reflect the correct Australian regulatory position',
    ...
    'C. 4.0° for all ILS installations in Australia according to CASR and applicable CAO requirements',
    'D. 6.0° for noise-abatement purposes at Australian airports as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Ensure the aircraft meets noise standards — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Provide evidence of airworthiness only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Register the aircraft for insurance purposes under the Civil Aviation Act — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Any conditions requiring the use of instruments for navigation — this does not reflect the correct Australian regulatory position',
    ...
    'C. Only conditions within cloud — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Conditions where ceiling is below 1,000 ft only — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Only have an autopilot capable of maintaining ILS tracking — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only have CAT II approach approved in the Operations Manual — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Have at least 200 hours experience on the type before CAT II operations — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The altitude at which the ILS localiser signal becomes reliable — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The minimum height at which the missed approach must be initiated — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The height above threshold at which ATC expects the aircraft to be established on the ILS as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Only the published instrument approach procedure — no additional requirements apply at non-controlled aerodromes — this does not reflect the correct Australian regulatory position',
    ...
    'C. VFR separation rules — IFR procedures do not apply at non-controlled aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The operator\\\'s approval letter from CASA for each non-controlled aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Updated within the last 6 months',
    ...
    'D. Updated annually — monthly updates are not required for Australian operations'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. The aircraft is cleared to land — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The aircraft may conduct any approach it wishes to the aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The aircraft is cleared to the decision altitude for a precision approach — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Commercial aircraft over private aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. VFR aircraft since they have minimum fuel reserves — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The aircraft established on final approach first regardless of emergency status as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The area where ILS signals are strongest — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. The runway touchdown zone — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. The area within which passengers may hear the ILS morse identifier — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The point where the landing gear must be extended — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The fix where the aircraft must be on the glide slope for a precision approach — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The outer marker on an ILS approach only — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Provide distance measuring for fuel planning during the approach — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Provide obstacle clearance when approaching over water — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Replace the localiser signal on ILS approaches where the localiser is unserviceable — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. A view of the runway at the decision height under all weather conditions — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. A guaranteed landing regardless of pilot experience level — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Separation from other IFR aircraft at all times during the approach — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Only IFR flight is permitted — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Full ATC separation is provided to all aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Air Defence identification procedures are mandatory — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Confirmation that GPS signals are available — no other specific checks are required — this does not reflect the correct Australian regulatory position',
    'C. Only ATC clearance for the approach — GNSS checks are automatic — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Manual entry of all approach waypoints from the current approach chart — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Runway length and width only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. Runway lighting serviceability status — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Obstacle clearances near the runway — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Only the altitude to be maintained — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only the destination and squawk code — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Altitude and transponder code only — route is assumed to be the filed flight plan as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Any airspace above 10,000 ft AMSL — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only terminal areas around major aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Any airspace within 25 nm of a registered aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Any member of the public who requests it — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only a CASA Inspector — no other authority can demand production of aviation documents — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Production is required only during a formal hearing or investigation — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. The aerodrome is in Class G airspace — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Only when weather conditions exceed VFR minima by 500 ft and 2,000 m — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. The IFR clearance has been cancelled by the crew — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The following aircraft is at a higher altitude than the generating aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. The following aircraft is on a parallel runway approach — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Wake turbulence is only significant in calm wind conditions above FL200 — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Land as soon as possible to minimise exposure time — this does not reflect the correct Australian regulatory position',
    ...
    'C. Approach at a higher speed to penetrate through the vortex quickly according to CASR and applicable CAO requirements',
    'D. Land on a runway intersection beyond the heavy jet\\\'s touchdown point as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Firearms may be carried in checked baggage only and must be declared — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Firearms are always prohibited on all Australian commercial aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Passengers with gun licences may carry their weapon on board — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Only on international over-water flights — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only when the aircraft is operating above 5,700 kg MTOW — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Only during night operations over water — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. A light aircraft requiring only basic VFR equipment — this does not reflect the correct Australian regulatory position',
    'B. A medium aircraft exempt from turbine engine requirements according to CASR and applicable CAO requirements',
    'C. Classification depends on the number of passenger seats, not MTOW as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. The maximum speed at which the aircraft may be operated in any regime of flight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The maximum cruise speed for fuel efficiency purposes — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The maximum speed during descent — climb and cruise speeds are limited by MMO only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. ATC has issued a specific take-off clearance only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Full power checks have been completed to the manufacturer\\\'s specifications — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. All passengers and crew are seated and seatbelts fastened — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The aircraft be washed clean of all dirt before each flight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only ice must be removed — frost and snow are acceptable provided they are thin — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The aircraft must be de-iced by an approved contractor only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. They have received departure clearance only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. ATIS has been received and acknowledged — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The departure procedure has been loaded into the FMS — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. All aircraft are the same type — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. A formation leader with more than 500 hours is designated — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Formation flying is always prohibited for commercial operations — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Permitted provided the pilot does not feel impaired — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Permitted for domestic flights only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The 8-hour rule applies only to the pilot in command, not other crew — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Fly as normal — prescription medication is legal and therefore permitted — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only avoid flying if the medication causes drowsiness — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Notify CASA within 24 hours of taking the medication — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The PIC considers operational performance requires a different departure path — this does not reflect the correct Australian regulatory position',
    ...
    'C. The aircraft is on an IFR flight plan — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The aerodrome is Class G — NAP only applies to controlled aerodromes as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. All phases of flight — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. Only during approach and landing phases — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Only when the aircraft is within Class A airspace — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. An Air Defence Identification Zone',
    'B. A Terminal Control Area (TMA)',
...

{
  ...
  options: [
    'A. Restricted areas are only enforced during daylight hours — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Restricted areas apply only to IFR aircraft — VFR may transit freely — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. There is no practical difference — both terms are used interchangeably — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Inform the operator before taking any action — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Transfer the aircraft to the emergency frequency 121.5 MHz — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Require the aircraft to squawk 7700 before providing emergency services — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Oxygen may be carried freely by any passenger without restriction — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. Passenger-use oxygen is only permitted on pressurised aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. No oxygen may be carried in the passenger cabin under any circumstances — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Is legal — structural limits are not affected by density altitude — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Is automatically restricted by the FMS — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Requires a CASA waiver for hot and high operations — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'D. Any time the sun is below the horizon'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The larger aircraft has right of way — this does not reflect the correct Australian regulatory position',
    'B. The faster aircraft has right of way — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. ATC always resolves final approach conflicts — there is no pilot rule as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. The larger aircraft must give way',
    'B. Both aircraft must turn left',
...

{
  ...
  options: [
    ...
    'B. Only a government-issued photo ID — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The aircraft logbook and pilot logbook — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Pilot licence only — the medical certificate is held by CASA as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The aircraft carries TCAS II only — no other special requirement — this does not reflect the correct Australian regulatory position',
    'B. RVSM approval is not required for aircraft below 30,000 kg MTOW — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Only turbine-powered aircraft require RVSM approval — piston aircraft are exempt above FL290 as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The altimeter reading of zero at sea level for any pressure — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Height above the aerodrome reference point — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Pressure altitude corrected for non-standard temperature — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Weather warnings — these supersede TAFs when issued — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Aircraft warnings about specific aircraft technical issues — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Wake turbulence warnings for specific aircraft types — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Fly the heading but may deviate up to ±5° for turbulence avoidance — this does not reflect the correct Australian regulatory position',
    'B. Advise ATC if wind causes drift from the assigned heading according to CASR and applicable CAO requirements',
    'C. Maintain the magnetic heading for ±15° of the assigned heading at the pilot\\\'s discretion as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'C. May commence with captain\\\'s discretion as conditions may be better at lower altitude',
...

{
  ...
  options: [
    'A. 1,000 ft above the highest terrain within 100 nm of the route — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Applied only when flying in IMC — VMC allows visual obstacle avoidance below LSALT according to CASR and applicable CAO requirements',
    ...
    'D. Applied only on the IFR chart airways — off-airway flight may use any altitude as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Consumed more than one standard drink — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Consumed alcohol to a blood alcohol level exceeding 0.05 — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Consumed alcohol outside the airport precinct — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Attempt to re-engage the autopilot before doing anything else — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Declare an emergency and execute a missed approach — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Allow the aircraft to continue under flight director guidance while diagnosing the autopilot fault as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Descend immediately at maximum rate to FL140 — this does not reflect the correct Australian regulatory position',
    'C. Descend passing through FL140 to FL100 if workload permits according to CASR and applicable CAO requirements',
    'D. Advise ATC when passing FL150 to receive an amended clearance as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Requires any form of medication — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Has caused them to visit a doctor in the preceding 30 days — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Would require them to have a medical certificate renewed early — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Entering controlled airspace for the first time — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. At every position report in non-radar airspace — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. When entering the ILS final approach course — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Advise ATC and await permission before manoeuvring — this does not reflect the correct Australian regulatory position',
    'C. Follow ATC instructions which take precedence over ACAS according to CASR and applicable CAO requirements',
    'D. Manoeuvre only if the conflicting traffic is visible as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. DME only — all other navigation equipment is optional — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Only a GPS receiver — all other radio navigation aids are supplementary — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Weather radar on all IFR flights — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. Permitted at any time over unpopulated areas — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Permitted over water at all times — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Permitted from VFR aircraft below 1,500 ft AGL — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Provide ATC with confirmation that the message was received — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. Satisfy the requirement to use standard phraseology — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Comply with the legal requirement that all ATC communications be recorded — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Fly any aircraft on the licence — type ratings do not expire — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Fly as co-pilot only with a current captain present regardless of their own currency — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Fly for training purposes only with a qualified instructor on board — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The autopilot does not fail at any time — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. The autopilot is not required — "fail-operational" refers to the ILS equipment only according to CASR and applicable CAO requirements',
    'D. Fail-operational is a higher RVR minimum than fail-passive — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Be airborne and above circuit height — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only contact ATC when entering Class C airspace — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. File the flight plan in flight — telephone pre-filing is not required — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Any safety system — all safety systems must always be operational — this does not reflect the correct Australian regulatory position',
    'B. Any navigation equipment regardless of redundancy available according to CASR and applicable CAO requirements',
    'C. Any equipment installed within the last 12 months as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. All aircraft above 2,250 kg MTOW — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Only aircraft with more than 19 passenger seats — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. All commercial aircraft regardless of MTOW — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Whenever any aircraft is within 100 nm — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only when the conflicting aircraft is on the same frequency — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. When ATC is providing full separation from the traffic mentioned as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Accept the clearance — ATC is responsible for route safety — this does not reflect the correct Australian regulatory position',
    'B. Accept the clearance but slow to turbulence penetration speed according to CASR and applicable CAO requirements',
    'C. Declare an emergency before refusing any ATC clearance as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. The most senior licenced person on board the aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Always the person with the highest licence grade on board — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Any pilot at the controls of the aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    ...
    'B. Two independent ILS receivers — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only a VOR receiver — RNAV is always supplementary — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. A single GPS receiver without RAIM is sufficient for all RNAV operations — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Operate any aircraft registered in Australia without further approvals — this does not reflect the correct Australian regulatory position',
    'C. Employ any licence holder as flight crew without further qualification requirements according to CASR and applicable CAO requirements',
    'D. Modify the aircraft type in ways not covered by the type certificate as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. A current ATPL only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. At least 100 hours on the aircraft type — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The route qualification is only required for international operations as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Fuel for the flight plus 30 minutes reserve only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Fuel for the flight to destination plus 45 minutes at cruise power — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Fuel for twice the planned flight time as a safety factor — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    ...
    'B. The alternate must be within 80 nm of the destination — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The aircraft must carry 80% fuel capacity as a minimum — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. 80 minutes of reserve fuel for all turbine aircraft on IFR flights — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Leave the aircraft and return for maintenance — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Fly the aircraft back to base immediately regardless of defects found — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The remote aerodrome operations are prohibited without on-site engineering support — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Record at least 30 minutes of the most recent audio — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Record only the ATC communications for regulatory purposes — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Be operator-controlled and may be erased between flights — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Monitoring the passengers through the cabin camera — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only managing the radios — flight instruments are the PF\\\'s responsibility — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The PNF has no defined responsibilities — they simply observe — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Domestic flights of less than 2 hours duration — this does not reflect the correct Australian regulatory position',
    'B. Training flights where the instructor acts as pilot in command according to CASR and applicable CAO requirements',
    'C. Ferry flights without passengers as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'B. A person with airline management experience only — no pilot qualification is required — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Appointed by the airline\\\'s Board — CASA has no role in their appointment — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. A CASA-employed inspector seconded to the operator — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Any additional staff on board the aircraft beyond the minimum crew — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Crew who have received special endorsement training only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Ground crew members riding in the cockpit jump seat — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. The take-off distance calculated for the actual conditions plus a fixed 10% margin — this does not reflect the correct Australian regulatory position',
    ...
    'C. 1,000 m for any turbine aircraft regardless of weight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The take-off run required at sea level ISA standard conditions — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. The speed at which the aircraft must be airborne to clear obstacles — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. The speed at which the nosewheel lifts from the runway — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. The speed at which the aircraft is rotated to take-off attitude — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    ...
    'B. Vlof — the aircraft lifts off before the rotation command — this does not reflect the correct Australian regulatory position',
    'C. They always occur at the same speed simultaneously according to CASR and applicable CAO requirements',
    'D. On a wet runway, Vlof occurs before Vr as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Total runway length only — this does not reflect the correct Australian regulatory position',
    'B. TORA minus 300 m safety margin — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Runway length available for normal operations excluding the stopway as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. The maximum take-off weight based solely on structural limits — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. The weight at which the aircraft\\\'s landing performance becomes critical — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Fuel required for the flight — WAT limits define minimum fuel not maximum weight — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. All turbine-powered aircraft regardless of MTOW — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Only helicopters operating over mountainous terrain — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Only aircraft conducting international operations — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Remain quiet — challenging the captain is insubordination — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Immediately contact the company operations centre on the second radio — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Document the concern for the post-flight debrief only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Captains only — first officers learn CRM by observation — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only new-entrant pilots during type rating training — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. CRM training is voluntary — no regulatory requirement exists — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. A post-accident investigation technique only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. An ATC procedure for managing radar conflicts — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. A maintenance quality control process — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. It allows the aircraft to fly a shallower approach than published — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. It reduces fuel consumption on all approaches — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. CDFA is only applicable to precision approach procedures — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The same for all runways regardless of surface condition — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. The maximum wind speed at 90° to the runway allowed under ATC rules — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Specified in the NOTAM for each aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. Take over the aircraft immediately and correct the error — this does not reflect the correct Australian regulatory position',
    ...
    'C. Fail the check immediately for any procedural error according to CASR and applicable CAO requirements',
    'D. Intervene and document nothing — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. The aircraft is on final approach and the runway is not visible — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. The first ATC instruction to hold is received — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. The flight is beyond the point of no return for the destination — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. They have been on annual leave for more than 28 days — this does not reflect the correct Australian regulatory position',
    'B. The weather forecast for the route is below VMC — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The crew member has a cold — any illness requires 3 days off under the regulations as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. 550 m regardless of the published minimum — this does not reflect the correct Australian regulatory position',
    'B. The published minimum — if RVR is below the published minimum, the approach ban applies and the approach cannot commence',
    'C. 300 m — approaches may continue if RVR is above 300 m according to CASR and applicable CAO requirements',
    'D. 200 m — this is the absolute minimum for any ILS approach as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Pull up gradually at a safe rate to avoid passenger discomfort — this does not reflect the correct Australian regulatory position',
    'B. Advise ATC before manoeuvring — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Continue the approach and check the radar altimeter — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. A CPL with 200 hours total time — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. An ATPL with 500 hours on the type — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. No minimum is specified — the operator determines requirements — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Weather deteriorates to below VMC during the final approach — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. ATC instructs the aircraft to hold at the FAF — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. The approach is not stabilised at 1,500 ft AAL — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The autopilot must be disengaged — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. The co-pilot cannot operate the radios — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Passengers must be seated and seatbelts fastened only — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. 3 minutes at all aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. 10 minutes for Category 3 aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. The required response time is 90 seconds for all certified aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. No modification — wet runway performance is always identical to dry — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Only increased fuel consumption on wet surfaces — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Additional drag from water spray only — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. The same — wet runway only affects take-off performance — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Shorter — water on the runway acts as a lubricant reducing rolling friction according to CASR and applicable CAO requirements',
    'C. Landing distance is unaffected by surface conditions — only wind matters as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'B. Only international flights — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only the first flight of each day — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Only when passengers request the briefing — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Fuel the aircraft and depart as soon as the weather clears without further action — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Calling CASA to notify the diversion — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. Completing the original flight plan to the scheduled destination regardless of diversion — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The autopilot engages when the PF lets go of the controls — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The co-pilot becoming PIC when the captain leaves the flight deck — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only a formal written transfer of responsibility is acceptable — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. The airline\\\'s marketing specifications for each route — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. The technical specifications for each aircraft in the fleet — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. Internal company documents with no regulatory significance — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. A description of the company aircraft only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Only incident reporting procedures — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. A safety officer position designation only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. The SOP always takes precedence — it has been approved by CASA — this does not reflect the correct Australian regulatory position',
    ...
    'C. The pilot uses their own judgment to determine the safest option — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The conflict must be reported to CASA before the flight can proceed as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. The average elevation of all runways at the aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The aerodrome reference point (ARP) — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The lowest point of the aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Expect to be vectored to any runway at ATC discretion — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only commence approach briefing after receiving the actual approach clearance from ATC — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Approach briefing is not required if the ATIS specifies the approach type — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Always carry passengers on positioning sectors — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only carry positioning crew if the flight is to an AOC base — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Be operated under CASR Part 91 only — Part 121 does not apply to crew positioning — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    ...
    'B. Only the aircraft MTOW — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. ATC\\\'s assessment of the runway length at the specific aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Only the landing roll distance at MTOW — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The flight exceeds 500 nm — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Night IFR operations are involved regardless of weather — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. An alternate is required for all IFR flights regardless of forecast conditions — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. The 14th ATIS update of the day has been received by the crew — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The crew is requesting the ATIS to be read out on the frequency — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. NOTAM information is included in the ATIS — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Only the aircraft hull — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. All aviation insurance is voluntary — no minimum is specified by law — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Only international flights require insurance — domestic operations are unregulated — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Landing with a DH of 200 ft and RVR of 550 m — this does not reflect the correct Australian regulatory position',
    'C. Landing in zero visibility without any DH or RVR requirement according to CASR and applicable CAO requirements',
    'D. The same as CAT I but at night only — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Change frequency after a 2-minute delay to allow handoff to be completed',
    ...
    'D. Only change frequency after passing the current sector boundary'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Ceiling and Visibility OK — any cloud and visibility above minimums — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Clear skies with no cloud at all — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Visibility exceeds 20 km with no precipitation — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Descend to FL170 and continue further if no other clearance received — this does not reflect the correct Australian regulatory position',
    'B. Descend to FL170 but may continue below if in visual conditions according to CASR and applicable CAO requirements',
    'C. Commence descent after the co-pilot has checked the altimeter setting as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Comply with the part they understood and request clarification later — this does not reflect the correct Australian regulatory position',
    ...
    'C. Say nothing until ATC repeats the instruction according to CASR and applicable CAO requirements',
    'D. Ask other crew members what they heard as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. "EMERGENCY EMERGENCY EMERGENCY [callsign]" — this does not reflect the correct Australian regulatory position',
    'B. "PAN PAN PAN [callsign]" — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. "DISTRESS DISTRESS DISTRESS [callsign]" — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Continue the approach if the runway appears clear',
...

{
  ...
  options: [
    ...
    'B. Only the number of passengers on board — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Only the duration of the flight — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Only the weather conditions — IFR operations always require a co-pilot — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. 5,000 ft AMSL — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. FL100 always — below FL100 altitudes are used — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. FL180 — Australian upper airspace begins at FL180 as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Is the QNH at the destination aerodrome only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Is the mean QNH calculated from all aerodromes in the FIR — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Area QNH is only broadcast for VFR flights — IFR flights use aerodrome QNH — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. 1013 hPa until passing FL100, then 1009 hPa — this does not reflect the correct Australian regulatory position',
    ...
    'C. 1009 hPa only after passing the transition level — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. 1013 hPa at all times — the clearance is issued in feet which means flight levels apply as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Prohibited — all civil aircraft must avoid all danger areas at all times — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. The same as a restricted area — a clearance is required to enter — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Only applicable to military aircraft operating in combat training areas — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. The standard criminal law of the state in which the aircraft is registered — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Only international law which applies outside Australian territory — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. The Aviation Transport Security Act 2004 which deals with civil liability only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The operator\\\'s accountable manager — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. The airline\\\'s Director of Flight Operations — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. CASA — as the regulatory authority — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'C. 1,600 ft is the initial approach altitude; 620 ft is the circuit height',
...

{
  ...
  options: [
    ...
    'B. Only advise if the weather is IMC',
...

{
  ...
  options: [
    'A. Take off from the beginning of the runway and land at the displaced threshold — this does not reflect the correct Australian regulatory position',
    ...
    'C. Both take-off and landing must commence at the displaced threshold — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The displaced threshold only applies to VFR aircraft — IFR may use the full runway as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Issue a SIGMET immediately — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only record the PIREP for statistical purposes — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Require the reporting aircraft to divert — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The alternate must be within radar coverage of the destination — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The alternate must have an ILS approach only — VOR or NDB approaches are not acceptable — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The alternate aerodrome tower must be staffed at the estimated arrival time — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Squawk 7600, continue to destination as normal — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Squawk 7700 and land immediately at the nearest aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Descend below Class C airspace and continue VFR — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The IFR flight has been cancelled and VFR applies — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. The aircraft must maintain VFR cloud clearances at all times — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. VMC on top is only permitted in Class A airspace — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Prevent aircraft from commencing approaches in all IMC conditions — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Prohibit approaches by aircraft not approved for low visibility operations — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Prevent multiple simultaneous approaches at the same aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Accept the payload if the company approves it in writing — this does not reflect the correct Australian regulatory position',
    'C. Accept if the runway length allows the extra weight according to CASR and applicable CAO requirements',
    'D. Accept if the extra weight does not affect the CG limits as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The same as cancellation of the licence — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. A warning letter with no legal effect — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Issued only for breaches detected by radar — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. During cruise above FL350 — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. During oceanic flight beyond VHF range — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. During any phase at night — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. May land at any aerodrome — the declaration can be filed on the ground — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. May land at the nearest aerodrome and file the declaration within 2 hours — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Must file the declaration while airborne before reaching the Australian coastline — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. The aerodrome has instrument approaches only — this does not reflect the correct Australian regulatory position',
    'B. The STAR is charted — all published STARs are always mandatory according to CASR and applicable CAO requirements',
    'C. ATIS specifies STAR operations are in use — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Any time the autopilot is engaged on an IFR flight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only when in actual IMC — simulated instrument time cannot be logged — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. All flight time in controlled airspace counts as instrument time — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    ...
    'B. A noise-abatement departure with reduced thrust — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. A procedure for returning to land with a failed engine — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Engine out procedures are only published at high-altitude aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Operate an aircraft without current navigation charts on board — this does not reflect the correct Australian regulatory position',
    'B. Fly an aircraft outside normal business hours without approval according to CASR and applicable CAO requirements',
    ...
    'D. Use a personal communication device while at the controls of an aircraft as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Only life jackets — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Only a personal locator beacon (PLB) — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. Standard over-water survival equipment — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. The aircraft must stay at FL160 (the centre of the block) — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The aircraft must not enter FL150 or FL170 — only the altitudes between them — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Block altitudes are not used in Australian ATC — this is a US procedure — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. The time by which the aircraft must have landed — this does not reflect the correct Australian regulatory position',
    'C. ATC\\\'s best estimate of the arrival time at the gate — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The time the ILS will be switched on for the approach as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. From engine shutdown to engine start of the next sector — this does not reflect the correct Australian regulatory position',
    'B. From landing to the next departure — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only from the end of flying duties — ground duties during the "rest" period are permitted as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Only the weather condition observed — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only the callsign and the aerodrome nearest to the observation — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. A PIREP should be as brief as possible — no specific format is required — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    ...
    'B. Only an ILS receiver capable of tracking to 100 ft DH — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Automatic landing is optional — crews may hand-fly CAT IIIB approaches — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. CAT IIIB only applies to specific aircraft types — all aircraft with CAT I ILS can fly CAT IIIB — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Higher than the actual altitude of 28,000 ft AMSL because QNH is below standard — this does not reflect the correct Australian regulatory position',
    ...
    'C. Exactly 28,000 ft AMSL regardless of QNH above the transition altitude according to CASR and applicable CAO requirements',
    'D. Higher than actual because the aircraft is climbing in a lower pressure environment as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. The aircraft is over 5,700 kg MTOW only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only on international flights — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The AFM is not required to be carried — it only needs to be available at the operator\\\'s base — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    ...
    'B. Only the FL100 instruction — the STAR routing is advisory — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. FL100 only — there are no altitude constraints on a STAR, only the terminal assigned level — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The STAR routing only down to the first waypoint — then navigate direct to the IAF as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Continue to the destination as the failure is not safety-critical — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Request a lower flight level outside RVSM airspace without advising ATC — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Switch to the standby altimeter and continue normally — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. VFR rules may be used in VMC within Class A — this does not reflect the correct Australian regulatory position',
    'B. Instrument Flight Rules (IFR) — Class A is IFR only; no VFR operations are permitted regardless of weather conditions',
    'C. Either IFR or VFR depending on weather conditions according to CASR and applicable CAO requirements',
    'D. Special VFR rules apply when visibility exceeds 10 km as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Engine Takeoff Altitude — this does not reflect the correct Australian regulatory position',
    'B. Emergency Turnback Altitude — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. En-route Traffic Advisory — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Only a white strobe light on top of the fuselage — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only the navigation lights — anti-collision lights are optional at night — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Landing lights at all times when flying at night — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. 500 ft above all obstacles — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. 5,000 ft AMSL at all times — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The same as day VFR — night has no additional altitude requirements — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Traffic volume and expected holding times — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only QNH and active runway — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Pilot preferences for approach type — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. May continue operations for up to 30 days after expiry — this does not reflect the correct Australian regulatory position',
    'B. May continue if the aircraft carries a portable PLB as an alternative according to CASR and applicable CAO requirements',
    'C. May fly if the PIC accepts responsibility in writing as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'B. The aircraft is cleared to cross and enter runway 34 — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The aircraft is cleared for take-off from runway 34 — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The holding point clearance is the same as a take-off clearance — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Only the departure and destination aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only the destination if the route is a standard airway — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only instrument approach charts — en-route charts are optional as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Is used as the standard Australian altimeter setting — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. Is the same as QNH but measured in inHg — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Is used only above 10,000 ft in Australia — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Aviation Transport Security Act 2004 — this does not reflect the correct Australian regulatory position',
    'B. Air Navigation Act 1920 — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Transport Safety Investigation Act 2003 as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. 100 ft above the published DH — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. When the runway centreline is not visible — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. When the aircraft has reached a point from which a safe landing is not possible — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. A co-pilot assisting the captain with workload management — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Any training flight with an instructor present — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. The second-in-command on a multi-crew flight — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Immediately follow any climb or descent instruction displayed — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Advise ATC and request the traffic be cleared from the vicinity — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Climb 1,000 ft immediately as a precautionary measure — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Always 800 m RVR — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Zero — take-off minimums do not exist in Australian regulations — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Always the same as the published approach minimums for the aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. Requires ATC clearance for all aircraft (same as Class C) — this does not reflect the correct Australian regulatory position',
    'B. Is only available above FL200 — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Is exactly the same as Class G — no services are provided as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. ATC clearances for arriving aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. Traffic information and separation advisories — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Navigation aid status and NOTAM information — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. VHF relay through other aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Morse code on shortwave frequencies — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Operations beyond HF range are not permitted for Australian-registered aircraft as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Retains their licence provided they were not impaired during flight operations — this does not reflect the correct Australian regulatory position',
    'B. Only loses their licence if the offence involved aviation activities — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Is automatically granted amnesty under the voluntary disclosure scheme — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Exclusively the captain in command during flight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. ATC for all aspects of the flight once airborne — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. CASA through its continuous oversight of all commercial operations — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Use personal electronic devices during flight — this does not reflect the correct Australian regulatory position',
    'C. Carry food on board without the airline\\\'s permission according to CASR and applicable CAO requirements',
    'D. Smoke in any area of the aircraft regardless of airline policy as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The number of passengers on board — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The aircraft MTOW only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The operator\\\'s risk assessment for each specific operation as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Declare MAYDAY FUEL and attempt the approach regardless of minimums — this does not reflect the correct Australian regulatory position',
    ...
    'C. Continue circling the destination until fuel requires a landing regardless of conditions according to CASR and applicable CAO requirements',
    'D. Attempt the approach below minimums as an emergency measure — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Always the lessor — they provide the aircraft and crew — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Always the lessee — they sell the tickets — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. Irrelevant — both parties share equal responsibility — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Airworthiness of aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Personnel licensing — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Air traffic services — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. 500 ft AGL for all aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. 2,000 ft AGL for turbine aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. 1,500 ft AGL for all aircraft regardless of type — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Essential traffic is VFR only; traffic information applies to IFR — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Essential traffic is closer than traffic information — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. There is no difference — both terms are used interchangeably — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Mode A transponder only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Any transponder regardless of mode — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Transponder is optional in controlled airspace — it only improves ATC\\\'s picture as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. 5 years from the last entry — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Indefinitely — logbooks must never be destroyed — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. 2 years from the expiry of the associated licence as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Proceed to line up as soon as the instruction is received — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Confirm with ATC that the 737 is airborne before entering the runway — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Line up as soon as the 737 commences its take-off roll — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Any defect is found during pre-flight inspection — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Any time the aircraft receives maintenance outside Australia — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only when the pilot is summoned for a medical examination — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Issue flight clearances for individual flights — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Investigate aircraft accidents — this is the ATSB\\\'s role — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Set airport charges and landing fees — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Physically capable only — no other requirements — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. A frequent flyer with an emergency briefing card — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Able-bodied and wearing appropriate footwear only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. Only transponder code and altitude — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only works in radar coverage areas — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Encrypted signals readable only by ATC ground equipment — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. On any runway they choose — this does not reflect the correct Australian regulatory position',
    ...
    'C. On 34L or 34R as they are parallel runways according to CASR and applicable CAO requirements',
    'D. On 34L or any shorter runway on the same heading as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. From the aerodrome tower at the departure aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Only through flight plan filing — no radio clearance is required for oceanic entry according to CASR and applicable CAO requirements',
    'C. From CASA before the flight departs — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. The crew is required to operate the autopilot — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. The aircraft\\\'s weather radar is being monitored by ATC — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. ATC will issue specific headings for the entire flight — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Permission from the property owner regardless of the height — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Permission only if the aircraft is conducting commercial photography — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Noise complaints from the property owner to be filed with CASA before restrictions apply as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Always the person in the left seat — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Always the pilot with the highest total hours — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Determined by ATC based on the primary pilot identification in the flight plan — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. 1,500 m visibility and clear of cloud — this does not reflect the correct Australian regulatory position',
    'C. 5,000 m visibility and 1,000 ft below cloud according to CASR and applicable CAO requirements',
    'D. 10,000 m visibility and no cloud within 10 nm as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. 1,000 ft in all areas regardless of terrain — this does not reflect the correct Australian regulatory position',
    'C. 500 ft above the highest terrain according to CASR and applicable CAO requirements',
    'D. 2,000 ft above MSL in all areas as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The aircraft should contact ATIS — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The aircraft should contact the operator\\\'s dispatch — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The aircraft should tune to the emergency frequency 121.5 MHz — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Turn immediately after rotation to the north-east heading — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Turn at 50 ft AGL in any direction at the crew\\\'s discretion — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Level at 500 ft before commencing any turn after take-off — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Always right-hand turns — all non-controlled aerodromes use right-hand circuits — this does not reflect the correct Australian regulatory position',
    'B. Left-hand for all runways unless an obstacle requires right-hand — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Determined by the pilot for each individual flight — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Immediately commence a climb — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Advise ATC of the alert and request amended clearance — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. Disconnect the autopilot and fly manually — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. 45 minutes at normal cruise power — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. 1 hour at normal cruise speed — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. 20 minutes at approach speed at destination as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. For 2-year periods as usual with no additional requirements — this does not reflect the correct Australian regulatory position',
    'B. For 12-month periods (instead of 24 months under 40) — medical examinations are required annually for ATPL holders over 40',
    'C. For 6-month periods above the age of 40 according to CASR and applicable CAO requirements',
    'D. There is no age-related change to medical certificate duration as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. 500 ft AGL for all aircraft at all controlled aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Always 1,500 ft AGL at controlled aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Determined individually by the tower for each arriving aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Continue below DH using the approach lights as visual reference — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Continue to landing using only approach lights as reference — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Contact ATC for permission to use approach lights only as visual reference — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    ...
    'B. Only a current ATPL with more than 5,000 total hours — this does not reflect the correct Australian regulatory position',
    'C. A Grade 1 Flight Instructor Rating at minimum — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Only the operator\\\'s check captain authority — no CASA authorisation is required as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The aircraft to fly straight and level at the current heading indefinitely — this does not reflect the correct Australian regulatory position',
    'B. The aircraft to maintain the filed flight plan heading only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The aircraft to use the autopilot heading mode only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Before the next flight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Within 48 hours by written report only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only if the deviation resulted in an airspace infringement — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    ...
    'B. Only Victoria and Tasmania — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only Australian mainland airspace within 200 nm of Melbourne according to CASR and applicable CAO requirements',
    'D. Exclusively the airspace below FL245 in southeastern Australia as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Only when carrying maximum payload — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Only for flights above 5,700 kg MTOW — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Monthly — a monthly weight and balance check is sufficient as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. A route requiring special qualification — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. A route for supersonic aircraft only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. A temporary route activated by NOTAM — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. An alternate is required for all flights regardless of weather — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Only applies to IFR operations — VFR flights are exempt — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. The departure alternate must be the same as the destination alternate — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. The crew can see the ground and are in VMC — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The captain has more than 1,000 hours on the type — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The aircraft is within 50 nm of the destination aerodrome as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. 150 hours total flight time — this does not reflect the correct Australian regulatory position',
    'B. 500 hours total flight time according to CASR and applicable CAO requirements',
    'C. 200 hours total flight time, including specified cross-country, night, and instrument time',
    'D. 100 hours total flight time as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Jets get even flight levels and propeller aircraft get odd flight levels — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Higher-performance aircraft always get higher flight levels — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. IFR traffic gets even levels and VFR traffic gets odd levels — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    ...
    'B. Correctly allocated — odd levels apply to all northwest tracks — this does not reflect the correct Australian regulatory position',
    'C. Correctly allocated — FLAS only applies to direct east and west tracks according to CASR and applicable CAO requirements',
    'D. Correctly allocated — FLAS only applies above FL200 as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. 0.05 g/100 mL — the same as road driving — this does not reflect the correct Australian regulatory position',
    'B. 0.00 g/100 mL — zero tolerance applies absolutely according to CASR and applicable CAO requirements',
    'C. 0.02 g/100 mL — significantly lower than road driving to reflect the safety-critical nature of aviation',
    'D. 0.08 g/100 mL as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. File a flight plan before entering the aerodrome vicinity — this does not reflect the correct Australian regulatory position',
    ...
    'C. Obtain ATC clearance before entering within 10 nm — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Comply with instrument meteorological conditions rules as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Extending the landing gear only — all other checks occur at the FAF — this does not reflect the correct Australian regulatory position',
    'C. Only confirming the weather is above minimums — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Setting the altimeter to QFE at the destination aerodrome — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Wait 30 days before flying as a precautionary measure — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Self-certify fitness after a personal assessment — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Notify CASA by email before the next flight — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Determine blame and assign penalties for regulatory breaches — this does not reflect the correct Australian regulatory position',
    'B. Support insurance claims and legal proceedings according to CASR and applicable CAO requirements',
    ...
    'D. Certify pilots as competent after incidents as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. 130 KIAS — this does not reflect the correct Australian regulatory position',
    'B. 160 KIAS — the maximum speed for Category C circling (121-140 kt Vat) aircraft in the circling manoeuvre',
    'C. 150 KIAS according to CASR and applicable CAO requirements',
    'D. 180 KIAS as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. The PIC is responsible only for decisions made in the air — this does not reflect the correct Australian regulatory position',
    'C. The PIC and operator share equal responsibility for all aspects of the flight according to CASR and applicable CAO requirements',
    'D. The PIC is responsible only for the aircraft, not the passengers as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Reach 5,000 ft before BUNND at their discretion',
    'B. Cross BUNND at exactly 5,000 ft',
...

{
  ...
  options: [
    'A. Turn the transponder off completely — this does not reflect the correct Australian regulatory position',
    'B. Set the transponder to STANDBY mode — it is powered but not transmitting replies to interrogations',
    'C. Set the transponder to ALT mode according to CASR and applicable CAO requirements',
    'D. Select the emergency code 7700 as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Continue to the destination — the alternate decision was made at planning stage — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Declare an emergency and land at the nearest aerodrome immediately — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Contact the operator for instructions before taking any action — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. 1,000 m — this does not reflect the correct Australian regulatory position',
    'B. 800 m in all circumstances according to CASR and applicable CAO requirements',
    'C. 3,000 m for training flights only as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Only a serviceable autopilot — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. TCAS II only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. A GPS receiver and ADS-B transponder — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Continue to land using approach lights as the sole reference — this does not reflect the correct Australian regulatory position',
    'B. Continue to land — approach lights constitute sufficient visual reference for CAT I according to CASR and applicable CAO requirements',
    ...
    'D. Immediately execute a missed approach — approach lights alone are never sufficient as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. A minor regulatory infringement under CASR — this does not reflect the correct Australian regulatory position',
    'B. A civil offence only — criminal law does not apply to aviation operations according to CASR and applicable CAO requirements',
    ...
    'D. An offence only if injury or death results as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Have flown in the past 3 months — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Are employed by an airline or charter operator — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Hold CASA approval for each individual flight as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Weekly',
    'C. Monthly on the first of each month',
...

{
  ...
  options: [
    'A. Hold an ATPL only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Be employed by CASA directly — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Hold a Grade 1 Flight Instructor Rating as a minimum prerequisite — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. The crew is cleared to cross immediately — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. ATC acknowledges and will issue a clearance shortly — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The crew should hold at the runway and await further instruction — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The aircraft should taxi at a faster than normal speed — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The aircraft should taxi progressively toward the runway without stopping — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. A training manoeuvre where the instructor gives guidance only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Receives full immunity from any prosecution — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Must submit a written statutory declaration within 24 hours — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Cannot be prosecuted for any aviation offence after disclosure — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. FL100 — this does not reflect the correct Australian regulatory position',
    'B. 10,000 ft AMSL according to CASR and applicable CAO requirements',
    'C. FL290 in Australian airspace — aircraft operating at or above FL290 must have serviceable ADS-B OUT',
    'D. FL200 as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. At any speed the crew chooses — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'C. At maximum cruise speed only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. The 180 minutes applies to normal twin-engine cruise speed only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Ground power is unserviceable at the aerodrome — this does not reflect the correct Australian regulatory position',
    'C. GPS is unserviceable in the terminal area — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Ground personnel are unavailable at the aerodrome as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. 5 nm — the same as in lower airspace — this does not reflect the correct Australian regulatory position',
    'C. Always 100 nm in oceanic airspace — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. No lateral separation is applied — only vertical separation is used above FL290 as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Vector the aircraft to the nearest aerodrome by visual signals only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Scramble military aircraft to escort the NORDO aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. Cancel all ATC services until the aircraft re-establishes contact — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Expires annually and must be renewed — this does not reflect the correct Australian regulatory position',
    'B. Must be renewed every 2 years with CASA inspection according to CASR and applicable CAO requirements',
    'C. Expires when the aircraft owner changes as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    'A. Only appeal through CASA\\\'s internal review process — this does not reflect the correct Australian regulatory position',
    ...
    'C. No right of appeal exists once a suspension is imposed according to CASR and applicable CAO requirements',
    'D. Appeal only after the suspension period has expired as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. Only when changing aircraft types — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Only when the AOC is due for renewal — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. At the annual safety audit only — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. The operator\\\'s chief pilot — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. The aircraft manufacturer only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. IATA on behalf of all member airlines — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. A pilot licence',
    'B. Only a first aid certificate',
...

{
  ...
  options: [
    'A. The FLAS only applies to IFR aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. VFR aircraft below 3,000 ft AGL are exempt from all altitude rules — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. The FLAS applies at all altitudes for all aircraft — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
...

{
  ...
  options: [
    'A. Permitted in designated smoking areas — this does not reflect the correct Australian regulatory position',
    'B. Only prohibited during take-off and landing — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Permitted if the aircraft was manufactured before the smoking ban as specified in the relevant CASR Part 91 and CAO provisions',
...

{
  ...
  options: [
    ...
    'B. 15 degrees — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. 45 degrees — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. 5 degrees — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. 5,700 kg — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. 15,000 kg — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Performance classes do not use weight limits — only engine type matters as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Reduce to the stall speed — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Reduce to 150 KIAS regardless of aircraft type — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. Reduce to minimum approach speed immediately — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. CASA under the CASR framework — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Airservices Australia as part of the AIP subscription — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The aircraft manufacturer includes the radio licence with the type certificate as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The weather is unlikely to deteriorate further — this does not reflect the correct Australian regulatory position',
    ...
    'C. The pilot has at least 500 hours total time — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The aircraft is multi-engine only — single-engine IFR is prohibited as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. The aircraft should immediately commence an emergency descent — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The aircraft should use speedbrakes regardless of aircraft limitations — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The aircraft should descend immediately to the LSALT — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    'A. Any time the autopilot is engaged — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Only take-off and landing — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. Only IFR operations in IMC — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Continue using the remaining primary altimeter — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. Descend immediately below FL290 without ATC clearance — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Switch to GPS altitude as the primary reference — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. An annual audit reveals minor documentation errors — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The licence holder fails to pay CASA fees — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. CASA can never suspend a licence without prior notice — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    ...
    'B. 30 minutes at holding speed — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. 20 minutes at normal cruise power — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The same as turbine aircraft — 30 minutes at holding speed as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. 70% — the same as all other ATPL subjects — this does not reflect the correct Australian regulatory position',
    'B. 75% — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. 90% — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Non-precision approaches are conducted in worse weather than precision approaches — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'B. Non-precision approaches do not require an instrument rating — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    ...
    'D. Precision approaches always have lower minima than non-precision — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. The PIC\\\'s authority is subordinate to the operator\\\'s operations centre at all times — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The PIC must consult the company before making any emergency decisions — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. The PIC\\\'s authority applies only to the aircraft — cabin and ground operations are outside their authority — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Estimated figures based on typical operations — exact calculations are not required for charter flights — this does not reflect the correct Australian regulatory position',
    'B. Standard sea level ISA conditions only — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Performance data from the previous flight on the same route as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. 121.5 MHz at all times — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. 122.8 MHz universally — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Broadcasts are not required in Class G — see-and-avoid only as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. A fine only — no imprisonment is possible',
    ...
    'D. 12 months imprisonment maximum'
  ],
  correct: 2,
...

{
  ...
  options: [
    'A. Declare an emergency and land at the nearest aerodrome regardless of conditions — this does not reflect the correct Australian regulatory position',
    ...
    'C. Wait for the PIC to recover before taking any action — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Contact the operator for instructions before assuming command — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Only the total flight time — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Only defects found during the flight — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Journey logs are not required for charter operations under 5,700 kg MTOW as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. Only needs to be updated annually — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. May be kept only at the operator\\\'s principal place of business — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Is only required for international operations — this does not correctly describe the applicable Australian regulatory requirement under CASR',
...

{
  ...
  options: [
    ...
    'B. The pilot has an ATPL — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. The aircraft is above 3,000 ft AGL — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. The aerodrome is uncontrolled — 3 nm proximity rules only apply to controlled aerodromes — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The endorsement is permanent and never expires — this does not reflect the correct Australian regulatory position',
    ...
    'C. The endorsement is valid for 6 years — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Level 4 is not accepted for ATPL — Level 5 minimum is required as specified in the relevant CASR Part 91 and CAO provisions'
  ],
  correct: 1,
...

{
  ...
  options: [
    ...
    'B. Only the aircraft performance data — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'C. Only the ATIS for the destination — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders',
    'D. A briefing from CASA for each flight — this does not correctly describe the applicable Australian regulatory requirement under CASR — this is not the correct requirement under Australian civil aviation law, CASR Part 91, or the applicable Civil Aviation Orders'
  ],
  correct: 0,
...

{
  ...
  options: [
    ...
    'B. Has at least 500 hours total time — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Holds a ground movement endorsement on their licence — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Is authorised by the aircraft\\\'s owner for ground operations — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The aircraft must land immediately — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'B. The transponder may be switched off as it provides no useful information without Mode C — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'D. Operations may continue normally — Mode C is optional at all times — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 2,
...

{
  ...
  options: [
    ...
    'B. Maximise aircraft speed to reduce congestion — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'C. Increase the speed of descent to clear airspace quickly — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Allow pilots to skip STAR altitude constraints — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 0,
...

{
  ...
  options: [
    'A. The ATPL is a combined aeroplane/helicopter licence — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. Helicopter time always counts toward ATPL(A) requirements — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Helicopter time counts if the flights were conducted under IFR — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
...

{
  ...
  options: [
    'A. All three are the same organisation with different functions — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    ...
    'C. CASA oversees both ATSB and Airservices Australia — this does not correctly describe the applicable Australian regulatory requirement under CASR',
    'D. Airservices Australia and CASA are combined; ATSB is separate — this does not correctly describe the applicable Australian regulatory requirement under CASR'
  ],
  correct: 1,
