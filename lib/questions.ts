...
'PPL Theory': [
  {
    ...
    options: ['A. 271.6 kg', 'B. 358 kg', 'C. 251.6 kg', 'D. 338 kg'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['A. 140°M', 'B. 032°M', 'C. 320°M', 'D. 302°M'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['A. 81.0 litres', 'B. 108.0 litres', 'C. 90.0 litres', 'D. 54.0 litres'],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. 3,000 m during TEMPO periods — which may occur around ETA 1414Z within the TEMPO window 1412–1416Z',
      'C. Visibility is not forecast in this TAF',
      'D. 10 km — 9999 always means 10 km or more'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A 10 kt tailwind reduces TODR by approximately 10%',
      'B. A tailwind increases TODR — approximately 10% increase per 2 kt of tailwind component, or as specified in the aircraft performance charts',
      'C. Wind direction has no effect on TODR for aircraft under 1,200 kg',
      'D. A tailwind only affects landing distance, not take-off distance'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Scattered cloud at 18,000 ft with no significant type',
      'B. Scattered towering cumulus with base at 1,800 ft AAL — TCU indicates significant convective development that may produce turbulence and rapidly changing conditions',
      'C. Scattered stratus at 1,800 ft',
      'D. TCU is only reported above FL100'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ['A. 2,745 mm', 'B. 2,828 mm', 'C. 2,927 mm', 'D. 3,004 mm'],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'C. Only a final call is required at non-controlled aerodromes',
  ...
  },
  {
    ...
    options: [
      'A. Class G is controlled airspace requiring ATC clearance',
      'B. Class G is uncontrolled airspace — no ATC separation service is provided to VFR aircraft. Pilots are responsible for collision avoidance under see-and-avoid principles',
      'C. Class G airspace is only found above FL245',
      'D. VFR aircraft are not permitted in Class G airspace'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 18 kt — full cross wind',
      'B. Approximately 14 kt cross wind',
  ...
  },
  {
    ...
    options: [
      ...
      'B. 6,500 ft — even thousands plus 500 ft for westbound VFR (tracks 180°–359°M)',
      'C. 6,000 ft — even thousands for westbound',
  ...
  },
  {
    ...
    options: [
      'A. The aerodrome is permanently closed',
  ...
  },
  {
    ...
    options: [
      'A. Flap increases stall speed and increases landing distance',
      'B. Flap increases lift coefficient — stall speed decreases (allowing lower approach speed), and the associated drag increase also aids deceleration, reducing landing distance',
      'C. Flap has no effect on stall speed',
      'D. Flap reduces drag and stall speed simultaneously'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A 30-minute grace period applies before SAR action begins',
      'B. SAR action commences immediately — the responsible person must initiate the SAR plan: call the destination aerodrome, then notify JRCC Australia if the aircraft cannot be located',
      'C. The pilot must contact NAIPS within 1 hour of SARTIME before SAR action begins',
      'D. SARTIME overruns are only acted on if the delay exceeds 2 hours'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The highest point on the aerodrome surface',
      'B. The elevation of the highest point on the usable runways, expressed in feet AMSL — used as the entry altitude for performance charts',
      'C. The elevation of the aerodrome reference point at the geometric centre',
      'D. The elevation of the lowest runway threshold'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Continue — VFR terrain clearance rules provide adequate separation',
      'B. Turn back immediately — a VFR pilot must not enter IMC. If visual reference cannot be maintained, the flight must be turned back or diverted to maintain VMC',
      'C. Climb above the cloud to maintain VMC',
      'D. Declare an emergency and continue to destination'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. It is used for candidate identification details',
      ...
      'C. The scribble page may be taken out of the examination room for review',
      'D. It is used by the examiner to record candidate scores'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Pressure altitude',
      'B. Landing weight — the note on Figure 4 states that landing distance required does not vary significantly with weight',
      'C. Wind component',
      'D. Temperature'
    ],
    correct: 1,
...
'Human Factors': [
  {
    ...
    options: [
      'A. The pilot has flown too many hours this week',
      'B. 0200–0500 local corresponds to the circadian trough — body temperature, alertness, and cognitive performance are at their daily minimum regardless of prior sleep',
      'C. Drowsiness is caused only by dehydration during night flights',
      'D. Night flights increase carbon dioxide levels in the cockpit'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Yes — windscreen cracks are a Schedule 8 pilot maintenance item',
      ...
      'C. Yes — provided the crack does not exceed 5 cm',
      'D. Yes — the pilot may tape the crack as a temporary repair'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. An upsloping runway causes the pilot to perceive the aircraft is too low',
      'B. An upsloping runway creates the illusion the aircraft is too high — the pilot tends to fly a lower approach, risking undershoot',
      'C. A downsloping runway creates the perception of being too high',
      'D. Runway slope has no effect on pilot approach perception'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Over-the-counter medications are always permitted',
      'B. Many antihistamines cause sedation — a pilot must not fly while impaired by any substance. The pilot should consult a DAME before flying while taking any medication including OTC drugs',
      'C. Antihistamines are only prohibited on IFR flights',
      'D. Medication is only a concern for Class 1 medical holders'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Empty field myopia is short-sightedness corrected by glasses',
      ...
      'C. Empty field myopia only affects pilots over 40',
      'D. It causes the pilot to misjudge runway length'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A knowledge-based mistake requiring more theory training',
      'B. A rule-based mistake — the pilot has learned an incorrect rule or is applying the correct rule incorrectly. Requires targeted retraining on the specific procedure',
      'C. A lapse — the pilot forgets the procedure each time',
      'D. A violation — the pilot is intentionally not following the procedure'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Hypoxia at these altitudes causes immediate incapacitation',
      'B. Early symptoms (euphoria, impaired judgement, false sense of wellbeing) often prevent self-recognition — the pilot feels normal while cognitive performance is already significantly degraded',
      'C. Hypoxia at these altitudes only affects vision, not decision-making',
      'D. Symptoms are obvious and easy to self-diagnose'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Acute fatigue is more serious than chronic fatigue',
      'B. Acute fatigue is short-term fatigue from a single extended duty period — recoverable with adequate rest. Chronic fatigue accumulates over extended periods of inadequate recovery and is not resolved by normal rest',
      'C. Chronic fatigue only affects pilots over 50',
      'D. Acute and chronic fatigue produce identical performance effects'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Cognitive tunnelling improves focus during emergencies',
      'B. Cognitive tunnelling is the narrowing of attention under stress or high workload to a single task — all other information is excluded. Most dangerous during approach and landing where multiple tasks must be monitored simultaneously',
      'C. Cognitive tunnelling only affects inexperienced pilots',
      'D. Cognitive tunnelling is the same as spatial disorientation'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. "I" for Illness — the pilot has a medical condition',
      'B. "E" for Emotion — significant emotional stress degrades decision-making and situational awareness. The pilot should honestly assess fitness to fly and consider standing down',
      'C. IMSAFE does not cover emotional factors',
      'D. The pilot is only unfit if physically ill'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Flicker vertigo is caused by viewing aircraft strobe lighting directly',
      'B. Flicker vertigo is disorientation caused by light flickering at 4–20 Hz — can occur from propeller shadows on the sun, anti-collision strobes in cloud, or helicopter rotor effects. In susceptible individuals it can trigger seizure-like responses',
      'C. Flicker vertigo only occurs during IFR flight',
      'D. Flicker vertigo is the same as motion sickness'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Noise improves alertness and performance by stimulating the brain',
      ...
      'C. Noise only affects older pilots with hearing loss',
      'D. Noise has no measurable effect on flight performance'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Expectation bias always benefits pilots by speeding up routine communications',
      'B. Expectation bias is the tendency to hear what you expect rather than what was said — a pilot expecting "cleared to FL350" may mishear "climb to FL250" as the expected clearance, causing an altitude bust',
      'C. Expectation bias only affects non-English-speaking pilots',
      'D. Expectation bias has no demonstrated effect on read-back accuracy'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. CO poisoning produces an obvious smell of exhaust',
      'B. CO is colourless and odourless — symptoms include headache, dizziness, and confusion. The onset may be gradual, impairing judgement before the pilot recognises the problem',
      'C. CO poisoning only occurs if the exhaust system is visibly cracked',
      'D. CO detectors are not recommended for general aviation aircraft'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Only the initial licence check is required — no recency requirements exist',
      ...
      'C. Recency requirements only apply to commercial operations under Part 121',
      'D. 1 flight per year satisfies all recency requirements'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Stress inoculation is the process of vaccinating pilots against infectious diseases',
      'B. Stress inoculation progressively exposes pilots to realistic emergency scenarios in a controlled simulator environment — building resilience and practised automatic responses so real emergencies trigger trained reactions rather than panic',
      'C. Stress inoculation only applies to military aviation',
      'D. Stress inoculation is used to remove unsuitable pilots from service'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Ignore it — fuel gauges in light aircraft are notoriously inaccurate',
      'B. Cross-check against calculated fuel burn, check for fuel leaks, consider the consequences of being wrong, and plan a precautionary landing if fuel state cannot be confirmed',
      'C. Continue to destination — there is still fuel showing on the gauge',
  ...
  },
  {
    ...
    options: [
      ...
      'D. CO symptoms are only present if exhaust fumes can be smelled'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Crew briefings are only required for multi-crew operations',
      'B. A pre-departure briefing establishes shared situational awareness: route and weather threats, NOTAMs, fuel state and alternates, emergency procedures, roles and communication plan, and personal fitness (IMSAFE)',
      'C. Pre-departure briefings are completed by filling out the flight plan only',
      'D. Crew briefings cover only fuel and weather'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Higher arousal always produces better performance',
      'B. The Yerkes-Dodson law describes an inverted-U relationship between arousal and performance — optimal performance occurs at a moderate level of arousal. Too little arousal (boredom) or too much (stress) both degrade performance',
      'C. The Yerkes-Dodson law only applies to physical tasks, not cognitive flying tasks',
      'D. Arousal has no measurable effect on complex decision-making'
    ],
    correct: 1,
...
'Aerodynamics': [
  {
    ...
    options: [
      'A. Induced drag is constant regardless of airspeed',
      ...
      'C. Both drag types increase with decreasing airspeed',
      'D. Parasite drag increases with lower airspeed'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Torque effect causes the aircraft to pitch nose-up',
      'B. The engine rotates the propeller clockwise (viewed from behind), so the reaction tends to roll the aircraft anti-clockwise (left). Corrected by aileron rigging bias (slight right aileron droop)',
      'C. Torque effect only occurs at full power on takeoff',
      'D. Torque effect is counteracted by rudder input only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Gyroscopic precession causes the aircraft to pitch up during takeoff',
      'B. When the tail is raised, the top of the propeller disc moves forward — precession causes a yawing force 90° later in the direction of rotation (to the left for a clockwise-rotation propeller), requiring right rudder',
      'C. Gyroscopic precession only affects jet aircraft',
      'D. Precession causes the aircraft to roll right during takeoff'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Best glide speed is the same as Vne',
      'B. Best glide speed (Vbg) is the speed of maximum L/D ratio (Vmd) — it gives maximum glide distance per unit of altitude lost',
      'C. Best glide speed gives the maximum time in the air with no power',
      'D. Best glide speed is always 1.3 × stall speed'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Higher weight reduces stall speed at constant AoA',
      'B. At constant AoA (constant CL), higher weight requires higher speed to generate sufficient lift — stall speed increases proportionally to √(W2/W1)',
      'C. Weight has no effect on stall speed — only AoA matters',
      'D. Higher weight decreases the lift required'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Slipstream only affects multi-engine aircraft',
      'B. The propeller imparts a helical rotation to the slipstream. At high power/low speed, this spiralling airflow strikes the vertical tail at an angle, producing a sideways force that causes the aircraft to yaw left (for a clockwise-rotation propeller)',
      'C. Slipstream causes the aircraft to pitch nose-up only',
      'D. Slipstream has no net effect on aircraft yaw'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ['A. 74 KIAS', 'B. 53 KIAS', 'C. 48 KIAS', 'D. 58 KIAS'],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. It prevents the wing from flexing at high speed',
      ...
      'C. A stall strip improves climb performance',
      'D. Stall strips are only used on swept-wing aircraft'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. High aspect ratio increases induced drag',
      'B. Aspect ratio = wingspan²/wing area. High aspect ratio wings have smaller wingtip vortices relative to total span — less induced drag for the same lift. Gliders have high aspect ratios for efficient soaring',
      'C. Aspect ratio has no effect on drag — only on lift',
      'D. Low aspect ratio reduces both induced and parasite drag'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Vy and Vx are always at the same speed',
      'B. Vy is always faster than Vx. Vx gives maximum altitude gain per unit of distance (obstacle clearance). Vy gives maximum altitude gain per unit of time (efficient sustained climb)',
      'C. Vx is faster than Vy at sea level only',
      'D. The relationship reverses at high altitude'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Normal +3.8g / -1.52g; Utility +4.4g / -1.76g — stated separately',
      'B. Normal +3.8g to -1.52g; Utility +4.4g to -1.76g. Utility allows limited aerobatics. Aerobatic category: +6.0g to -3.0g',
      'C. All categories have identical structural limits',
      'D. Normal +2.5g; Utility +3.0g'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. A spin requires both a stall AND yaw — one wing is more stalled. Recovery: full opposite rudder, pause, forward elevator (unstall), centralise controls, recover from dive',
      'C. Spin recovery requires full back stick and power',
      'D. Both wings must be fully stalled for a spin to develop'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Both Vno and Vne increase with altitude',
      'B. Vno and Vne expressed in KIAS remain approximately constant with altitude — structural loads depend on dynamic pressure (½ρV²) which is what IAS measures directly',
      'C. Vno decreases with altitude but Vne remains constant',
      'D. Both speeds decrease significantly with altitude'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The region of reversed command only exists above 10,000 ft',
      ...
      'C. In the region of reversed command, less power is needed at lower speeds',
      'D. The region of reversed command does not affect landing performance'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Frost has no measurable effect on aerodynamic performance',
      'B. Even a thin layer of frost disrupts the smooth laminar boundary layer — this can increase stall speed by 5–10% and reduce CLmax by up to 30%, potentially causing the aircraft to stall at takeoff speed',
      'C. Frost only affects drag, not lift',
      'D. Frost only becomes dangerous above 5 mm thickness'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Adverse aileron yaw causes the aircraft to pitch nose-up when ailerons are applied',
      'B. When ailerons are deflected to roll right, the downgoing left aileron creates more drag on the left wing — the nose yaws LEFT, opposite to the intended turn direction',
      'C. Adverse yaw requires no correction in modern aircraft',
      'D. Adverse aileron yaw only occurs in swept-wing aircraft'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Higher density altitude improves propeller efficiency',
      ...
      'C. Propeller performance is unaffected by density altitude',
      'D. Density altitude only affects piston engine output, not propeller thrust'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The CP moves progressively aft as AoA increases',
      'B. For a conventional cambered aerofoil, the CP generally moves forward as AoA increases toward the critical angle — the increasing suction peak moves toward the leading edge. Beyond the critical AoA, the CP moves sharply aft as separation occurs',
      'C. The CP remains fixed at 25% chord for all angles of attack',
      'D. CP movement has no effect on aircraft stability'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Ground effect increases induced drag during takeoff roll',
      'B. Ground effect reduces induced drag when the aircraft is within approximately one wingspan of the ground — the wing\'s upwash/downwash is restricted. This allows the aircraft to become airborne before reaching the speed required for sustained flight outside ground effect',
      'C. Ground effect only applies to landing, not takeoff',
      'D. Ground effect increases stall speed near the ground'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Dutch roll is a longitudinal oscillation corrected by elevator trim',
      'B. Dutch roll is a coupled lateral-directional oscillation (alternating roll and yaw). It occurs when directional stability is weaker than lateral stability. Controlled by a yaw damper on transport aircraft; manually by applying rudder to stop the yaw component',
      'C. Dutch roll only occurs in turboprop aircraft',
      'D. Dutch roll is the same as pilot-induced oscillation'
    ],
    correct: 1,
...
'Aircraft General Knowledge': [
  {
    ...
    options: [
      'A. Venting prevents fuel evaporation only',
      'B. Fuel tank vents allow air to enter as fuel is consumed, preventing a vacuum that would restrict fuel flow. A blocked vent causes fuel starvation — the engine runs normally then fuel flow stops despite fuel being present',
      'C. Tank vents are only required on tanks with electric pumps',
      'D. A blocked vent causes the fuel cap to be ejected'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Both magnetos have failed and the flight should not proceed',
      'B. Both magnetos are satisfactory — an 80 RPM drop is within typical limits (~125 RPM max), and a 20 RPM differential is well within the typical 50 RPM maximum difference',
      'C. The magneto with 80 RPM drop requires immediate maintenance',
      'D. Zero RPM drop indicates a perfect magneto; 80 RPM is excessive'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The pitot-static system powers the attitude indicator',
      'B. Airspeed indicator (pitot − static), altimeter (static only), and vertical speed indicator (rate of change of static). The AI and DI use vacuum',
      'C. Static pressure only powers the airspeed indicator',
      'D. The pitot-static system powers all six primary flight instruments'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Continue to destination — oil pressure lights are often false alarms',
      ...
      'C. Apply full power to reach the nearest aerodrome quickly',
      'D. Shut down the engine immediately regardless of position'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The alternator and battery provide identical functions and are interchangeable',
      'B. The alternator (engine-driven) continuously charges the battery and powers electrical systems in flight. The battery provides starting power and is a backup if the alternator fails',
      'C. The battery powers all systems in flight; the alternator is only for starting',
      'D. The alternator operates above 2,000 RPM only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Continue climbing to increase altitude before assessing',
      'B. Throttle CLOSE, fuel selector OFF, ignition OFF, master OFF, maintain glide speed, declare MAYDAY, land ahead with minimum turn',
      'C. Apply full power and climb away from the ground quickly',
      'D. Open cockpit vents to supply fresh air to extinguish the fire'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The primer system enriches the mixture during cruise at altitude',
      ...
      'C. The primer is used after landing to clear the carburetor',
      'D. Priming is required before every start regardless of temperature'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Static wicks improve radio antenna reception',
      'B. Static wicks are installed at trailing edges and wing/tail tips — they bleed off electrostatic charge from airflow friction, reducing precipitation static (P-static) interference on communications and navigation radios',
      'C. Static wicks are only required on metal aircraft',
      'D. Static wicks are lightning protection devices'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The AI and DI have already failed completely',
      'B. The vacuum pump has failed — the AI and DI are no longer reliably driven and will slowly precess over the next 10–15 minutes. Cross-check with the turn coordinator (electrically powered)',
      'C. The vacuum system requires routine servicing — continue flight normally',
      'D. The vacuum light only activates below 1,000 ft AGL'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Detonation and pre-ignition are the same phenomenon',
      ...
      'C. Detonation only occurs at idle power settings',
      'D. Pre-ignition is harmless; detonation causes engine damage'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Pitot heat is used to warm the cockpit in cold conditions',
      'B. Pitot heat electrically heats the pitot tube to prevent ice from blocking the impact pressure inlet — blockage causes erroneous airspeed. Should be activated before entering icing conditions (cloud, rain, below 10°C OAT)',
      'C. Pitot heat is only required above FL100',
      'D. Pitot heat activates automatically when OAT drops below 0°C'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Fuel-injected engines are immune to all forms of fuel-related icing',
      'B. Fuel injection meters fuel directly to each port — there is no venturi cooling effect eliminating carburettor ice risk. However, induction system icing can still affect injected engines by blocking the air intake',
      'C. Fuel-injected engines are more susceptible to icing',
      'D. Fuel injection eliminates all forms of engine icing'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Avtur has the same octane rating as AVGAS and can be used in an emergency',
      ...
      'C. Avtur improves piston engine performance at altitude',
      'D. Avtur causes no immediate harm but reduces engine life over time'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The firewall is a structural bulkhead providing primary fuselage strength',
      'B. The firewall is a heat and fire-resistant barrier between the engine and cockpit — typically stainless steel or titanium. It contains an engine fire and prevents it spreading to occupants',
      'C. The firewall is made from composite materials to save weight',
      'D. The firewall also serves as the instrument panel mounting structure'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Reset all tripped circuit breakers immediately',
      'B. Do not reset unless the system is essential for safe flight — wait 1–2 minutes, attempt a single reset. If it trips again, leave it out and manage the associated system failure',
      'C. All circuit breakers may be safely reset three times',
      'D. Circuit breakers should be reset by the cabin crew only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. GPWS provides traffic collision avoidance',
      'B. GPWS/TAWS monitors flight parameters and terrain proximity to provide aural/visual warnings of unsafe terrain proximity. Immediate response: maximum power, maximum pitch (within limitations), climb — do not hesitate',
      'C. GPWS only works below 1,000 ft AGL',
      'D. EGPWS and TCAS are the same system'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A high EGT always indicates engine over-temperature requiring shutdown',
      'B. High EGT at normal power may indicate lean mixture (approaching or past peak EGT), partially blocked exhaust, or impending valve failure. EGT is the primary mixture management tool — peak EGT indicates stoichiometric mixture',
      'C. High EGT only occurs during engine start',
      'D. EGT is not relevant to piston engine management'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Forward CG reduces aircraft stability',
      'B. Forward CG increases longitudinal stability but increases stall speed (more elevator needed), reduces elevator effectiveness, increases trim drag, and increases fuel consumption',
      'C. Forward CG has no effect on stall speed',
      'D. Forward CG only affects handling in turbulence'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Anti-skid systems are identical to road vehicle ABS',
      'B. Hydraulic brakes apply direct pilot-controlled pressure to the brake pads. Anti-skid systems automatically modulate brake pressure when wheel deceleration sensors detect an impending skid, allowing maximum braking without wheel lock-up',
      'C. Anti-skid systems only work above 80 knots',
      'D. Hydraulic brakes are more effective than anti-skid on dry runways'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'C. The aerodrome has no instrument approaches',
      'D. Only aircraft under 1,200 kg may use unlicensed aerodromes'
    ],
    correct: 1,
...
'Meteorology': [
  {
    ...
    options: [
      'A. 20°C, 1013 hPa, 2.0°C/1,000 ft',
      'B. 15°C, 1013.25 hPa, approximately 2°C/1,000 ft to the tropopause at approximately FL363',
      'C. 15°C, 1000 hPa, 3.0°C/1,000 ft',
      'D. 20°C, 1013.25 hPa, 1.5°C/1,000 ft'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Both are identical at approximately 3°C/1,000 ft',
      'B. DALR ≈ 3°C/1,000 ft applies to unsaturated rising air. SALR ≈ 1.5°C/1,000 ft applies to saturated air — latent heat released during condensation reduces the cooling rate',
      'C. SALR is steeper than DALR — saturated air cools faster',
      'D. DALR applies above the tropopause; SALR below it'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. All thunderstorms are classified as severe',
      ...
      'C. Severe thunderstorms are defined only by lightning intensity',
      'D. Severe thunderstorms only produce rainfall above 100 mm/hr'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Carburettor icing is not possible above 0°C',
      'B. Temperature 8°C, dewpoint 6°C — a 2°C spread indicates high relative humidity. Combined with the venturi cooling effect (~20°C), carburettor temperature could be −12°C, creating HIGH icing risk',
      'C. Only temperature matters for carburettor icing assessment',
      'D. A 2°C spread means carburettor icing is impossible'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Valley fog forms when warm moist air flows over cold mountain terrain',
      'B. Valley fog forms through: radiative cooling of the valley floor (clear sky, calm winds), cold air drainage (denser cold air pools in the valley), and high relative humidity. It typically dissipates 2–3 hours after sunrise',
      'C. Valley fog is caused by orographic lifting only',
      'D. Valley fog forms only in winter'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A temperature inversion always improves visibility and performance',
      ...
      'C. Temperature inversions only occur above FL200',
      'D. Inversions improve engine performance by providing denser air'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. FM and BECMG describe identical changes',
      'B. FM (From) indicates an abrupt change at the specified time — all conditions change instantaneously. BECMG indicates a gradual change completing within the specified time period',
      'C. FM only applies to wind changes; BECMG applies to visibility',
      'D. Both FM and BECMG indicate temporary conditions'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Sea breeze is a wind from the land toward the sea — strongest in the morning',
      'B. The sea breeze develops when land heats faster than the sea — cool sea air flows onshore. Effects: wind change from morning to afternoon, possible CB development along the sea breeze front, and sudden wind shift on approach',
      'C. Sea breeze has no effect on aviation operations',
      'D. Sea breezes only affect aerodromes within 1 km of the coast'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. PROB40 means the conditions are almost certain to occur',
      ...
      'C. PROB40 and PROB30 have identical planning implications',
      'D. PROB40 conditions require no alternate planning'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The Foehn effect produces identical conditions on both sides of a range',
      'B. Moist air rises on the windward side (cools at SALR, precipitates moisture), then descends on the leeward side (warms at DALR — now dry). Result: windward = cool, cloudy, wet; leeward = warm, dry, clear with gusty winds',
      'C. The Foehn effect produces colder temperatures on the leeward side',
      'D. The Foehn only occurs in the European Alps'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. ATIS codes are used to identify individual aircraft on radar',
      'B. Each new ATIS recording is assigned a sequential phonetic alphabet letter. Pilots include the ATIS code in their initial call to confirm they have current aerodrome information. ATC confirms or advises of an updated ATIS',
      'C. ATIS codes change every 30 minutes regardless of weather',
      'D. ATIS codes identify the controller on duty'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The GAF covers FL240 to FL450',
      'B. The GAF provides graphical weather forecasts from surface to FL100 (lower GAF) and surface to FL180 (upper GAF). It shows cloud layers, visibility, icing, turbulence, mountain wave, and area boundaries',
      'C. The GAF is a pilot weather report',
      'D. GAFs are only available for controlled aerodromes'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Mountain wave turbulence only exists below 5,000 ft AGL',
      'B. Mountain waves form when stable air crosses elevated terrain — waves can extend from the surface to 50,000 ft or above. The rotor zone (below wave crests) contains the most severe turbulence but moderate-severe turbulence can exist at all altitudes',
      'C. Mountain wave turbulence is always identified by lenticular clouds',
      'D. Mountain waves only form in the European Alps and Rockies'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. QNH is the pressure at FL180 converted to sea level',
      'B. QNH is the local altimeter setting that makes the altimeter read field elevation on the ground. If actual QNH is lower than set, the altimeter reads HIGH — the aircraft is actually LOWER than indicated (dangerous on approach)',
      'C. QNH errors of up to 10 hPa have no practical effect on approach safety',
      'D. QNH only affects altimeter accuracy above FL100'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Conditional instability is a type of absolute instability',
      'B. Conditional instability exists when the ELR is between the SALR and DALR. Dry air lifted through this layer is stable. But if air is forced above its lifting condensation level and becomes saturated, it may become unstable relative to the SALR and continue rising — producing CBs with sufficient lift',
      'C. Conditional instability always produces thunderstorms',
      'D. Conditional instability does not exist in the atmosphere'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Maintain current power setting and continue the approach',
      ...
      'C. Increase descent rate to land before the shear zone',
      'D. Reduce power to the normal approach setting and continue'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A routine METAR issued at a fixed schedule',
      'B. A SPECI is a Special Meteorological Report issued when significant weather changes occur between routine METARs — triggers include visibility crossing 800m/1,500m/5,000m thresholds, cloud base changes, or onset/cessation of thunderstorm or freezing precipitation',
      'C. A SPECI is a TAF amendment',
      'D. A SPECI is a pilot weather report (PIREP)'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. An occlusion is a stationary front that never moves',
      'B. An occlusion forms when a cold front catches and lifts a warm front — the warm sector is lifted above the surface. Warm occlusion: stratiform cloud and steady rain. Cold occlusion: more convective with embedded CBs and turbulence',
      'C. Occluded fronts produce fair weather',
      'D. An occlusion only occurs in tropical regions'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A trough of low pressure always produces stable, fair weather',
      ...
      'C. Troughs only affect aviation above FL200',
      'D. East coast troughs produce only light winds and drizzle'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Relative and absolute humidity are the same measurement',
      'B. Absolute humidity is the actual mass of water vapour per unit volume of air. Relative humidity is the ratio of actual water vapour content to the maximum possible at that temperature, expressed as a percentage',
      'C. Relative humidity increases as temperature falls',
      'D. Absolute humidity determines whether precipitation occurs'
    ],
    correct: 1,
...
'Navigation': [
  {
    ...
    options: ['A. 5.0° right', 'B. 3.0° right', 'C. 7.0° right', 'D. 2.0° right'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['A. 84 NM', 'B. 45.4 NM', 'C. 52.0 NM', 'D. 38.8 NM'],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. They measure the same compass error from different reference points',
      'B. Variation is the angular difference between true north and magnetic north at a geographic location — published on charts as isogonals. Deviation is the compass error caused by the aircraft\'s own magnetic field — varies with aircraft heading and recorded on the compass deviation card',
      'C. Deviation is always a larger error than variation',
      'D. Variation changes with aircraft heading; deviation is constant'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. LSALT guarantees 500 ft clearance within 1 NM of track',
      'B. LSALT provides a minimum of 1,000 ft clearance above the highest obstacle or terrain within 5 NM either side of track (or 10 NM in mountainous areas). It does not guarantee radio coverage or radar contact',
      'C. LSALT is the minimum altitude for VFR operations only',
      'D. LSALT provides 2,000 ft clearance above all terrain'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. True + Variation = Magnetic; Magnetic + Deviation = Compass',
      ...
      'C. True = Magnetic = Compass in Australia',
      'D. Magnetic + Variation = True; True + Deviation = Compass'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Homing means flying the heading that places the NDB behind the aircraft',
      'B. Homing means maintaining the ADF needle on 000° by continuously adjusting heading. Limitation: in a crosswind, the aircraft follows a curved path to the station, drifting downwind — it arrives at the station from an unpredictable direction',
      'C. NDB homing gives a straight-line track regardless of wind',
      'D. Homing is the same as tracking'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. ERSA contains only instrument approach charts and is updated annually',
      'B. ERSA contains detailed aerodrome information: frequencies, runways, lighting, fuel types and hours, facilities, circuit direction, local procedures, noise abatement, contact details. Updated on the 56-day AIRAC cycle',
      'C. ERSA is updated weekly by NOTAM',
      'D. ERSA covers international aerodromes only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. Generally 10,000 ft AMSL (varies by area — check AIP ENR 1.7). Below: QNH. At or above the transition layer: 1013.25 hPa (standard setting) using flight levels',
      'C. The transition altitude is FL180 throughout Australia',
      'D. Aircraft change to 1013.25 hPa only at FL240'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 7,000 ft — even thousands for eastbound',
      'B. 7,500 ft — odd thousands plus 500 ft for eastbound (tracks 000°–179°M)',
      'C. 6,500 ft — even thousands plus 500 ft',
      'D. 8,000 ft — even thousands for eastbound'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Position reports are only required at the boundary of controlled airspace',
      'B. Position reports provide ATC with aircraft location for procedural separation without radar. Required elements: callsign, position, time (UTC), flight level, next position and ETA, subsequent waypoint',
      'C. Position reports are replaced by transponder squawk in all controlled airspace',
      'D. Position reports require only callsign and altitude'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The 1 in 60 rule: 1 NM error per 60 NM flown = 1° track error only',
      'B. At any distance, cross-track error (NM) × 60 / distance (NM) = angle in degrees. TEA = cross-track × 60 / distance flown. Closing Angle (CA) = same cross-track × 60 / distance remaining. Total correction = TEA + CA',
      'C. The rule only applies to distances up to 60 NM',
      'D. 1 in 60 calculates fuel burn not track error'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A STAR is a suggested routing that aircraft may follow at their discretion',
      ...
      'C. STARs are only published for visual approaches',
      'D. A STAR clearance supersedes all ATC altitude restrictions'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. ERC LOW covers FL245 to FL600',
      'B. ERC LOW (En Route Chart Low) is used for IFR and VFR navigation below FL200 approximately. It shows airways, NavAids, controlled airspace boundaries, mandatory broadcast zones, and grid LSALTs',
      'C. ERC LOW charts are only for VFR navigation',
      'D. ERC LOW is used for oceanic navigation only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The transition layer is where weather radar cannot detect returns',
      'B. The transition layer is the airspace between the transition altitude and the transition level. Aircraft ascending through the layer change from QNH to 1013.25 hPa; descending aircraft change from standard to QNH. No level flight is conducted within the transition layer',
      'C. The transition layer is a permanent feature at FL180',
      'D. Aircraft maintain QNH throughout the transition layer'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A DME arc is a straight-in approach using only DME distance',
      ...
      'C. DME arcs are only used as missed approach procedures',
      'D. A DME arc is the same as an NDB arc'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ['A. 600 ft/min', 'B. 1,000 ft/min', 'C. 800 ft/min', 'D. 1,200 ft/min'],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A fix triangle is always caused by compass deviation',
      'B. When three position bearings are taken, they may not intersect at a single point — forming a small triangle. A small triangle is acceptable. A large triangle indicates error in one or more bearings — the true position is within the triangle',
      'C. A fix triangle always means the aircraft is at the centre of the triangle',
      'D. Three bearings always intersect at a single perfect point'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A SID is a suggested routing for VFR departures only',
      ...
      'C. SID altitudes are advisory only',
      'D. A SID clearance removes the need for a departure ATC clearance'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Entering Class G airspace without clearance is a controlled airspace penetration',
      'B. Entering Class A, C, D, or E airspace without the required ATC clearance is a serious airspace infringement. Legal consequences: CASA investigation, possible licence suspension, civil penalty, and mandatory reporting',
      'C. A clearance is only required for Class A and C airspace',
      'D. Controlled airspace penetrations are handled by ATC with no pilot consequences'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. SARWATCH is a voluntary service with no mandatory requirements',
      'B. SARWATCH is a search and rescue watch lodged with NAIPS or a responsible person. Activating SARWATCH means the responsible person commences timing. If the aircraft does not report by the SARTIME, SAR action is immediately initiated',
      'C. SARWATCH only applies to overwater flights',
      'D. SARWATCH is automatically closed when the pilot lands'
    ],
    correct: 1,
...
'Operations Performance Planning': [
  {
    ...
    options: [
      ...
      'C. The CG is at the most rearward acceptable position',
      'D. 2,710 mm is beyond the aft limit'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ['A. 457.4 kg', 'B. 515 kg', 'C. 437.4 kg', 'D. 362.4 kg'],
    correct: 0,
  ...
  },
  {
    ...
    options: [
      'A. Trip fuel + 30 minutes contingency',
      'B. Trip fuel + 45 minutes at cruise power reserve',
  ...
  },
  {
    ...
    options: [
      'A. The 1.15 factor increases the chart distance by 15% for wet runways only',
      'B. The chart already incorporates a 1.15× safety factor over the demonstrated (actual) distance — the aircraft\'s actual performance will be approximately 15% better than the chart value under identical conditions',
      'C. The 1.15 factor is applied to fuel calculations, not distance',
      'D. A factor of 1.15 indicates the chart is for heavy aircraft only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Higher elevation reduces TODR due to thinner air reducing drag',
      'B. Higher elevation increases TODR — reduced air density reduces engine power output and propeller efficiency. The aircraft must reach a higher TAS to achieve lift-off, requiring a longer ground roll',
      'C. Elevation only affects landing distance, not TODR',
      'D. TODR is constant regardless of aerodrome elevation'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. BRW is the weight after fuel burn to cruise altitude',
      'B. BRW is the weight at the start of the take-off roll (when brakes are released). It is the relevant weight for take-off performance calculations — equivalent to take-off weight (TOW)',
      'C. BRW is the weight at landing',
      'D. BRW equals ramp weight minus fuel loaded'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The aircraft is at maximum take-off weight',
      'B. The aircraft is loaded outside certified CG limits — it is unairworthy and must not be flown until the load is re-distributed to bring both ZFW and take-off weight plots within the envelope',
      'C. The Alpha system does not use a CG envelope',
      'D. Outside the envelope is acceptable if only the ZFW point is outside'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Depart at MTOW + 10% for short trips only',
      ...
      'C. Accept the overweight if runway length is at least 1,000 m',
      'D. MTOW may be exceeded by 5% in emergency conditions'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A tailwind reduces LDR by reducing ground speed',
      'B. A tailwind increases LDR — the aircraft is travelling faster over the ground at a given approach IAS, increasing the ground roll and total landing distance',
      'C. Wind direction only affects TODR, not LDR',
      'D. A tailwind reduces stall speed and therefore reduces LDR'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Long dry grass reduces TODR by 10%',
      'B. The CASA Workbook charts show separate reference lines: Short Dry Grass (reference baseline), Long Dry or Short Wet Grass (higher TODR), and Long Wet Grass (highest TODR) — due to increased rolling resistance',
      'C. Grass surfaces have no effect on TODR for aircraft under 1,000 kg',
      'D. Long dry grass and short dry grass produce identical TODR'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ['A. 51.1 kg·m', 'B. 165.6 kg·m', 'C. 92.0 kg·m', 'D. 0.51 kg·m'],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. ZFW is calculated after fuel is loaded for the final load sheet',
      'B. ZFW = aircraft weight with all load but NO fuel. The ZFW must not exceed MZFW (Maximum Zero Fuel Weight) — a structural limit on fuselage bending. Checking ZFW first ensures the dry load is within limits before fuel is added',
      'C. ZFW only applies to aircraft over 5,700 kg',
      'D. ZFW and MTOW are equivalent limits'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The climb limit weight appears on the take-off charts only',
      'B. Climb limit weight is the maximum weight at which the aircraft can meet the required climb gradient on a missed approach. At high altitude/temperature, the climb limit may be more restrictive than the structural MLW',
      'C. Climb limit weight is always the same as MTOW',
      'D. Climb limit weight is only relevant for IFR operations'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Rearward CG increases stability and reduces stall speed',
      ...
      'C. Rearward CG has no effect on aircraft stall speed',
      'D. Rearward CG only affects landing characteristics'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A precautionary search is optional at familiar aerodromes only',
      'B. A precautionary search is a low pass over the landing area to assess surface condition, obstacles, slope, circuit direction, and wind — conducted at circuit height (1,000 ft AGL) then lower if required',
      'C. A precautionary search must be conducted at exactly 500 ft AGL only',
      'D. A precautionary search is only required when NOTAM states the aerodrome is unserviceable'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Useful load and payload are identical',
      'B. Useful load = MTOW − BEW — it includes fuel, pilot, passengers, and freight. Payload = weight of revenue-generating items (passengers and freight) excluding fuel and crew in commercial operations',
      'C. Useful load excludes fuel; payload includes fuel',
      'D. Payload always equals maximum useful load'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Upslope reduces TODR; downslope increases TODR',
      ...
      'C. Slope only affects aircraft above 1,000 kg MTOW',
      'D. Downslope increases TODR due to steeper lift-off angle'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 1 hour at normal cruise power',
      'B. Trip fuel + 45 minutes at normal cruise power — the same as VFR day under CASR Part 91 MOS Table 19.02',
      'C. Trip fuel + 30 minutes at normal cruise power',
      'D. Trip fuel + 2 hours for night operations'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. CG expressed in mm aft of datum',
      'B. Moment/1,000 inch-pounds — weight (lbs) × arm (inches) / 1,000. The intersection of total weight and total Moment/1,000 must fall within the CG envelope',
      'C. Loading System Bravo uses index units',
      'D. Bravo expresses CG as a percentage of wingspan'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Density altitude is the same as pressure altitude',
      'B. Density altitude is the pressure altitude corrected for non-standard temperature — it represents the altitude in the standard atmosphere with the same air density. High temperature above ISA = density altitude higher than pressure altitude',
      'C. Density altitude only affects aircraft above 10,000 ft',
      'D. Density altitude is calculated from QNH only'
    ],
    correct: 1,
...
'Flight Rules and Air Law': [
  {
    ...
    options: [
      'A. 1,500 m and clear of cloud',
      'B. 5 km flight visibility, 1,000 ft above cloud, 1,000 ft below cloud, 1 NM horizontally from cloud',
      'C. 8 km and CAVOK',
      'D. 3 km and 500 ft vertical cloud clearance'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 70% — standard pass for all CPL subjects',
      'B. 80% — Air Law requires a higher pass mark at both CPL and ATPL levels',
  ...
  },
  {
    ...
    options: [
      ...
      'C. 1 flight in the preceding 12 months',
      'D. Only a valid medical is required — no recency applies'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. An MBZ is a controlled zone requiring ATC clearance',
      ...
      'C. MBZ broadcasts are optional — "mandatory" refers to the frequency',
      'D. MBZ applies only to IFR aircraft'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Night begins exactly at sunset and ends at sunrise',
      'B. CASR Part 91 defines night as the period from 30 minutes after sunset to 30 minutes before sunrise',
  ...
  },
  {
    ...
    options: [
      ...
      'B. The glider has right of way — gliders take priority over all powered aircraft under CASR Part 91 right-of-way rules',
      'C. The aircraft with the other on its left must give way',
      'D. Larger aircraft always have right of way'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. NOTAMs are permanent aeronautical information documents',
      ...
      'C. NOTAMs are only issued for runway closures',
      'D. NOTAMs are advisory only and need not be checked before CPL operations'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A verbal warning from CASA only',
      'B. A strict liability offence under CASR Part 91 — penalties include licence suspension/cancellation, civil penalties, and possible criminal charges. Random breath testing programs exist at aerodromes',
      'C. Only applies to Part 121 commercial operations',
      'D. The 0.02% limit is advisory only — 0.05% applies at law'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Clear to land',
      'B. Give way to other aircraft and continue circling — do not land',
      'C. Airport is closed',
      'D. Red is not a tower signal'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. 250 KIAS below 10,000 ft AMSL — VFR and IFR speed limits are the same below 10,000 ft',
      'C. There is no VFR speed limit — only structural limits apply',
      'D. 200 KIAS for VFR operations below 3,000 ft'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Yes — all electronic equipment replacement is a Schedule 8 task',
      'B. No — Schedule 8 does not include radio transceiver replacement. This requires a LAME or avionics approved person',
      'C. Yes — provided the replacement unit is identical to the original',
  ...
  },
  {
    ...
    options: [
      'A. Special VFR allows flight in Class A airspace',
      ...
      'C. SVFR allows night VFR operations without an IFR rating',
      'D. SVFR is identical to an IFR clearance'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Only the aircraft documentation is required',
      'B. Pilot licence (or licence evidence), current Class 1 medical certificate, and any applicable ratings/endorsements required for the specific operation',
      'C. A CPL must carry a notarised copy of their licence',
      'D. Documents are only required for international flights'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 0000',
      'B. 7000 — the standard VFR squawk in Australia when no specific code has been assigned',
  ...
  },
  {
    ...
    options: [
      'A. 12 hours flight time in any 24-hour period',
      'B. Generally 8 hours flight time in any 24-hour period for single-pilot commercial operations, though FDP limits may be the more restrictive factor',
      'C. No limit applies for CPL operations under 5,700 kg',
      'D. 10 hours in any 24-hour period for all CPL operations'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Aircraft must be washed before each scheduled flight',
      'B. No aircraft may take off with frost, ice, or snow adhering to any lift-producing or control surface. Positive confirmation (visual and physical inspection) is required',
      'C. Clean aircraft concept only applies to aircraft over 5,700 kg',
      'D. Ice on tail surfaces may be accepted if the wings are clear'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Unregistered aircraft may be operated for private non-commercial flights',
      'B. Operating an unregistered aircraft is an offence under the Civil Aviation Act 1988. Civil penalties and possible criminal charges apply',
      'C. Registration is only required for commercial RPT operations',
      'D. Unregistered aircraft can operate if the owner can prove airworthiness'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The most senior cabin crew member',
      'B. The PIC is the pilot responsible for the operation and safety of the aircraft during flight time. Must hold the appropriate licence, current medical, and meet recency requirements',
      'C. The company operations manager designates PIC in writing before each flight',
      'D. On a two-crew aircraft, both pilots share PIC responsibility equally'
    ],
    correct: 1,
...
'Instrument Rating': [
  {
    ...
    options: [
      'A. DA and MDA are both altitudes — the aircraft descends to and levels off at both',
      'B. DA is used on precision/APV approaches — the aircraft descends through DA and IMMEDIATELY executes missed approach if visual reference is not established. MDA is used on non-precision approaches — the aircraft levels off at MDA and may continue to the MAP before missed approach',
      'C. DA provides lower minima than MDA in all cases',
      'D. MDA is used on precision approaches; DA on non-precision'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The glideslope is a localiser signal providing lateral guidance set at 3°',
      'B. The ILS glideslope is a UHF radio signal (329.15–335.00 MHz) providing vertical approach guidance — standard angle is 3°, approximately 318 ft/NM descent rate. Full Scale Deflection is ±0.7° from glidepath',
      'C. The glideslope operates on the same frequency as the localiser',
      'D. The glideslope angle is always exactly 2.5°'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'C. The flag appears only when the aircraft is below the glidepath',
      'D. The OFF flag clears automatically when the localiser is captured'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A stabilised approach only requires on-speed configuration at 200 ft',
      'B. A stabilised approach requires: correct approach path, correct airspeed (VREF ± 5 kt), correct configuration, correct power, and correct sink rate — established by 1,000 ft AAL in IMC and 500 ft AAL in VMC. If not stabilised by these heights: go-around',
      'C. Stabilisation requirements only apply to category C and D aircraft',
      'D. Stabilisation is achieved when the runway is in sight'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Localiser 108.10–111.95 MHz (VHF, odd decimals); Glideslope 329.15–335.00 MHz (UHF)',
      'B. Both use the same VHF range (108–118 MHz)',
      'C. Localiser 118–136 MHz; Glideslope 108–118 MHz',
      'D. Localiser 329–335 MHz (UHF); Glideslope 108–111 MHz (VHF)'
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
      'A. A missed approach is initiated if the landing gear fails to extend',
      ...
      'C. A missed approach can be initiated any time after passing the outer marker',
      'D. Missed approaches are only required if the runway is obstructed'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Standard holding uses left-hand turns',
      'B. Standard holding uses RIGHT-HAND turns. The pattern: inbound leg (1 min below FL140, 1.5 min at/above FL140), outbound leg, and two 180° turns',
      'C. All IFR holding patterns use left-hand turns',
      'D. Holding pattern direction is at the pilot\'s discretion'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. On vacuum failure, all instruments fail',
      'B. Failed (unreliable): AI and DI. Still functional: altimeter, VSI, ASI (pitot-static), turn coordinator (electric), magnetic compass, and clock',
      'C. The altimeter is the only instrument that fails with vacuum',
      'D. Partial panel means flying with half the instrument panel covered'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Trip fuel + 45 minutes reserve',
      ...
      'C. Trip fuel + alternate fuel + 1 hour final reserve',
      'D. Same as VFR fuel requirements'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Localiser coverage is unlimited in any direction',
      'B. ILS localiser coverage: ±10° within 25 NM, ±35° within 17 NM. Intercepts greater than 30° should be avoided — the aircraft may overshoot the course before completing the turn',
      'C. Localiser coverage is ±5° in all directions',
      'D. The localiser only provides guidance within 5 NM'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. IAF and FAF are identical — both mark the start of the approach',
      'B. IAF marks the beginning of the instrument approach procedure where the aircraft transitions from en-route/STAR. FAF marks where the final approach segment and descent to DA/MDA begins',
      'C. FAF is the same as the outer marker on all approaches',
      'D. IAF only applies to ILS; FAF to non-precision approaches'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 200 m RVR',
      'B. 550 m RVR (or 800 m visibility if RVR is not reported) with a DH of at least 200 ft',
      'C. 300 m RVR',
      'D. 1,600 m visibility regardless of approach type'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. Execute the missed approach immediately — loss of visual reference after DA is treated the same as not having visual reference at DA',
      'C. Descend to a lower altitude to regain visual reference',
      'D. Circle overhead until visual reference is re-established'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Any sight of the runway environment is sufficient',
      'B. At DA, at least one of the following must be in sight and identifiable: approach lighting, runway threshold, threshold markings, touchdown zone, runway or runway markings, PAPI/VASIS — and the reference must be adequate to continue and land with normal manoeuvring',
      'C. Only approach lights are required',
      'D. The full runway surface must be visible'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A non-precision approach uses only vertical guidance',
      'B. A non-precision approach provides lateral guidance only (no glideslope) and uses an MDA. Types in Australia: NDB/ADF approach, VOR approach, RNAV LNAV approach, LOC-only (localiser without glideslope)',
      'C. Non-precision approaches are not permitted in Australian Class C airspace',
      'D. GPS is never used for non-precision approaches'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. An alternate is always required for all IFR flights',
      ...
      'C. An alternate is only required for night IFR',
      'D. An alternate is required if destination weather is below 1,000 ft cloud base only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Land at the nearest aerodrome immediately regardless of fuel',
      'B. Squawk 7600; continue flight plan as filed; attempt contact on 121.5 MHz; land at filed destination at ETA or later; advise ATC by alternative means if possible',
      'C. Squawk 7700 and declare emergency',
      'D. Turn back to departure aerodrome immediately'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Fly directly to the VOR then turn onto the arc',
      ...
      'C. A DME arc is joined by flying to the IAF only',
      'D. Approach the arc at any angle and let the DME stabilise naturally'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. CFIT is a mid-air collision between two aircraft',
      'B. CFIT is when an airworthy aircraft under crew control is unintentionally flown into terrain, water, or an obstacle. The primary warning system is TAWS/EGPWS which provides aural and visual warnings',
      'C. CFIT only occurs in mountainous terrain',
      'D. TAWS and TCAS provide identical protection'
    ],
    correct: 1,
...
'Flight Planning Advanced': [
  ...
  },
  {
    ...
    options: [
      'A. FL330 — maintain current level',
      'B. The altitude capability table entered with GW at the ETP and ISA deviation at that point',
      'C. Always FL200 for 1-INOP operations',
      'D. The optimum level from the all-engines cruise table'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 74,000 KG',
      'B. 75,000 KG',
      'C. 74,000 KG interpolated with 75,000 KG',
      'D. 73,000 KG'
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
      'A. Standard 0.80M/280/250 KIAS profile',
      'B. The 1-INOP descent profile from Table 5.x of the Handbook for the actual conditions',
      'C. 300 KIAS throughout',
  ...
  },
  {
    ...
    options: [
      'A. YBBN is suitable — INTER periods do not affect aerodrome status',
      'B. YBBN is acceptable — fuel planning uses the acceptable status holding fuel allowance',
  ...
  },
  {
    ...
    options: [
      'A. 35 KT headwind',
      'B. Approximately 18 KT headwind',
      'C. Approximately 27 KT headwind',
      'D. Zero — wind is at 90° to track'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 4,320 KG/hr — always round down',
      'B. 4,580 KG/hr — always round up for conservatism',
      'C. 4,450 KG/hr — average the two table entries',
  ...
  },
  {
    ...
    options: [
      ...
      'C. Add 10 minutes holding fuel only',
      'D. YPPH remains suitable as TEMPO is not a permanent change'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. Optimum level reduces — higher temperature reduces thrust and engine efficiency, reducing altitude capability',
      'C. Optimum level is unchanged — temperature does not affect it',
      'D. Optimum level rises by one level for every 10°C above ISA'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. 0.80M/280/250 KIAS',
      'C. 0.78M/260/250 KIAS',
      'D. 0.82M/280/220 KIAS'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Within 25 NM of the departure aerodrome',
      'B. Within a flight time calculated for single-engine cruise to the alternate — for twin jets approximately 60 minutes at single-engine cruise speed and altitude',
      'C. Within 100 NM regardless of engine type',
      'D. Within 200 NM for three-engine aircraft'
    ],
    correct: 1,
...
'Navigation Advanced': [
  ...
  },
  {
    ...
    options: [
      ...
      'B. 0710 Thursday BST',
      'C. 0610 Wednesday BST',
      'D. 1810 Wednesday BST'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 9,500 ft — use the most common value',
      'B. 11,200 ft — use the highest grid LSALT of all grids crossed',
  ...
  },
  {
    ...
    options: [
      ...
      'B. The CDI reading is unreliable — a TO flag on an outbound radial indicates reverse sensing',
      'C. The aircraft is north of the 270 radial — the track is correct, no action needed',
  ...
  },
  {
    ...
    options: [
      'A. Up to 30 MHz; static interference is the primary night error',
      'B. 190–1,750 KHz (LF/MF band); night effect — ionospheric reflection of sky waves causes the ADF needle to fluctuate away from the ground wave bearing',
      'C. 108–118 MHz (VHF); VHF NDBs are not affected by night effect',
      'D. 300–3,000 KHz only; coastal refraction is the primary night error'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. FL180–FL410, accuracy ±100 ft',
      'B. FL290–FL410, AFCS must maintain ±65 ft and altimetry system accurate to ±65 ft',
      'C. FL280–FL410, accuracy ±50 ft',
      'D. FL290–FL450, accuracy ±100 ft'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 1.0 NM total',
      'B. 12.6 NM total (2.0 NM/hr × 6 hrs + 0.6 NM)',
      'C. 6.0 NM total (1.0 NM/hr)',
  ...
  },
  {
    ...
    options: [
      'A. The HSI replaces the ADF and gives bearing to the NDB',
      'B. The HSI displays the selected VOR course on a compass rose that rotates with the aircraft heading — CDI deflection is always relative to the selected course regardless of aircraft heading, eliminating reverse sensing errors',
      'C. The HSI only works with ILS and cannot display VOR information',
      'D. The HSI compass card is fixed north-up regardless of aircraft heading'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'C. East-southeast of the station at approximately 42 NM slant range',
      'D. The bearing FROM the station is 275°, placing the aircraft to the west'
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      ...
      'B. Real wander is mechanical imperfection in bearing friction causing the spin axis to drift from its set position regardless of earth rotation — it is an instrument defect causing DI heading error over time',
      'C. Real wander only occurs in wet/humid conditions',
      'D. Real wander is the same as apparent wander and is corrected by the latitude nut'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. TAS and EAS are always identical above FL180',
      ...
      'C. EAS is always higher than TAS',
      'D. TAS equals EAS plus the Mach number correction only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'C. Turn 20° left',
      'D. Turn 20° right to place the ADF needle on the nose (000° relative)'
    ],
    correct: 3,
  ...
  },
  {
    ...
    options: [
      'A. RAIM increases GPS signal strength in remote areas',
      'B. RAIM uses redundant satellite geometry to detect and exclude faulty satellite signals — it provides an integrity alert if position accuracy degrades below the required level for the phase of flight',
      'C. RAIM is only required for oceanic operations',
      'D. RAIM corrects for ionospheric delay in GPS signals'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 2 NM either side of centreline throughout',
      'B. 5 NM either side near the VOR, expanding with distance from the station based on ±4.5° angular width',
      'C. 10 NM either side throughout',
      'D. 3 NM either side up to 80 NM, then 4 NM beyond'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 2.4° left',
      'B. 2.4° right',
      'C. 2.4° left closing angle plus 2.4° left return angle = 4.8° total left',
      'D. 1.2° left'
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      'A. GPS NOTAMs are for en-route use only, not approaches',
      'B. GPS NOTAMs warn of predicted RAIM outages at specific locations and times — they must be checked before any IFR GPS approach to ensure RAIM will be available during the approach window',
      'C. RAIM outages are automatically compensated by the GPS receiver',
      'D. GPS NOTAMs only apply within 50 NM of major cities'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. Monday — crossing the IDL eastbound subtracts one day (go back one calendar day)',
      'C. Thursday — two days are added',
...
'Performance and Loading': [
  {
    ...
    options: [
      'A. 47,250 KG, 185 IU — no adjustment needed for domestic',
      'B. 47,146 KG, 188.2 IU — life vests not carried requires: subtract 104 KG, add 3.2 IU',
      'C. 47,510 KG, 162.0 IU — life rafts added',
  ...
  },
  {
    ...
    options: [
      'A. 47,510 KG, 208.0 IU',
      'B. 47,510 KG, 162.0 IU',
  ...
  },
  {
    ...
    options: [
      'A. No action — ZFW limits are advisory only',
      'B. The load must be reduced so that ZFW does not exceed 63,500 KG before fuel is added',
      'C. Add more fuel to reduce ZFW by increasing take-off weight',
      'D. Apply for a MZFW dispensation from CASA'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 10 — both T and Z are inside the central area',
      'B. The number is limited by the dotted line that encloses BOTH the T (21%) and Z (24%) positions',
      'C. Zero — both points must be in the forward third of the envelope',
      'D. 6 — only Z is used to determine the limit'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'C. Either distance may be used at the pilot\'s discretion',
      'D. 2,224 m only if MTOW is below 80,000 KG'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 640 lbs fuel in the forward auxiliary tank only',
      'B. 2,560 lbs fuel in the forward auxiliary tank only, OR 6,880 lbs fuel in tank 2 only, OR 640 KG deadweight in compartment 1 only',
      'C. Move 800 KG of cargo from compartment 5 to compartment 1',
      'D. Remove 80 KG of payload from Zone E'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 5% contingency and final reserve',
      'B. 400 KG allowance for approach and manoeuvring, added to fuel planned from take-off to first intended landing station',
      'C. Taxi fuel of 150 KG',
      'D. No additional allowance — trip fuel is just cruise fuel'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. 3.0% gross gradient',
      'C. 2.7% gross gradient',
      'D. 1.8% net gradient'
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      'A. 63,500 KG — MZFW is unchanged',
      'B. 58,057 KG — MZFW reduced by 5,443 KG of unusable ballast fuel',
      'C. 57,500 KG — reduce by 6,000 KG',
      'D. 61,000 KG — reduce by 2,500 KG'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. The runway-limited BRW (Brakes Release Weight) — the maximum weight that can take off within the available effective operational length',
      'C. The climb-limited BRW',
      'D. The obstacle-limited BRW'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 4 cabin crew, 144 passengers',
      'B. 6 cabin crew (standard), 138 passengers (excluding crew and extra seat occupants)',
      'C. 6 cabin crew, 144 passengers',
      'D. 4 cabin crew, 138 passengers'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 86 KG (male standard)',
      'B. 71 KG (female standard)',
      'C. 81 KG (standard adult weight)',
  ...
  },
  {
    ...
    options: [
      ...
      'B. 52,150 KG plus the weight of ballast fuel loaded',
      'C. 63,500 KG minus the ballast fuel weight',
      'D. MZFW is not affected by ballast fuel position'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. ZFW = 56,821 KG — complies with MZFW 63,500 KG',
      'B. ZFW = 56,821 KG — exceeds MZFW of 63,500 KG',
...
'Aerodynamics and Systems': [
  {
    ...
    options: [
      'A. Mcrit is the speed at which the aircraft enters supersonic flight throughout',
      'B. Mcrit is the IAS at which the crew must reduce throttles',
      'C. Mcrit is the Mach number at which airflow over the most critical part of the wing first reaches Mach 1.0 locally — exceeding Mcrit produces shock waves causing drag rise, Mach tuck, and possible buffet',
      'D. Mcrit is the Mach number at which the aircraft exceeds Vmo'
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      'A. It adjusts the throttles automatically at high Mach to maintain speed',
      'B. It automatically applies nose-up stabiliser/elevator trim as Mach increases to counteract the nose-down pitching moment (Mach tuck) that develops as the CG moves aft at high speed',
      'C. It limits the aircraft to below Mcrit automatically',
      'D. It compensates for increased propulsive efficiency at high Mach numbers'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Increased EGT only — no other symptoms',
      ...
      'C. Only applicable below 10,000 ft',
      'D. Compressor stalls automatically reset with no crew action'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. N1 is the high-pressure shaft speed — EPR is more accurate',
      'B. N1 is the fan/low-pressure compressor rotational speed — on high-bypass turbofans where the fan generates 80%+ of total thrust, N1 directly represents thrust output. EPR is affected by probe icing and inlet distortion',
      'C. N1 and EPR provide identical information',
      'D. N1 is only used on propeller turbine engines'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Slats reduce the maximum CL and lower the stall angle',
      'B. Slats increase the maximum CL and increase the stall angle of attack — the wing can fly at a higher angle before flow separation occurs, enabling lower approach speeds',
      'C. Slats have no effect on the stall angle, only on cruise drag',
      'D. Slats increase the stall angle but reduce maximum CL'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A structural zone in the fuselage with reduced survivability in turbulence',
      ...
      'C. The coffin corner only applies below FL200',
      'D. A region of the CG envelope that requires special procedures'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. The autopilot pitch channel servomotor or pitch axis computer — altitude hold commands pitch via the elevator servo; failure results in unchecked pitch changes',
      'C. The yaw damper',
      'D. The autothrottle system'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. EPR = fan speed divided by core speed',
      'B. EPR = turbine exit total pressure divided by compressor inlet total pressure — it represents the energy added to the airflow by the engine and correlates directly with thrust',
      'C. EPR measures bypass ratio only',
      'D. EPR = N1 divided by N2 as a percentage'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Differential ailerons reduce roll rate at all speeds',
      ...
      'C. Differential ailerons increase aileron authority at low speed',
      'D. Differential ailerons are used only on aircraft without rudder authority'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Chemical fluid and windshield heat only',
      'B. Thermal (hot bleed air from the engines flowing through piccolo tubes in the leading edge) and electrical resistance heating — bleed air is most common for large leading edge areas; electrical is used on smaller surfaces and aircraft with electric anti-ice systems',
      'C. Only bleed air — electrical anti-ice is not certified for leading edges',
      'D. Deicing boots only — jets do not use thermal anti-icing'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Single spool has one combustion chamber; twin spool has two',
      'B. A single-spool engine has all compressor and turbine stages on one shaft; a twin-spool engine has a low-pressure spool (fan + LP compressor + LP turbine) and a high-pressure spool (HP compressor + HP turbine) operating at different speeds for better efficiency and surge resistance',
      'C. Single spool refers to single-engine aircraft only',
      'D. Twin spool means the engine has two separate fuel systems'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Ground spoilers improve stopping performance by increasing forward thrust',
      'B. Ground spoilers deploy symmetrically on touchdown to destroy lift rapidly, transferring aircraft weight to the wheels — this increases normal force and therefore braking effectiveness, and increases aerodynamic drag',
      'C. Ground spoilers are only used during a rejected takeoff',
      'D. Ground spoilers reduce landing distance by increasing flap effectiveness'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Loss of any one system',
      'B. Simultaneous loss of all three independent hydraulic systems — designed to be extremely improbable. Aircraft have backup power transfer units and RAT (Ram Air Turbine) for this scenario',
      'C. Loss of two systems, unless the third powers all flight controls',
      'D. Single hydraulic pump failure always causes control loss'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. It controls the flow rate to each mask',
      'B. It protects the oxygen cylinder from overpressure if temperature increases — if ambient temperature causes pressure to exceed the cylinder maximum rated pressure, the relief valve vents excess oxygen overboard',
      'C. It activates the oxygen system automatically at FL250',
      'D. It regulates crew oxygen flow based on altitude only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A secondary stall occurs on the second flight of the day',
      'B. A secondary stall occurs when the pilot applies back pressure too aggressively during stall recovery before sufficient airspeed has been regained — the wing stalls again before flying speed is restored',
      'C. A secondary stall only occurs at altitudes above FL200',
      'D. Secondary stalls are not possible on fly-by-wire aircraft'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Advise ATC and wait for further instructions before manoeuvring',
      ...
      'C. Only follow the RA if VMC conditions exist',
      'D. Press the TCAS inhibit button and contact ATC'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Bypass ratio is the ratio of thrust to fuel flow',
      'B. Bypass ratio is the ratio of mass airflow bypassing the core to mass airflow through the core — modern high-bypass engines have ratios of 8:1 to 13:1 compared to early turbofans at 1:1 to 5:1, producing much higher propulsive efficiency and lower fuel burn',
      'C. Bypass ratio measures the pressure ratio across the fan',
      'D. All modern turbofan engines have identical bypass ratios'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. FDR data may be overwritten immediately after an accident to protect airline data',
      'B. The FDR must be preserved intact — the operator must immediately disable the FDR after a reportable occurrence to prevent overwriting, and the data must be surrendered to the ATSB for investigation',
      'C. FDR data is only retained for 25 hours automatically',
      'D. Pilots may access FDR data directly for their own incident analysis'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Bleed air only powers the anti-icing system',
      ...
      'C. Bleed air is only used for engine starting',
      'D. Bleed air failure has no significant effect on aircraft systems'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Hard alerts are more serious than soft alerts in all cases',
      'B. A soft alert (advisory) occurs as the aircraft approaches the cleared altitude (typically 1,000 ft prior) — the alert is inhibited when established within a set band. A hard alert (warning) triggers if the aircraft deviates significantly from the cleared altitude after being established',
      'C. Hard and soft alerts use identical audio and visual signals',
      'D. Soft alerts only occur below FL200'
    ],
    correct: 1,
...
'Human Factors Advanced': [
  {
    ...
    options: [
      'A. Holes represent individual errors only; accidents occur from one major error',
      'B. Holes represent latent conditions and active failures in each defensive layer — an accident occurs when holes in successive layers temporarily align, allowing the hazard trajectory to pass through all defences',
      'C. Holes represent gaps in training documentation only',
      'D. The model applies only to maintenance errors, not flight operations'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Workload shedding means delegating work to cabin crew',
      ...
      'C. Workload shedding is only appropriate during system failures',
      'D. Workload shedding is prohibited under CRM principles — all tasks must be completed'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Confirmation bias means the crew confirms all checklist items verbally',
      'B. Confirmation bias is the tendency to seek, interpret, and favour information that confirms existing beliefs while ignoring contradicting information — e.g. a crew expecting a technical problem to be minor may interpret ambiguous readings as confirming the minor diagnosis and not investigate further',
      'C. Confirmation bias only affects inexperienced crews',
      'D. Confirmation bias is beneficial as it reinforces correct procedures'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Circadian dysrhythmia is acute dehydration from long-haul flights',
      'B. Circadian dysrhythmia is the misalignment between the body\'s internal clock (set to the departure time zone) and the new local time — the pilot\'s body is still on Sydney time in London, causing cognitive impairment, disrupted sleep, and performance degradation particularly during subjective night hours',
      'C. Circadian dysrhythmia is fully resolved after 24 hours rest',
      'D. Circadian dysrhythmia does not affect flight safety'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. Environmental threats (weather, terrain), organisational threats (scheduling, procedures), and ready threats (aircraft defects notified pre-flight)',
      'C. Threats (external), errors (crew-induced), and undesired aircraft states — e.g. threat: thunderstorm; error: wrong SID entry; UAS: aircraft 500 ft below cleared altitude',
  ...
  },
  {
    ...
    options: [
      'A. Inattentional blindness is caused by fatigue only',
      'B. Inattentional blindness is the failure to notice an unexpected but fully visible object or event when attention is focused elsewhere — e.g. a crew focused on resolving an FMS alert fails to notice the altitude alerter activating for an altitude bust',
      'C. Inattentional blindness is the same as tunnel vision',
      'D. Inattentional blindness only occurs in visual meteorological conditions'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Both types have identical medical restrictions',
      'B. Type II diabetes managed by diet and/or oral medication may be assessed as fit for Class 1/2 medical with conditions (e.g. regular monitoring). Type I (insulin-dependent) diabetes generally precludes a Class 1 medical certificate for commercial operations in Australia',
      'C. Diabetes of any type automatically disqualifies a pilot from all licences',
      'D. Medical restrictions for diabetes are at the DAME\'s sole discretion with no regulatory standard'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Hypoxia has no effect on vision until FL250',
      'B. Night vision (rod cell function) is particularly sensitive to hypoxia — meaningful degradation begins as low as 5,000 ft pressure altitude, where rods lose approximately 10% efficiency. By 10,000 ft night vision can be degraded by 20-25% without the pilot noticing',
      'C. Hypoxia only affects colour vision, not night vision',
      'D. Night vision is not affected by altitude below FL180'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Authority gradient refers to the seniority pay structure in airlines',
      'B. Authority gradient is the perceived power differential between crew members. Too steep (authoritarian captain): junior crew fail to speak up, errors go unchallenged. Too flat (overly democratic): decision-making becomes indecisive and unclear — effective leadership requires an optimum gradient where the captain leads decisively while remaining genuinely open to crew input',
      'C. Authority gradient only applies to military aviation',
      'D. A steep authority gradient is always safer as it reduces crew confusion'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Plan continuation error is when a flight plan must be amended due to ATC',
      'B. Plan continuation error (get-there-itis) is the cognitive tendency to continue an original plan despite accumulating evidence that should prompt reassessment — organisational factors: schedule pressure, crew pairing with a high-authority captain; individual factors: goal orientation, desire to not disappoint company/passengers, normalisation of deviation',
      'C. Plan continuation error only occurs on the first flight of a new route',
      'D. Plan continuation error is resolved by longer pre-flight briefings'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Tingling fingers → unconsciousness → hypoxic convulsions',
      'B. Increased breathing rate → euphoria/impaired judgement → loss of coordination → loss of vision (tunnel vision, colour vision loss) → unconsciousness — time of useful consciousness (TUC) at 25,000 ft is approximately 3-5 minutes',
      'C. Cyanosis is always the first symptom',
      'D. Hypoxia symptoms only begin above 30,000 ft'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Errors are more serious than violations',
      ...
      'C. Violations are errors committed by managers only',
      'D. Errors and violations require identical corrective actions'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Type III is the same as Type I but at night',
      'B. Type III (incapacitating) is where the pilot is fully aware of the conflict between instrument readings and vestibular sensations but cannot override the powerful physical sensation with voluntary control — the pilot knows the instruments are correct but physically cannot fly accordingly',
      'C. Type III spatial disorientation is only possible during aerobatics',
      'D. Type III is always resolved by closing the eyes'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. 0.02% BAC — approximately half the road driving limit, and a pilot must not fly within 8 hours of consuming alcohol',
      'C. Zero BAC required at all times',
  ...
  },
  {
    ...
    options: [
      'A. SMS is a voluntary best-practice system with no regulatory basis',
      ...
      'C. SMS only applies to aircraft manufacturers',
      'D. SMS is only required for international operators'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Normalisation of deviance means accepting all deviations as normal during emergencies',
      'B. Normalisation of deviance is the gradual process by which deviant practices (rule violations, degraded safety margins) become accepted as normal within an organisation because they have not yet produced adverse consequences — in Challenger: O-ring erosion was repeatedly observed and reclassified from anomaly to acceptable risk until a catastrophic failure occurred',
      'C. It only occurs in space agencies, not aviation operators',
      'D. Normalisation of deviance is addressed solely by maintenance procedures'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Startle and surprise are identical responses requiring identical training',
      'B. Startle is an involuntary physiological response to an unexpected high-intensity stimulus (< 0.5 seconds) — automatic, cannot be suppressed. Surprise is a cognitive response to an unexpected event (seconds to minutes) — manageable with training. Startle training focuses on recovery from the initial startle reflex before cognitive processing begins',
      'C. Only surprise affects pilot performance',
      'D. Startle only occurs during simulator training, not in flight'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Prospective memory failure is forgetting past events',
      ...
      'C. Prospective memory failure only affects long-haul crews',
      'D. Prospective memory is enhanced by fatigue'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 8 hours rest between any duties',
      'B. Minimum 10 hours rest between FDPs for short duty periods, increasing to 12 hours after longer or more fatiguing duties — rest must be at a suitable rest facility',
      'C. 6 hours rest is sufficient between any FDPs',
      'D. Rest periods under CAO 48.1 are calculated per fortnight, not between flights'
    ],
    correct: 1,
...
'Meteorology Advanced': [
  {
    ...
    options: [
      'A. 5 NM lateral clearance is sufficient',
      ...
      'C. 10 NM clearance if circumnavigating visually',
      'D. No clearance is required at FL370 if above the main cell'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. SIGMET is issued for all IMC conditions',
      'B. SIGMET is issued for phenomena hazardous to ALL aircraft regardless of size: severe or extreme turbulence, severe icing not associated with TS, tropical cyclone, severe mountain wave, widespread dust/sandstorm obscuring FL100+, and volcanic ash cloud. Each has specific intensity/extent criteria',
      'C. SIGMET is issued for CAT only',
      'D. SIGMET is equivalent to a TAF and covers the same area'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Tropical tropopause is at the same height as southern Australia — approximately FL360',
      'B. The tropical tropopause is approximately FL500-FL560 (50,000-56,000 ft) — much higher than the southern Australian tropopause (~FL360-FL380). This allows CB tops to penetrate to extreme altitudes, creating hazards for all jet cruise levels and making top avoidance impractical',
      'C. The tropical tropopause is lower, suppressing CB development',
      'D. Tropopause height has no effect on CB development'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Temperature/dewpoint spread and QNH only',
      'B. Visibility of 1,400 m (below CAT I ILS minima of 550 m RVR unless converted) combined with OVC030CB — active CB with embedded TS, severe turbulence, microburst, and wind shear on approach. Combined these require reassessment of approach category or diversion',
      'C. QNH 1005 and wind only',
      'D. OVC030 cloud base and surface wind only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A cut-off low is a fast-moving frontal system that produces brief showers only',
      'B. A cut-off low forms when an upper trough becomes isolated from the main westerly flow, creating a closed circulation. Unlike frontal depressions (which move with the westerlies), cut-off lows are slow-moving, persist for 3-7 days, and produce prolonged severe weather in unusual locations',
      'C. Cut-off lows only form in the tropics',
      'D. Cut-off lows are weaker than frontal depressions'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. ISA+18 is too warm for accurate flight planning — the data should be ignored',
      'B. Round ISA+18 to nearest multiple of 3 = ISA+18 (exactly divisible). Apply the temperature deviation to fuel flow correction in the cruise tables. ISA+18 means the air is warmer and less dense than standard — TAS will be higher than standard for the same Mach number, but engine thrust is reduced',
      'C. ISA+18 means standard performance — no corrections needed',
      'D. ISA+18 corrections only apply to climb, not cruise'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Yes — INTER is not a significant change',
      'B. The "suitable" or "acceptable" assessment depends on whether the prevailing conditions (excluding INTER periods) meet the applicable approach minima — INTER periods below minima do not make an aerodrome not suitable, but the operator must assess based on company policy and the Handbook criteria',
      'C. INTER conditions always make an aerodrome unsuitable',
      'D. INTER 2000 m visibility always meets all approach minima'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'B. Cumulus (developing), mature, dissipating — mature stage is most hazardous: strong updrafts (to 100 kt) and downdrafts coexist, lightning, hail, and severe turbulence all present simultaneously',
      'C. All stages are equally hazardous',
      'D. Dissipating stage is most hazardous due to unpredictable behaviour'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Northwest Cloudbands are minor cloud formations with negligible aviation impact',
      ...
      'C. Northwest Cloudbands only affect operations south of 30°S',
      'D. Northwest Cloudbands are associated with tropical cyclones only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Any turbulence requiring seatbelts to be fastened',
      'B. Severe turbulence causes large, abrupt changes in altitude and/or attitude; the aircraft may be temporarily out of control; occupants are forced violently against seatbelts; unsecured objects become projectiles. Equivalent to approximately ±1.0g deviation from normal flight',
      'C. Severe turbulence is defined as any turbulence causing passenger injury',
      'D. Severe turbulence is anything above light chop'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. TAF3 is issued every 3 hours as a standard TAF',
      ...
      'C. TAF3 is identical to a standard TAF',
      'D. TAF3 only covers cloud and visibility, not temperature or QNH'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Orographic lifting produces fog only on both sides',
      'B. Orographic lifting forces moist air upward over terrain. Windward side: condensation, cloud formation (stratiform or convective depending on stability), precipitation (rain/snow). Leeward side: foehn effect — air descends, warms at DALR, creating dry warm conditions and dissipating cloud. Lee-side turbulence and rotor zones below mountain wave crests',
      'C. Orographic lifting only affects aircraft at low altitude below 5,000 ft',
      'D. Orographic lifting produces identical weather on both sides'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Less than 60 minutes per occurrence',
      'B. Less than 30 minutes per individual occurrence, with the total duration of INTER conditions being less than half of the INTER period',
      'C. INTER periods may last up to 2 hours at a time',
      'D. Each INTER occurrence lasts exactly 15 minutes'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Frost icing — formed when ground temperature is below 0°C',
      ...
      'C. Rime icing — always the most severe type',
      'D. Mixed icing only occurs above FL300'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. VOLMET provides navigation aid status updates only',
      'B. VOLMET is a continuous HF/VHF radio broadcast of METARs and TAFs for nominated aerodromes — it uses ICAO standard meteorological code format and is used by crews over oceanic or remote areas for destination/alternate weather updates without ATC communication',
      'C. VOLMET only covers major capital city aerodromes within Australia',
      'D. VOLMET is a manual weather briefing service requiring crew to request information'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. They produce identical weather — both terms describe the same system',
      ...
      'C. Troughs produce clear skies; fronts produce cloud',
      'D. Troughs are only significant in the tropics'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Radiative frost and temperature-based frost are identical',
      'B. Radiative frost occurs when the surface radiates heat rapidly (clear sky, calm winds, dry air) cooling the surface and adjacent air layer to below 0°C even when the 2-metre screen temperature remains above 0°C — screens read air temperature while frost forms on surfaces. Forecast minimum of +2°C with clear sky and calm may still produce surface frost',
      'C. Radiative frost only occurs in inland areas above 2000 ft',
      'D. Radiative frost is not relevant to aviation operations'
    ],
    correct: 1,
...
'Air Law Advanced': [
  {
    ...
    options: [
      ...
      'B. Three take-offs and landings in the preceding 90 days, current type rating, current instrument rating (IPC within 12 months), and compliance with operator-specific recency requirements under Part 121',
      'C. Annual IPC only, no recent flight experience required',
      'D. 100 flight hours in the preceding 12 months'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. BAC 0.05%, minimum 4 hours',
      'B. BAC below 0.02%, minimum 8 hours from last consuming alcohol — and no flight if under the influence regardless of time or BAC',
      'C. BAC 0.00% (nil alcohol) at all times',
      'D. BAC 0.05%, minimum 8 hours'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 14 hours FDP',
      'B. 11 hours FDP for early starts (0500-0559) — reduced from the standard 13 hours due to higher fatigue impact of early starts disrupting sleep',
      'C. 12 hours FDP for all duty periods regardless of start time',
      'D. 10 hours FDP for all starts before 0600'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Defer the defect under the MEL at the operator\'s discretion',
      ...
      'C. The PIC may authorise a departure with an undocumented defect if conditions are VMC',
      'D. All defects are automatically covered by the MEL at the operator\'s discretion'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The ATPL remains valid for 30 days after medical expiry',
      'B. The ATPL holder cannot exercise any privileges requiring that medical grade — a Class 1 medical is required to exercise ATPL privileges. Flying commercially without a valid Class 1 medical is illegal under CASR Part 61 regardless of how experienced the pilot is',
      'C. Only the instrument rating requires a valid medical',
      'D. An expired medical may be used for 7 days while renewal is pending'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The power-driven aircraft has right of way as it is more controllable',
      'B. The glider has right of way — under CASR Part 91 and ICAO Annex 2, less manoeuvrable aircraft have priority. Order: aircraft in distress, balloons, gliders, airships, aircraft towing/carrying loads, then power-driven aircraft',
      'C. The aircraft on the right has right of way regardless of type',
      'D. Larger aircraft always have right of way'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Only the Certificate of Airworthiness and radio licence',
      ...
      'C. Documentation is only required for international flights',
      'D. Digital copies satisfy all carriage requirements for domestic operations'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. NOTAM C is a cancellation of a previous NOTAM — it cancels the NOTAM identified in its reference',
      'B. NOTAM C is a checklisting NOTAM summarising all current valid NOTAMs for an area',
      'C. NOTAM C indicates a NOTAM with CRITICAL safety implications requiring immediate compliance',
      'D. NOTAM C is a civilian-only NOTAM with no military significance'
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
      'A. Part 119 applies only to aircraft manufacturers',
      'B. Part 119 establishes the framework for air operator certification — it applies to all AOC holders conducting RPT, charter, or aerial work operations and requires them to hold a valid Air Operator Certificate (AOC) demonstrating they meet safety, operational, and management standards',
      'C. Part 119 applies only to international operators',
      'D. Part 119 covers pilot licensing requirements only'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The operator need only notify its insurer',
      ...
      'C. Notification to ATSB is required only within 72 hours',
      'D. The PIC is solely responsible for notifying authorities'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. Any approach can be conducted to any weather condition',
      'B. The aircraft must be certified for the approach type, the aerodrome must have the required ground facilities serviceable, the crew must hold the required ratings and recency, the weather must be at or above the applicable minima, and the approach must be conducted in accordance with the published procedure',
      'C. Only the ILS is an approved instrument approach in Australia',
      'D. Approach to minima is only permitted for transport category aircraft'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A sterile cockpit means all windows must be closed during flight',
      ...
      'C. Sterile cockpit applies only on international flights',
      'D. Sterile cockpit is a manufacturer recommendation, not a regulatory requirement'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. 12 months from date of issue regardless of age',
      'B. 6 months from date of issue — Class 1 medical validity reduces to 6 months for pilots aged 40 and over. Under 40 the validity is 12 months',
      'C. 24 months from date of issue',
      'D. 6 months only applies to Class 2 medicals'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. ATC clearances are only required in Class A airspace',
      'B. A clearance from ATC must be obtained before entering Class A, C, or D airspace, and before conducting IFR operations in Class E airspace. Clearance must be obtained prior to entry and the pilot must comply with all conditions of the clearance',
      'C. Clearances are required only for IFR flights in all airspace classes',
      'D. Class G airspace requires a clearance above FL180'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. The Journey Log is completed by cabin crew only',
      'B. The Journey Log records each flight sector, fuel uplifts, defects, maintenance actions, and maintenance release status — entries are made by the flight crew (operational entries) and by LAME/AME (maintenance/defect entries). It forms part of the aircraft\'s continuing airworthiness record',
      'C. Journey Log entries may be made by any crew member',
      'D. Journey Logs are optional for domestic operations'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. MSAW is a pilot-operated system for terrain awareness',
      'B. MSAW is an ATC ground-based safety net that triggers an alert when a transponder-equipped aircraft\'s predicted trajectory conflicts with terrain — ATC must immediately issue a warning to the crew ("MINIMUM SAFE ALTITUDE WARNING") and provide climb instructions if the crew does not respond',
      'C. MSAW alerts are only advisory — ATC is not obligated to warn the crew',
      'D. MSAW replaces the need for TAWS/GPWS on aircraft'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      'A. A MAYDAY declaration is optional — the PIC may choose to handle the emergency quietly',
      'B. The PIC has authority to deviate from any CASR requirement to the extent necessary to meet the emergency, must declare the emergency to ATC as soon as practicable, and must submit a written report to CASA if a regulation was deviated from — safety of the aircraft and occupants takes absolute priority',
      'C. MAYDAY declarations require prior CASA approval',
      'D. Only the captain may declare a MAYDAY — the first officer may not'
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'C. 2 minutes separation for all wake turbulence combinations',
      'D. Wake turbulence separation is at the pilot\'s discretion'
    ],
    correct: 1,
