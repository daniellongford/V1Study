export const aasaQuestions = [
  ...
  },
  {
    ...
    options: [
    `A. The torsional stress in the propeller shaft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. The rotational speed of the propeller (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. The pressure differential across the turbine stages (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
  ...
  },
  {
    ...
    options: [
    `A. Direct law engages the autopilot automatically to compensate for lost protections (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Direct law provides enhanced turbulence protection by dampening rapid inputs (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Direct law is the normal operating mode — normal law is only used in specific configurations (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. The aircraft must never exceed 2.5g in any manoeuvre (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. The aircraft can pull 2.5g indefinitely without any structural concern (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `D. 2.5g is the minimum load factor required for certification testing (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    `B. Engine bleed air directed across the outer glass surface — this does not apply in the scenario described in normal operations under standard conditions (this is not the primary function described)`,
  ...
  },
  {
    ...
    `B. Apply the parking brake and shut down immediately — the brakes must cool overnight — this is not correct under the conditions described in the applicable MOS — this is not the correct procedure per the applicable standard in normal operations (this is not the primary function described)`,
  ...
  },
  {
    ...
    `B. The pilot's physical reaction time and crew certification limits only — this is not correct under the conditions described in the applicable MOS — this is not the correct procedure per the applicable standard in normal operations under standard conditions per the flight manual in normal operations (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Physically removing heavy avionics from the cockpit (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Reducing fuel flow to all engines simultaneously (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Transferring all loads to the battery bus immediately (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Fixed tailplanes are too heavy for large aircraft — this does not apply in the scenario described in normal operations under standard conditions per the flight manual in normal operations under standard conditions per the flight manual in normal operations under standard conditions (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. The aircraft must immediately declare an emergency and descend (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. The aircraft must divert immediately — engine-out cruise above 10,000 ft is prohibited (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `C. The failed engine must be restarted or the aircraft lands immediately (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
  ...
  },
  {
    ...
    `B. Increase — faster air creates stronger vortices (this does not apply in this scenario) (this is not technically correct here)`,
    `C. Remain constant — induced drag depends only on weight (this does not apply in this scenario) (this is not technically correct here)`,
    `D. First decrease then increase as VMO is approached (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    `B. The squat switch determines tyre inflation pressure automatically — this does not apply in the scenario described in normal operations under standard conditions per the flight manual in normal operations (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Create aerodynamic drag to slow the aircraft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. Reduce runway required by acting as aerodynamic brakes (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `D. Prevent the aircraft from bouncing back into the air after touchdown (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. Maximum speed — more ground covered before descent (this does not apply in this scenario) (this is not technically correct here)`,
    `B. VMD — speed for maximum L/D; the glide ratio equals L/D, so maximum L/D gives maximum distance per unit altitude lost`,
    `C. Minimum speed — slowest descent rate (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. The speed for minimum rate of descent (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. At high speed, aileron cables stretch and the surface deflects less than commanded (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. High Mach flow causes the aileron to flutter and reverse direction physically (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Swept wings have inverted aileron geometry at high speed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. The aircraft has exceeded VMO/MMO by more than 10 kt — a minor exceedance triggers only a visual warning (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `B. The warning activates only when the autopilot is disconnected at high speed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. Overspeed warnings are only active below FL250 (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. Higher force output per unit weight — pneumatics are more powerful than hydraulics (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. Immunity to temperature effects — compressed air behaves identically at all temperatures (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. Higher precision — compressed air gives more accurate actuator positioning than hydraulic oil (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
  ...
  },
  {
    ...
    `B. Using hydraulic actuators that resist oscillation by their inherent stiffness (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. Flying below a maximum speed set by the flutter analysis (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Using composite materials that absorb vibrational energy in the structure (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Evaporating liquid refrigerant in an expansion valve — the same principle as a domestic refrigerator (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. Mixing hot bleed air with cold ram air through a simple heat exchanger only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. Pumping air through desiccant material that absorbs heat during the adsorption process (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
  ...
  },
  {
    ...
    options: [
    `A. The FMC only needs route and altitude data — weight and CG are not required (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Weight data is only used for calculating takeoff V-speeds — not cruise performance (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. The FMC uses weight and CG only to set the stabiliser trim automatically (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. EGT is always lower than TIT, making it easier to measure (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. EGT sensors are lighter than TIT sensors (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario) (this is not technically correct here)`,
    `D. Regulations prohibit direct measurement of turbine inlet temperature (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Fuel from sloshing in turbulence and creating noise (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. Fuel from transferring between tanks without crew selection (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. Over-pressurisation of tanks during refuelling (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
  ...
  },
  {
    ...
    options: [
    `A. Fixed slats and spoilers — no other types are used (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Trailing edge flaps extended to the leading edge position (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Drooping ailerons that serve as both leading edge devices and roll control (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. The most powerful engine — losing the highest-thrust engine is most critical (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `C. The most outboard engine — greater moment arm creates the largest yaw (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. The engine closest to the fuel tanks — fire risk makes it critical (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Moves to more nose-up — an aft CG creates a nose-down tendency requiring more up trim (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `B. Stays the same — only speed changes require trim adjustment (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `D. Moves to maximum nose-up to prevent the aft CG from causing instability (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    `B. Maintain altitude precisely — apply continuous elevator corrections for every altitude deviation — this is not correct under the conditions described in the applicable MOS — this does not apply in the scenario described (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. The tiller is hydraulically powered; rudder pedals are mechanical only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. The tiller directly controls main gear steering; rudder pedals control nose gear only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. The tiller provides automatic differential braking; rudder pedals do not (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. The rudder alone cannot provide directional stability in turbulence (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. The yaw damper coordinates turns by applying rudder proportional to bank angle (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Without the yaw damper, the rudder floats to full deflection in turbulence (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Increase the pump outlet pressure beyond the normal 3,000 PSI system pressure (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. Maintain fluid temperature below 80°C (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `D. Provide an emergency pressure reserve when the engine-driven pump fails (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. Set stabiliser trim for takeoff automatically (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Prevent the stabiliser from moving during autopilot operation (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Compensate for changes in airspeed without pilot input (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Maintain a fixed stabiliser position during autopilot operation (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Trim the aircraft for maximum range in cruise (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Compensate for CG movement due to fuel burn only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Sweep increases CLmax, which raises approach speed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `C. Sweep reduces the structural bending moment at the wing root (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Sweep reduces induced drag at low speed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Bank toward the heavier wing to shift fuel laterally (this is not technically accurate in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. 400 Hz is required by international regulations for all commercial aircraft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `C. 400 Hz provides better interference rejection for avionics (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. 400 Hz allows direct connection to commercial ground power at any airport (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. The autopilot from engaging at speeds below VMO (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. The engines from producing more than maximum rated thrust (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `D. The aircraft from flying above the certified service ceiling (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. Brakes automatically applying maximum pressure (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. The wheel locking solid to prevent aircraft movement (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. A warning light in the cockpit alerting the crew to tyre overheat (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
  ...
  },
  {
    ...
    `B. Lift = Weight, Thrust = Drag — same as level flight (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `C. Thrust = Lift, Drag = Weight — forces exchange roles in a climb (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Lift = Weight × cos(30°), Thrust = Drag only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Autopilot gain is reduced at high altitude to prevent over-control (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `B. Lower aircraft weight at high altitude reduces inertia (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    ...
    `D. High altitude reduces tail moment arm effectiveness due to compressibility (this is not technically accurate in this scenario) (this does not apply in this scenario)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. Increase wave drag by concentrating the shock wave energy (this does not apply in this scenario) (this is not technically correct here)`,
    `B. Reduce the effective Mach number seen by the wing section, weakening the shock and reducing wave drag`,
    `C. Have no effect on wave drag — only on induced drag (this does not apply in this scenario) (this is not technically correct here)`,
    `D. Reduce Mach buffet onset Mach number (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Increase mass airflow through the combustion chamber for better combustion — this is not correct under the conditions described in the applicable MOS — this does not apply in the scenario described (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Increase altitude immediately to avoid terrain (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Reduce thrust on the live engine to eliminate asymmetry (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Declare emergency before taking any control action (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Reduce speed to VMO − 50 kt for reduced structural loads — this is not the correct procedure per the applicable standard in normal operations under standard conditions per the flight manual in normal operations (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Feathering allows the propeller to windmill freely, reducing engine drag (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Feathering increases thrust from the failed engine's propeller (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Feathering is required by regulation to prevent propeller blade flutter at cruise speed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Regulating bleed air supply to the cabin — opening allows more bleed in, closing reduces supply (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Connecting the cabin directly to ambient pressure for equalisation before landing (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Acting as the primary fire damper for the cabin air recirculation system (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Increase the stall margin — higher speed means more lift available (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. Have no effect — stall margin depends only on AoA, not Mach (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. Improve the stall margin by delaying flow separation over the swept wing (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
  ...
  },
  {
    ...
    `B. LSS decreases with altitude in the stratosphere — this does not apply in the scenario described in normal operations under standard conditions per the flight manual in normal operations under standard conditions (this is not the primary function described)`,
  ...
  },
  {
    ...
    `B. Wing mid-span section — where the average bending moment is highest (this is not technically accurate in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. NiCd batteries are incompatible with 28V DC systems (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. NiCd cells must be replaced every 100 flight hours as a mandatory maintenance interval (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. NiCd batteries require continuous charging current to prevent capacity loss (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
  ...
  },
  {
    ...
    `B. Any hydraulic low-pressure warning activates (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`,
    `C. Manual crew deployment only (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`,
    `D. The aircraft exceeds VMO — the RAT provides additional drag to slow the aircraft (this is not technically accurate in this scenario) (this does not apply in this scenario)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Normal variation — 22V is within acceptable range for all DC equipment (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. High electrical load from passenger entertainment (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Automatic voltage reduction by the power management system to conserve power in cruise (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. A dedicated cabin pressurisation compressor driven by the APU only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Ram air scoops on the fuselage that compress air dynamically at cruise speed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Ground carts that supply pressurised air through a dedicated fuselage connection during all phases of flight (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Providing normal flight instrument power during cruise (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Powering all aircraft systems during ground operations (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Maintaining constant voltage on the AC bus during generator switching transients (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    question: `The Ram Air Turbine (RAT) deploys automatically when:`,
    options: [
    `A. Any hydraulic pump low-pressure warning activates (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. The aircraft exceeds VMO — the RAT provides emergency aerodynamic drag (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Any single engine generator fails — the RAT supplements normal generation (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Normal turbulence in the boundary layer near the surface — no concern — this is not correct under the conditions described in the applicable MOS — this does not apply in the scenario described in normal operations under standard conditions per the flight manual in normal operations under standard conditions (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. VMCG is always higher than VMCA because the aircraft is heavier on the ground (this does not apply in this scenario) (this is not technically correct here)`,
    ...
    `C. VMCG applies only to four-engine aircraft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. VMCG is measured with flaps fully extended; VMCA with flaps retracted (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. The swept wing structure is physically angled upward like a conventional dihedral wing (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `C. Sweep reduces spanwise flow, preventing tip stall in sideslips (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Swept wings have lower aspect ratio which increases lateral stability (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Add oleo servicing fluid and resume operations — this is not the correct procedure per the applicable standard in normal operations under standard conditions per the flight manual in normal operations under standard conditions (this is not the primary function described)`,
  ...
  },
  {
    ...
    `B. Red is the international colour for maximum IFR speed — this is not the correct procedure per the applicable standard in normal operations under standard conditions per the flight manual in normal operations under standard conditions (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Maximum speed to reduce time in the air (this does not apply in this scenario) (this is not technically correct here)`,
    `B. 1.3 × VS for all aircraft (this does not apply in this scenario) (this is not technically correct here)`,
    `C. VMD — minimum drag speed, where fuel flow (proportional to thrust for a jet) is minimum`,
    `D. Maximum certified altitude to reduce drag (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. Engine-out speed is always lower to conserve fuel on the remaining engine (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Engine-out cruise uses the same speed as normal cruise — only altitude changes (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Engine-out cruise speed equals VMCA plus a safety margin (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Maintain altitude — the autopilot prevents any altitude change (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. Accelerate — reduced thrust means less drag forces (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `D. Pitch up immediately — reducing thrust causes a nose-up pitching moment always (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. Maximum hydraulic pressure is delivered to all systems simultaneously (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. The hydraulic fluid temperature is maintained within limits (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Engine oil and hydraulic fluid remain separated in the heat exchangers (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. The hot bus provides constant voltage regulation for the main AC buses (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. The hot bus reduces the number of electrical relays needed in the normal bus system (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Regulations require all aircraft to have a permanently powered bus for passenger call systems (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. The number of aircraft movements a runway can accommodate per day (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `C. The maximum approach speed for a given runway length (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. The minimum runway length required for the aircraft type (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Land immediately — all electrical power is lost (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Deploy the RAT and continue to the planned destination (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Reset both generator circuit breakers — this always restores normal generation (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. The live engine must produce twice the thrust to replace the failed engine (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `C. The live engine automatically increases thrust to compensate for the lost engine (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. The live engine must produce extra thrust only to maintain directional control (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    `B. 800-1,000 m/s — supersonic velocity for maximum thrust (this is not technically accurate in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. Always improve specific air range — higher is always better (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Improve efficiency up to the service ceiling (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Have no effect on range — altitude only affects fuel burn at sea level (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Always begin descent 50 nm before destination (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Use maximum descent rate to minimise flight time (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Maintain constant 2,000 fpm throughout the descent (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. The parking brake lever applied asymmetrically (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. The anti-skid system applied asymmetrically on the two main gear sets (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Engine thrust differential combined with full rudder deflection (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Using a digital frequency converter that electronically adjusts the output (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Running the generator at variable frequency then converting to 400 Hz (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Connecting multiple generators in parallel so their frequencies average to 400 Hz (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Adjusting engine thrust to maintain the reference altitude (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. Adjusting both pitch and thrust simultaneously (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `D. Locking the elevator at a fixed position (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. The minimum speed at which the aircraft can maintain altitude on one engine (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. The minimum speed for gear retraction after engine failure (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. The minimum speed at which the autopilot can maintain heading with one engine inoperative (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. At high altitude VMCA is higher due to lower air density making the rudder less effective (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Engine failures at high altitude cannot occur (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. At high altitude only the autopilot can maintain control after engine failure (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. VMD — minimum drag speed gives maximum excess thrust (this does not apply in this scenario) (this is not technically correct here)`,
    `B. The speed for maximum excess power — where (Thrust − Drag)×TAS is greatest; for a jet this is above VMD`,
    `C. Maximum speed — faster speed means faster climb (this does not apply in this scenario) (this is not technically correct here)`,
    `D. The minimum speed above stall to conserve fuel (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Physically connect the generator output shafts for synchronisation (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Convert three-phase power to single-phase for selected consumers (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Regulate the voltage on each bus independently (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Minimum and maximum fuselage payload only — fuel has no effect on CG — this does not apply in the scenario described in normal operations under standard conditions per the flight manual in normal operations (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Adjusts thrust to maintain the selected climb/descent rate (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. Adjusts both pitch and thrust to hold exactly the selected V/S (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. Uses speedbrakes to increase descent rate if the selected V/S is not achieved (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
  ...
  },
  {
    ...
    options: [
    `A. Automatic pilot-input correction for wind gusts (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. Turbulence damping to reduce pilot workload in rough air (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. Automatic centering of the controls when the pilot releases them (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. The aircraft is climbing — EGT always rises with altitude at constant thrust (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `B. The EGT gauge is malfunctioning while N1 and N2 remain normal (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    ...
    `D. Increased ram recovery at cruise Mach is raising EGT proportionally (this is not technically accurate in this scenario) (this does not apply in this scenario)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. Increase braking force by having more brake units (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Improve crosswind landing capability (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Allow higher approach speeds by providing better aerodynamic braking from the gear doors (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Mach tuck creates a nose-up tendency requiring nose-down stabiliser (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. The Mach trimmer only adjusts elevator position, leaving the stabiliser fixed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Mach tuck only occurs above MMO where the Mach trimmer is inactive (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Crew-selected thrust only — actual engine condition is not measured (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Runway length and obstacle height only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. A fixed N1 value that does not change with temperature or altitude (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Flow rate in litres per second (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`,
    `C. The aircraft's quality factor in structural certification (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `D. Fuel calorific value in kJ/kg (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    `B. TAS divided by the sea level speed of sound (661.5 kt) at all times — this is not the correct procedure per the applicable standard in normal operations under standard conditions per the flight manual in normal operations under standard conditions (this is not the primary function described)`,
    `C. The EGT of the engines, which is proportional to local speed of sound — this is incorrect and not supported by the AAGA MOS requirements in normal operations under standard conditions per the flight manual in normal operations under standard conditions (this is not the primary function described)`,
  ...
  },
  {
    ...
    `B. Rotating the entire engine nacelle 180° to point the thrust forward (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. Increasing turbine RPM to generate forward thrust from the turbine exhaust (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Opening doors on the front of the nacelle to spill compressor air forward (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Selecting a fixed Mach from a standard table (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. Adjusting cruise altitude only — speed is fixed for all aircraft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. Following ATC-assigned speeds — CI is set by ATC (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. At higher altitude, air is less dense so more speed is needed to generate the same lift (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. At higher altitude, wing sweepback becomes less effective at delaying compressibility (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Engine thrust decreases with altitude, limiting the speed achievable (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Increases — faster speed demands more rudder force (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Decreases — lower speed means less asymmetric thrust yawing moment (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Is unchanged — rudder deflection is fixed by the degree of asymmetry (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Unchanged from normal law — alternate law only affects the lateral axis (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Completely removed — the aircraft is flown as a conventional mechanical aircraft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Enhanced — alternate law adds protections not available in normal law (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Segregation allows different hydraulic pressures for different services (this is not technically accurate in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. The aircraft descends below the minimum safe altitude (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. The radio altimeter reads below 50 ft on a non-precision approach (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `D. The aircraft descends through decision height on an autoland (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    `B. SLD causes electrical static discharge through the airframe — this does not apply in the scenario described in normal operations under standard conditions per the flight manual in normal operations under standard conditions (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Immediately disconnect the IDG using the DISC switch to prevent fire (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. Shut down the associated engine to allow the IDG to cool (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `D. Reset the IDG by cycling the generator bus tie switch (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. DC battery power to 115V AC 400 Hz for essential avionics (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `B. Three-phase AC to single-phase AC for galley equipment (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `D. 28V DC to 115V AC for the main electrical buses (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    `B. The aircraft is below 10,000 ft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. The thrust levers are not in the cruise detent (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. The FMS has not been fully programmed with the route (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Emergency steering pressure for the nosewheel (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Automatic brake pressure regulation during normal operations (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Surge damping to prevent hydraulic pressure spikes during brake application (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Increase CLmax at low speed for reduced approach speed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `C. Reduce the structural weight of the wing root attachment (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Increase the effective aspect ratio of the wing (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Maintain cabin altitude at a safe maximum during rapid ascent (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Allow ram air into the cabin if the pressurisation packs fail (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Reduce cabin altitude during emergency descent (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Only the fuel control unit — this does not apply in the scenario described in normal operations under standard conditions per the flight manual in normal operations under standard conditions per the flight manual in normal operations (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Setting a fixed brake pressure maintained throughout the landing roll (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `B. Selecting the number of braking cycles per second (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. Pre-setting a brake temperature limit — braking stops when the limit is reached (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
  ...
  },
  {
    ...
    `B. Equal — TAS and IAS are always the same (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `C. TAS is lower than IAS due to lower air density (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `D. TAS equals IAS corrected for wind only (this is not technically accurate in this scenario) (this does not apply in this scenario)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Apply maximum hydraulic pressure to all wheels simultaneously (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Limit maximum brake temperature by reducing pressure when temperature sensors detect overheating (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Provide differential braking for directional control during the landing roll (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Reduce thrust on the left engine to eliminate asymmetry and continue to the runway — this is not the correct procedure per the applicable standard in normal operations under standard conditions (this is not the primary function described)`,
    `C. Select maximum reverse thrust on the operating engine to slow down before the asymmetry becomes critical (this is not technically accurate in this scenario)`,
  ...
  },
  {
    ...
    `B. It increases fuel consumption by creating trim drag (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. A stabiliser runaway always leads to hydraulic system failure (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Stabiliser runaway is a minor issue that self-corrects when the autopilot detects it (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Reject the takeoff — an engine failure at rotation is always an automatic reject (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `B. Immediately reduce thrust on all engines to zero (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. Apply full aileron toward the live engine to counteract the yaw with roll (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
  ...
  },
  {
    ...
    `B. Variable frequency AC to constant 400 Hz AC (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. AC power to hydraulic pressure via an electric motor pump (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. High-voltage AC to low-voltage AC for passenger reading lights (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Altitude increases at the same IAS (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `B. Speed increases at constant altitude and weight (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `C. Wing aspect ratio increases (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`,
  ...
  },
  {
    ...
    `B. 10% above VMO to warn of approaching overspeed (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`,
    `C. At exactly the stall speed — it replaces the aerodynamic stall buffet on modern aircraft (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `D. At the design manoeuvring speed VA to prevent structural overload (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    `B. Cool the compressor before the next engine start — this is not correct under the conditions described in the applicable MOS — this is not the correct procedure per the applicable standard in normal operations under standard conditions (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. The bank angle reduces the thrust of the live engine through gyroscopic precession (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `B. Banking increases weight on the failed engine side, reducing its windmill drag (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `D. A 5° bank is required by regulation regardless of any aerodynamic effect (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. Decreases — cabin altitude rises as the aircraft climbs past FL250 (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `B. Remains constant — isobaric mode means constant differential (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    ...
    `D. Is automatically set to zero above FL300 (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    `B. The aircraft is on the correct glidepath — 4 white is the ideal PAPI indication (this is not technically accurate in this scenario)`,
    `C. The PAPI lights have failed — all white indicates a system fault — this is incorrect and not supported by the AAGA MOS requirements in normal operations under standard conditions (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Show the autopilot's current control inputs to the crew (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Warn the crew of flight envelope exceedances (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Indicate current aircraft attitude for monitoring only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    question: `Leading edge slats on a transport aircraft primarily:`,
    options: [
    `A. Increase wing chord for additional lift at cruise speed (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`,
    ...
    `C. Reduce wave drag at cruise Mach by modifying the leading edge radius (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `D. Provide additional elevator authority by shifting lift distribution forward (this is not technically accurate in this scenario) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Maximum speed — highest TAS shallowest the climb angle (this does not apply in this scenario) (this is not technically correct here)`,
    `C. Maximum power setting regardless of speed (this does not apply in this scenario) (this is not technically correct here)`,
    `D. The speed for maximum rate of climb (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Automatically coordinates turns by applying rudder proportional to bank angle (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `B. Limits maximum rudder deflection at high speed to prevent structural overload (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    ...
    `D. Maintains coordinated flight during autopilot pitch commands (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. A thinner wing produces more lift at low speed, delaying the need for high angles of attack (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `C. Thinner wings have higher torsional stiffness, resisting aileron reversal (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Thin wings reduce the wing's overall weight, reducing the cruise Mach needed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Maximum thrust with highest SFC (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `B. Maximum SFC (least efficient) (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`,
    `C. Minimum SFC — the engine is at its thermodynamic design point with highest overall pressure ratio and thermal efficiency`,
    `D. Maximum thrust and minimum SFC simultaneously (this is not technically accurate in this scenario) (this does not apply in this scenario)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. Engines are above normal idle before the takeoff call (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `C. Any door open warning is active anywhere on the aircraft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Either engine is below 60% N2 during the takeoff roll (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Has no effect on jet aircraft — only piston aircraft are affected by wind (this is not technically accurate in this scenario)`,
  ...
  },
  {
    ...
    `B. The aircraft descends below the altitude set in the FMC (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. The aircraft exceeds the maximum angle of bank in the approach configuration (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. The selected approach speed falls below 1.3 × VS (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Only rudder deflection — no other trim input is needed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Full rudder and full aileron held continuously — no trim is possible in asymmetric flight (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Rudder input only; no pitch trim is affected by asymmetric flight (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. The APU only — main engine bleed reserved for anti-icing (this is not technically accurate in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. Each channel controls a separate flight control surface (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. More channels provide faster control response for Cat III precision (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. ATC requires confirmation from multiple channels before clearing Cat III approaches (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Provide thrust for taxiing when main engines are shut down (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `C. Charge the main aircraft batteries only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Provide hydraulic power for landing gear retraction after takeoff (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Cabin pressure from becoming higher than ambient during rapid descent to low altitude (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `C. Passenger hypoxia by maintaining minimum cabin pressure at all altitudes (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `D. Pressurisation over-cooling by releasing hot bleed air (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. It is made of a special alloy that resists flutter at all speeds (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. It uses an automatic servo to prevent the crew from over-rotating (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `D. It has a separate elevator and stabiliser that move simultaneously in the same direction (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. The elevator is ineffective at low speed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Below VMD, parasite drag increases faster than induced drag decreases (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. The aircraft enters Dutch roll below VMD (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    question: `The distinction between anti-icing and de-icing systems is:`,
    options: [
    `A. Anti-icing is used only on the ground; de-icing is used only in flight (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. Anti-icing uses bleed air; de-icing always uses electrical power (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `D. Anti-icing protects only the wing; de-icing protects only the tail (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. The aircraft reaches its maximum certified altitude (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `B. The aircraft is too heavy to maintain altitude at its maximum certified Mach (this does not apply in this scenario) (this is not technically correct here)`,
    ...
    `D. Engine thrust becomes insufficient to maintain level flight (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. 1.3 × VS in the clean configuration (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `B. VMCA — the air minimum control speed from the AFM (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `C. 1.5 × stall speed in landing configuration (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
  ...
  },
  {
    ...
    options: [
    `A. 19% higher (this does not apply in this scenario) (this is not technically correct here)`,
    `B. 41% higher — VS_turn = VS_level × √n = VS × √2 = 1.41 × VS`,
    `C. 60% higher — same number as the bank angle (this does not apply in this scenario)`,
    `D. 30% higher — approximately half the bank angle (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Maintains constant engine EPR — this is not the correct procedure per the applicable standard in normal operations (this is not the primary function described)`,
    `C. Holds the manually set thrust without adjustment (this is not technically accurate in this scenario)`,
  ...
  },
  {
    ...
    `B. Maintains a fixed thrust setting regardless of airspeed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. Controls speed by adjusting pitch, with thrust fixed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Only operates during the approach phase — not active in cruise (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    `B. The cabin fills with toxic fumes during decompression (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. Cold air entering the cabin at decompression altitude causes immediate frostbite (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. High-altitude airflow creates suction that can eject unsecured items through any opening (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    `D. Wing aspect ratio increases (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    `B. Friction drag only — all other drag types are accounted for in the lift calculation (this is not technically accurate in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. 1.0 g — same as level flight (this does not apply in this scenario)`,
    `B. 1.41 g — load factor n = 1/cos(45°) = 1/0.707 = 1.41`,
    `C. 2.0 g — load factor doubles every 30° of bank (this does not apply in this scenario)`,
    `D. 0.71 g — vertical lift component is reduced (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Prevent arcing by using only direct current throughout the aircraft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Install all wiring in grounded metallic conduits (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Limit maximum voltage to 28V DC (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Higher weight (W) — heavier aircraft experience greater gust forces (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `C. Higher sweep angle — sweep directly increases gust response (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Lower aspect ratio — shorter wingspan reduces gust exposure (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. VMD — minimum drag gives maximum range (this does not apply in this scenario) (this is not technically correct here)`,
    `B. Maximum speed — less time in headwinds (this does not apply in this scenario) (this is not technically correct here)`,
    `C. Minimum speed above stall — slowest speed burns least fuel (this does not apply in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. Hydraulic pressure decreases as the aircraft slows (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario) (this is not technically correct here)`,
    `B. The reverse thrust buckets mechanically lose effectiveness below 80 kt (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. Anti-skid automatically reduces brake pressure when reverse thrust is applied (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
  ...
  },
  {
    ...
    `B. Friction pads mechanically applied by cables from the cockpit — this is not correct under the conditions described in the applicable MOS — this is not the correct procedure per the applicable standard (this is not the primary function described)`,
  ...
  },
  {
    ...
    `B. Remain constant — Mach is constant so IAS is constant (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. Decrease — the aircraft is descending so it is slowing down (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Remain at VMO — the autopilot limits IAS to VMO throughout the descent (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Has a higher approach speed but steeper glideslope (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`,
    `B. Has the same approach speed but longer landing distance due to higher drag (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    ...
    `D. Can only be used at aerodromes below 3,000 ft elevation due to engine power requirements (this is not technically accurate in this scenario) (this does not apply in this scenario)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    `B. A power surge in the autopilot computer sends maximum signal to all surfaces simultaneously (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `C. A hardover only occurs when the autopilot is disconnected and surfaces spring to neutral (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Hardover failures are prevented by dual-redundant computers and cannot occur in flight (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. The dihedral effect being too weak on swept wings (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. Excessive fin area that overreacts to sideslip (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `D. Insufficient torsional stiffness in the swept wing structure (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    `B. Slightly heavier stick forces requiring more pilot strength — this is not the correct procedure per the applicable standard in normal operations under standard conditions per the flight manual in normal operations (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Provide primary pitch control — elevators are for fine adjustment only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. Increase pitch stability by moving the tailplane aerodynamic centre aft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `C. Provide additional lift at low speed by acting as a second lifting surface (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
  ...
  },
  {
    ...
    options: [
    `A. Engine slipstream deflecting airflow toward the wingtips (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Wing washout creating a spanwise pressure gradient (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. The wingtip vortex drawing flow outward along the lower surface only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. V (kt) = 7.7 × √(tyre pressure in PSI) (this does not apply in this scenario) (this is not technically correct here)`,
    `B. V (kt) = 9 × √(tyre pressure in PSI) — for example, 200 PSI tyre: 9 × √200 = 9 × 14.1 ≈ 127 kt`,
    `C. V (kt) = tyre pressure (PSI) / 2 (this does not apply in this scenario) (this is not technically correct here)`,
    `D. V (kt) = 6 × tyre pressure / 10 (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Hold the current magnetic heading regardless of wind (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Track a specific ground track accounting for wind drift (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Turn at maximum rate 1 to the selected heading (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Engines above idle before the takeoff call (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. Any door open warning anywhere on the aircraft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `D. Either engine below 60% N2 during the takeoff roll (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. The reverser would overspeed the engine if deployed in flight (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. The reverser is aerodynamically shaped only for ground use and would stall in flight (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `D. Regulatory prohibition on in-flight reverser use is simply a convention without aerodynamic justification (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. The fan speed exceeding the maximum certified N1 limit (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Over-cooling of the compressor causing ice formation on the blades (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. The combustion chamber reaching maximum operating temperature (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Calendar time — every 2 years regardless of operation (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Total fuel consumed since new only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario) (this is not technically correct here)`,
    `D. Average cruise EGT measured over the preceding 100 hours (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Percentage is easier to read under high workload (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. ATC requires percentage RPM for noise abatement (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Percentage RPM is standardised across all turbofan manufacturers (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. The aircraft from being too light for safe operation (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario) (this is not technically correct here)`,
    ...
    `C. Fuel contamination from excessive payload density (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario) (this is not technically correct here)`,
    `D. The CG from moving too far aft with heavy cargo in the rear hold (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. The headwind increases aerodynamic drag on the airframe (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Headwind increases turbulence which increases fuel burn (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Headwind requires higher thrust to maintain the same IAS (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Allow emergency fuel dumping to extinguish a wing fire — this does not apply in the scenario described in normal operations under standard conditions per the flight manual in normal operations (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. The APU cannot start above FL250 (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. APU bleed air is contaminated above FL250 (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. CASR prohibits APU bleed air above FL250 for all aircraft (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Each system operates independently with no interaction (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. The FMS controls the autopilot directly; the AT is manual only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. The autopilot controls the FMS routing; the AT controls autopilot pitch (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
    `A. Indicate that the aircraft has fully stalled and recovery is required (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `B. Warn of approaching VMO (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `D. Signal that flap extension is required for approach (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. Aircraft weight alone — heavier aircraft have lower RTO speed limits (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `C. Maximum brake pressure multiplied by wheel contact area (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Runway slope and temperature only (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Electrically heated elements embedded in the leading edge skin (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. A chemical spray of glycol solution through porous panels (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Infrared lamps inside the wing illuminating the leading edge from inside (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. No action required — the autopilot manages everything to landing (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Manage radio communications only — all other tasks are automated (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Manually fly while the autopilot monitors for failures (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. The ratio of N1 rotational speed to N2 rotational speed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `C. The ratio of combustion chamber pressure to ambient pressure (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Fan inlet total pressure to compressor exit total pressure (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Hydraulic fluid temperature is controlled in the gear actuation system (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `C. The rate of gear retraction is controlled to prevent aerodynamic buffet (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Alternate gear extension is automatically selected if the primary system fails (this does not apply in this scenario) (this is not technically correct here)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Incorrect trim slows the aircraft's acceleration on the takeoff roll (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Incorrect trim prevents the autothrottle from engaging properly (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Trim errors are automatically detected and corrected by the flight management system (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. The tailplane stalls at high Mach due to the wing wake (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. High Mach compresses the fuselage, moving the CG forward (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. The elevator loses effectiveness at high Mach, preventing pitch correction (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Modern alloys have melting points above 2,000°C, eliminating the need for cooling (this is not technically accurate in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. Swept wings have less surface area exposed to the airflow (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Swept wings operate at lower Reynolds numbers, reducing aerodynamic efficiency (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. The swept wing's longer structural path reduces effective chord length (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. The nosewheel being aerodynamically unstable above 100 kt (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. Asymmetric thrust causing the nosewheel to oscillate (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. Wet runway conditions causing the nosewheel to hydroplane and oscillate (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`
    ],
    correct: 1,
  ...
  },
  {
    question: `An autopilot hardover failure means:`,
    options: [
    `A. The autopilot disengages from all modes simultaneously (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`,
    ...
    `C. The autopilot freezes in the current position without further authority (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `D. A fail-passive failure causing disconnect without any control surface input (this is not technically accurate in this scenario) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. Autopilot gain is reduced at high altitude to prevent over-control (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`,
    `B. Aircraft weight is lower at high altitude reducing inertia and increasing susceptibility (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `C. High altitude reduces tail moment arm effectiveness due to compressibility (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. The T-tail creates excessive trim force at high speed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. The T-tail moment arm is shorter than a conventional tail, reducing pitch stability (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `D. The T-tail traps airflow above the fuselage at high AoA (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. Volume flow is easier to measure than mass flow (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. Mass flow indicators are simpler and less expensive (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `C. Volume flow is only available during refuelling — not during flight (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
  ...
  },
  {
    ...
    options: [
    `A. Zero thrust means no drag from the failed engine nacelle (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. A windmilling engine provides useful lift through the fan bypass stream (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. Zero thrust has no performance effect — only the yawing moment matters (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Control the amount of fuel entering the combustion chamber — this is not the correct procedure per the applicable standard in normal operations under standard conditions per the flight manual in normal operations (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Manually reducing thrust lever position to a preset value (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `C. Reducing N1 limit by a fixed percentage set by maintenance (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Automatically activating after V1 to reduce engine wear during the climb (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. It is the altitude at which the aircraft transitions from climbing to cruise (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    ...
    `C. It is the altitude at which swept-wing aircraft first experience Dutch roll (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context)`,
    `D. It is the altitude at which aileron reversal first becomes a risk (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Maintains a constant thrust rating regardless of speed (this is not technically accurate in this scenario) (this does not apply in this scenario)`,
    `C. Maintains constant engine EPR (this is not technically accurate in this scenario) (this does not apply in this scenario) (this is not technically correct here)`,
    `D. Holds the manually set thrust — does not adjust automatically (this is not technically accurate in this scenario) (this does not apply in this scenario)`
    ],
    correct: 0,
  ...
  },
  {
    ...
    `B. Reversing engine rotation direction to push air forward — this does not apply in the scenario described in normal operations under standard conditions (this is not the primary function described)`,
  ...
  },
  {
    ...
    options: [
    `A. Increasing the overall wing chord and therefore wing area (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario) (this is not technically correct here)`,
    ...
    `C. Reducing the camber of the leading edge, allowing lower approach speeds (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `D. Deflecting the leading edge downward to increase the effective angle of attack at low speed (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
    `A. An accurate weight measurement for W&B purposes (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    `B. Automatic gear retraction after takeoff at a preset height (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`,
    ...
    `D. Brake temperature monitoring to prevent brake overuse on the ground (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard) (this is incorrect in this context) (this does not apply in this scenario)`
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
    `A. 10,000 ft altitude — a regulatory requirement (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    ...
    `C. FL290 — the base of the reduced vertical separation standard airspace (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`,
    `D. When the crew selects it manually — there is no automatic switching (this does not apply in this scenario) (this is not technically correct here) (this is not the applicable standard)`
    ],
    correct: 1,
  ...
  },
  {
    ...
    `B. Ailerons become aerodynamically balanced at high speed and deflect in the wrong direction (this is not technically accurate in this scenario)`,
    `C. High-speed airflow causes flow separation over the ailerons making them ineffective — this is incorrect and not supported by the AAGA MOS requirements in normal operations under standard conditions (this is not the primary function described)`,
