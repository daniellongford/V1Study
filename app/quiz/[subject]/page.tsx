...
const freeQuestions: Record<string, any[]> = {
  ...
  'Meteorology': [
    ...
    { question: 'What does TSRA mean in a METAR?', options: ['A. Thunderstorm with rain', 'B. Tropical storm with rain', 'C. Towering storm rain advisory', 'D. Thunderstorm in the vicinity with rain'], correct: 0, explanation: 'TSRA is a METAR present weather code meaning Thunderstorm with Rain, combining the TS descriptor with RA for rain.', reference: 'AIP GEN 3.5 / BOM METAR decoding guide' },
  ...
  'Navigation': [
    ...
    { question: 'What is magnetic variation?', options: ['A. The error in the compass caused by the aircraft own magnetic fields', 'B. The angular difference between true north and magnetic north', 'C. The difference between compass heading and track', 'D. The change in magnetic field strength with altitude'], correct: 1, explanation: 'Magnetic variation is the angular difference between true north and magnetic north. It must be applied to convert true headings to magnetic headings.', reference: 'AIP GEN 2.2' },
    { question: 'What is the 1-in-60 rule used for?', options: ['A. Calculating fuel reserves for 60 minutes', 'B. Estimating track error and heading correction', 'C. Determining obstacle clearance', 'D. Calculating rate of climb over 60 nm'], correct: 1, explanation: 'The 1-in-60 rule states that for every 60 nm travelled, 1 nm off track equals 1 degree of heading error. Used to calculate corrections to regain track.', reference: 'CASA CPL Navigation Study Guide' },
    { question: 'What is LSALT?', options: ['A. Altitude providing 1000 ft terrain clearance within 5 nm either side of track', 'B. Altitude providing 1000 ft clearance within 25 nm in mountainous terrain', 'C. Lowest Standard Assigned Level and Track', 'D. An altitude issued by ATC guaranteeing terrain separation'], correct: 0, explanation: 'LSALT provides a minimum of 1000 ft terrain and obstacle clearance within 5 nm either side of track or 10 nm in mountainous areas.', reference: 'AIP ENR 1.1 / CASR Part 91' },
    { question: 'What is Decision Altitude on a precision approach?', options: ['A. Altitude at which the crew must decide to divert', 'B. Altitude at which the approach must be abandoned if visual reference is not established', 'C. Lowest altitude on a non-precision approach', 'D. Altitude at which autopilot must be disconnected'], correct: 1, explanation: 'DA is the altitude on a precision approach at which the crew must decide whether to continue based on visual reference or execute a missed approach.', reference: 'ICAO Doc 8168 / AIP ENR 1.5' },
    { question: 'What is the Transition Altitude in Australia?', options: ['A. The altitude at which crews switch from QNH to standard pressure 1013 hPa', 'B. The altitude at which ATC hands off to the next sector', 'C. The height above which terrain separation is guaranteed', 'D. The altitude at which GPWS activates'], correct: 0, explanation: 'The Transition Altitude is the altitude at or below which vertical position is controlled by QNH. Above it, aircraft use flight levels referenced to standard pressure 1013.25 hPa.', reference: 'AIP ENR 1.7' },
    { question: 'What is compass deviation?', options: ['A. The difference between true and magnetic north', 'B. Error in the compass caused by the aircraft own magnetic fields', 'C. Wobble of the compass card in turbulence', 'D. The angle between magnetic and grid north'], correct: 1, explanation: 'Compass deviation is the error caused by the aircraft own electrical equipment and ferrous metals. It is recorded on a compass deviation card.', reference: 'Navigation / CASA CPL Study Guide' },
    { question: 'What does climb via SID require?', options: ['A. Climb to cleared altitude using any route', 'B. Comply with all published lateral AND vertical constraints on the SID', 'C. Climb on runway heading until advised', 'D. Comply with lateral routing only'], correct: 1, explanation: 'Climb via SID requires compliance with all published lateral routing and vertical altitude and speed constraints on the SID plus the cleared final altitude.', reference: 'AIP ENR 1.1 / ICAO Doc 4444' },
    { question: 'On an ILS, what does a full-scale fly-up glideslope deflection indicate?', options: ['A. Aircraft is above the glideslope', 'B. Aircraft is below the glideslope', 'C. Aircraft is on glideslope but ILS is flagged', 'D. Aircraft is too close to the threshold'], correct: 1, explanation: 'A fly-up deflection of the glideslope needle indicates the aircraft is BELOW the glideslope and must climb. The needle always points toward where the aircraft needs to go.', reference: 'AIP ENR 1.5 / ICAO Doc 8168' },
    { question: 'What is the difference between a rhumb line and a great circle?', options: ['A. A rhumb line is the shortest distance, a great circle crosses meridians at the same angle', 'B. A great circle is the shortest distance on a sphere, a rhumb line crosses all meridians at the same angle', 'C. They are identical at latitudes below 60 degrees', 'D. A great circle is only used for polar navigation'], correct: 1, explanation: 'A great circle is the shortest distance between two points on a sphere. A rhumb line maintains a constant heading but is a longer path at most latitudes.', reference: 'CASA Navigation Study Guide' },
  ],
  'Aircraft General Knowledge': [
    { question: 'What does the pitot-static system provide?', options: ['A. Attitude information to the flight director', 'B. Airspeed, altitude, and vertical speed inputs to flight instruments', 'C. Pressurised air to the cabin at altitude', 'D. Engine intake total pressure for fuel control'], correct: 1, explanation: 'The pitot-static system supplies total pitot and static pressure to the ASI, altimeter, and VSI. The difference between total and static gives indicated airspeed.', reference: 'CASA AGK Study Guide' },
    { question: 'What is pressure altitude?', options: ['A. Altitude shown when set to local QNH', 'B. Altitude indicated when the altimeter is set to 1013.25 hPa', 'C. Altitude corrected for temperature above MSL', 'D. Height above the aerodrome reference point'], correct: 1, explanation: 'Pressure altitude is the altitude indicated when the altimeter subscale is set to 1013.25 hPa standard pressure. Used for performance calculations and above the transition altitude.', reference: 'CASA AGK / AIP ENR 1.7' },
    { question: 'What is the effect of high density altitude on aircraft performance?', options: ['A. Performance improves as reduced density means less drag', 'B. Performance deteriorates with reduced engine power, thrust, and aerodynamic lift', 'C. Performance is unaffected if the aircraft is turbocharged', 'D. Only jet performance is affected'], correct: 1, explanation: 'High density altitude means less dense air, reducing engine power, propeller efficiency, and aerodynamic lift, resulting in longer takeoff runs and reduced climb rates.', reference: 'CASA AGK / Performance Study Guide' },
    { question: 'What is the purpose of static dischargers?', options: ['A. To provide a ground path for lightning', 'B. To dissipate static electricity reducing radio interference', 'C. To measure atmospheric electricity', 'D. To protect the fuel system from electrostatic ignition'], correct: 1, explanation: 'Static dischargers dissipate the electrostatic charge that builds on the airframe during flight, reducing interference with communication and navigation radios.', reference: 'CASA AGK Study Guide' },
    { question: 'What is VMO/MMO?', options: ['A. Variable Maximum Output, the rated continuous power', 'B. Maximum Operating Speed/Mach number which must not be exceeded in normal operations', 'C. Speed at which maximum lift-to-drag ratio is achieved', 'D. Speed at which landing gear must be retracted'], correct: 1, explanation: 'VMO is the Maximum Operating indicated airspeed and MMO is the Maximum Operating Mach number. Neither must be exceeded in normal operations to avoid structural overstress.', reference: 'Aircraft Flight Manual / CASA AGK Study Guide' },
    { question: 'What does a cockpit voice recorder capture?', options: ['A. ATC communications only', 'B. Cockpit audio including crew conversation, radio calls, and audio warnings for accident investigation', 'C. Live crew communications for quality assurance', 'D. Checklists for crew use'], correct: 1, explanation: 'A CVR captures the last 2 hours minimum of cockpit audio including crew conversations, radio communications, and cockpit sounds, used by accident investigators.', reference: 'CASR Part 91 / ICAO Annex 6' },
    { question: 'What is the purpose of ground spoilers on landing?', options: ['A. To provide aerodynamic braking by increasing drag only', 'B. To destroy lift immediately after touchdown, increasing weight on wheels for more effective braking', 'C. To assist roll control at low speeds on the runway', 'D. To prevent bouncing on landing'], correct: 1, explanation: 'Ground spoilers deploy on touchdown to destroy residual wing lift, rapidly transferring the aircraft full weight to the wheels, dramatically improving brake effectiveness.', reference: 'CASA AGK Study Guide / Aircraft Systems' },
    { question: 'What is the function of a hydraulic accumulator?', options: ['A. Filters hydraulic fluid contaminants', 'B. Stores hydraulic pressure to absorb surges and provide emergency power', 'C. Regulates system pressure to a constant level', 'D. Converts mechanical energy to hydraulic pressure'], correct: 1, explanation: 'A hydraulic accumulator stores pressurised fluid using a gas charge. It absorbs pressure surges, supplements pump output during high demand, and provides limited backup pressure.', reference: 'CASA AGK Study Guide / Aircraft Hydraulic Systems' },
    { question: 'What is compressor stall in a gas turbine engine?', options: ['A. Engine failing to start due to insufficient airflow', 'B. Disruption to smooth compressor airflow causing separation and possible flame extinction', 'C. Over-revving beyond rated RPM', 'D. Icing of compressor inlet guide vanes'], correct: 1, explanation: 'Compressor stall occurs when blade angle of attack exceeds the critical angle, causing airflow separation. Symptoms include loud bangs, vibration, and thrust loss.', reference: 'CASA AGK Study Guide / Gas Turbine Engines' },
    { question: 'What does MEL stand for and what is its purpose?', options: ['A. Maximum Equipment List, heaviest items permitted', 'B. Minimum Equipment List, specifies equipment that may be inoperative for dispatch within safety limits', 'C. Mandatory Equipment List, must be operational at all times', 'D. Maintenance Entry Log, record of maintenance actions'], correct: 1, explanation: 'The Minimum Equipment List allows an operator to dispatch an aircraft with certain specified equipment inoperative, provided conditions and limitations in the MEL are met.', reference: 'CASR Part 42 / AC 43-10' },
  ],
  'Flight Rules & Air Law': [
    { question: 'Under CASR Part 61, what is the minimum age for a CPL Aeroplane?', options: ['A. 17 years', 'B. 18 years', 'C. 19 years', 'D. 21 years'], correct: 1, explanation: 'CASR Part 61.415 specifies that an applicant for a CPL Aeroplane must be at least 18 years of age at the time of grant.', reference: 'CASR Part 61.415' },
    ...
    { question: 'What is required to enter Class C airspace VFR?', options: ['A. No clearance needed if clear of cloud', 'B. ATC clearance and two-way radio communication', 'C. Only a radio call to advise of intentions', 'D. An IFR flight plan must be filed'], correct: 1, explanation: 'Class C airspace requires an ATC clearance and established two-way radio communication before entry for all aircraft including VFR.', reference: 'AIP ENR 1.4' },
    { question: 'Who is responsible for the safe conduct of a flight under CASR?', options: ['A. The operator only', 'B. The pilot in command', 'C. ATC when in controlled airspace', 'D. The chief pilot of the operator'], correct: 1, explanation: 'CASR Part 91.085 establishes that the pilot in command is responsible for the safe conduct of the flight and has final authority on all matters relating to its operation.', reference: 'CASR Part 91.085' },
    { question: 'What is the minimum weather for VFR flight departing a non-controlled aerodrome by day?', options: ['A. 1500 m visibility and clear of cloud', 'B. 5000 m visibility and 1000 ft ceiling', 'C. 3000 m visibility and 500 ft ceiling', 'D. 8 km visibility and no restrictions'], correct: 0, explanation: 'For VFR flight outside controlled airspace below 3000 ft AMSL or 1000 ft AGL, the minimum is 1500 m flight visibility and clear of cloud.', reference: 'AIP ENR 1.2' },
    ...
    { question: 'What is the legal significance of AFM limitations?', options: ['A. Advisory only, pilots may deviate at discretion', 'B. Legally binding, operating outside AFM limits is illegal', 'C. Mandatory for RPT but advisory for charter', 'D. Applies only to aircraft over 5700 kg MTOW'], correct: 1, explanation: 'The AFM is an approved document and its limitations are legally binding. Operating outside AFM limitations constitutes an illegal operation under CASR.', reference: 'CASR Part 21 / CASR Part 91' },
    { question: 'What ELT is required for Australian RPT operations under CAO 20.7.4?', options: ['A. A portable ELT stored in the cabin', 'B. A fixed ELT operating on 406 MHz', 'C. Any ELT approved under FAA regulations', 'D. An ELT on 121.5 MHz only'], correct: 1, explanation: 'CAO 20.7.4 requires RPT aircraft to be fitted with a fixed 406 MHz ELT that meets the relevant TSO standard and is registered with AMSA.', reference: 'CAO 20.7.4' },
    { question: 'Can a pilot exercise CPL privileges without a valid Class 1 medical?', options: ['A. Yes for 30 days', 'B. No, CPL privileges cannot be exercised without a valid medical', 'C. Yes if they notify CASA within 7 days', 'D. Yes for 90 days if they self-declare fitness'], correct: 1, explanation: 'A pilot must hold a current medical certificate appropriate to their licence to exercise its privileges. Without a valid Class 1 medical, CPL privileges cannot be exercised.', reference: 'CASR Part 67 / CASR 61.045' },
    { question: 'What is the minimum total flight time for an ATPL Aeroplane under CASR?', options: ['A. 1000 hours', 'B. 1500 hours with specific requirements', 'C. 1200 hours', 'D. 2000 hours'], correct: 1, explanation: 'CASR Part 61.480 requires a minimum of 1500 hours total flight time including specific requirements for cross-country, night, and instrument flight time.', reference: 'CASR Part 61.480' },
  ],
  'Operations, Performance and Planning': [
    { question: 'What is the minimum fuel reserve for a VFR day flight in a single-engine aeroplane?', options: ['A. 30 minutes at cruise power', 'B. 45 minutes at cruise power', 'C. 20 minutes at cruise power', 'D. 10% of total fuel uplifted'], correct: 1, explanation: 'Under CASR Part 91 / CAO 20.9, single-engine aeroplanes on VFR day flights must carry sufficient fuel to reach the destination plus at least 45 minutes reserve at cruise power.', reference: 'CASR Part 91 / CAO 20.9' },
    { question: 'What is Zero Fuel Weight?', options: ['A. Weight of the aircraft with no passengers', 'B. Maximum weight before any usable fuel is added with crew, pax, cargo but no fuel', 'C. Weight when tanks are empty after flight', 'D. Aircraft empty weight only'], correct: 1, explanation: 'Zero Fuel Weight is the total weight loaded with crew, passengers, baggage, and cargo but with no usable fuel. It must not exceed the Maximum Zero Fuel Weight in the AFM.', reference: 'AFM / CASA Performance Study Guide' },
    ...
    { question: 'What is the significance of moment in mass and balance?', options: ['A. The time at which CG shifts during flight', 'B. Product of a weight and its arm from the datum, used to calculate CG position', 'C. Angular momentum of the aircraft in a turn', 'D. Rate of change of aircraft weight as fuel burns'], correct: 1, explanation: 'Moment = weight x arm distance from the datum. Summing all moments and dividing by total weight gives CG position. CG within limits is critical for controllability.', reference: 'CASA Performance and Mass and Balance Study Guide' },
    { question: 'What is the effect of a forward centre of gravity?', options: ['A. Increased stability but reduced control authority and increased trim drag', 'B. Decreased stability and lighter control forces', 'C. Improved fuel efficiency due to reduced induced drag', 'D. No effect, CG only affects weight and balance limits'], correct: 0, explanation: 'A forward CG increases longitudinal stability but requires more up-elevator trim, increasing trim drag. It may also reduce elevator effectiveness at low speeds.', reference: 'CASA Performance and Mass and Balance Study Guide' },
    { question: 'What is the standard contingency fuel for an IFR flight under CASR?', options: ['A. 5% of trip fuel or 5 minutes at cruise, whichever is greater', 'B. 10% of trip fuel', 'C. A fixed 30 minutes at holding speed', 'D. 2% of trip fuel per hour of flight'], correct: 0, explanation: 'Under CASR / CAO 20.9, contingency fuel for IFR operations is the greater of 5% of trip fuel or 5 minutes of flight at cruise consumption.', reference: 'CAO 20.9 / CASR Part 91' },
    { question: 'What is trip fuel for a VFR cross-country flight?', options: ['A. Total fuel on board at departure', 'B. Fuel from engine start at departure to landing at destination including taxi', 'C. Fuel from top of climb to top of descent only', 'D. Fuel from brake release to runway threshold'], correct: 1, explanation: 'Trip fuel is the total fuel from engine start at departure to landing at destination, including taxi, takeoff, climb, cruise, descent, and approach but excluding reserve fuel.', reference: 'CASR Part 91 / CAO 20.9' },
    ...
    { question: 'What is V1 in jet aircraft performance?', options: ['A. Speed at which the aircraft becomes airborne', 'B. Takeoff Decision Speed, above V1 the takeoff must continue, below it may be rejected', 'C. Speed at which flaps must be retracted', 'D. Speed at which the nose wheel lifts off'], correct: 1, explanation: 'V1 is the Takeoff Decision Speed. If engine failure occurs before V1, the takeoff may be rejected. At or after V1, insufficient runway remains to stop and the takeoff must continue.', reference: 'CASR / AFM / CASA Performance Study Guide' },
    { question: 'What is the purpose of alternate fuel in an IFR fuel plan?', options: ['A. Extra fuel for ATC holding at destination', 'B. Fuel to fly from destination to the nominated alternate and conduct an approach', 'C. Reserve fuel for taxi and start-up', 'D. 10% contingency added to trip fuel'], correct: 1, explanation: 'Alternate fuel is the quantity required to fly from the destination following a missed approach to the nominated alternate and conduct an approach and landing there.', reference: 'CASR Part 91 / CAO 20.9' },
  ],
  'Flight Planning': [
    { question: 'What is the minimum fuel reserve for a VFR day flight in a single-engine aeroplane?', options: ['A. 30 minutes at cruise power', 'B. 45 minutes at cruise power', 'C. 20 minutes at cruise power', 'D. 10% of total fuel uplifted'], correct: 1, explanation: 'Under CASR Part 91 / CAO 20.9, single-engine aeroplanes on VFR day flights must carry sufficient fuel to reach the destination plus at least 45 minutes reserve at cruise power.', reference: 'CASR Part 91 / CAO 20.9' },
    { question: 'What is Zero Fuel Weight?', options: ['A. Weight of the aircraft with no passengers', 'B. Maximum weight before any usable fuel is added', 'C. Weight when tanks are empty after flight', 'D. Aircraft empty weight only'], correct: 1, explanation: 'Zero Fuel Weight is the total weight loaded with crew, passengers, baggage, and cargo but with no usable fuel. It must not exceed the MZFW in the AFM.', reference: 'AFM / CASA Performance Study Guide' },
    { question: 'What is V1 in jet aircraft performance?', options: ['A. Speed at which the aircraft becomes airborne', 'B. Takeoff Decision Speed, above V1 the takeoff must continue', 'C. Speed at which flaps must be retracted', 'D. Speed at which the nose wheel lifts off'], correct: 1, explanation: 'V1 is the Takeoff Decision Speed. If engine failure occurs before V1, the takeoff may be rejected. At or after V1, the takeoff must continue.', reference: 'CASR / AFM / CASA Performance Study Guide' },
    { question: 'What is the balanced field length concept?', options: ['A. A runway length balancing needs of arriving and departing aircraft', 'B. Runway length where accelerate-stop distance equals takeoff distance with one engine inoperative', 'C. A runway with equal headwind and crosswind components', 'D. Total runway length divided equally between TORA and clearway'], correct: 1, explanation: 'Balanced field length is achieved when V1 is selected so that the distance to accelerate to V1 and stop equals the distance to continue the takeoff on one engine.', reference: 'CASA Performance Study Guide / AC 21-4' },
      ...
      <div style={{background:'white',borderRadius:'16px',padding:'2.5rem',maxWidth:'500px',width:'100%',border:'1px solid #e2e8f0',textAlign:'center'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'10px',marginBottom:'2rem'}}>
          ...
          <div style={{background:'#fff1f2',borderRadius:'8px',padding:'12px'}}>
            <div style={{fontSize:'24px',fontWeight:'600',color:'#dc2626'}}>{questions.length-score}</div>
