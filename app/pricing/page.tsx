...
const plans = [
  {
    ...
    color: '#10b981',
    description: 'Perfect for student pilots taking their first theory exam',
    features: ['PPL Theory exam', 'Unlimited questions', 'Full explanations', 'CASA references', '7 day free trial'],
  },
  {
    name: 'CPL Pack',
    price: '$19.99',
    ...
    features: ['PPL + all 7 CPL exams', 'Unlimited questions', 'Progress tracking', 'Weak area analysis', '7 day free trial'],
  },
  {
    name: 'ATPL Pack',
    price: '$29.99',
    ...
    features: ['PPL + CPL + all 7 ATPL exams', 'Unlimited questions', 'Progress tracking', 'Weak area analysis', '7 day free trial'],
  },
  {
    ...
    color: '#f59e0b',
    description: 'Just need your Instrument Rating? This is for you',
    features: ['IREX exam only', 'Unlimited questions', 'Full explanations', 'CASA references', '7 day free trial'],
  },
  {
    name: 'Full Access',
    price: '$34.99',
    ...
    features: ['All 16 exams included', 'PPL + CPL + ATPL + IREX', 'Unlimited questions', 'Priority support', '7 day free trial'],
  },
]
    ...
    <main style={{minHeight:'100vh',background:'#f8fafc',fontFamily:'system-ui,sans-serif'}}>
      ...
      <div style={{maxWidth:'1100px',margin:'0 auto',padding:'3rem 2rem'}}>
        <div style={{textAlign:'center',marginBottom:'3rem'}}>
          ...
          <p style={{fontSize:'18px',color:'#64748b',maxWidth:'600px',margin:'0 auto'}}>Start with a 7 day free trial. Cancel anytime. No credit card required to start.</p>
        </div>
          ...
          {plans.map((plan) => (
            <div key={plan.name} style={{background:'white',borderRadius:'16px',padding:'1.5rem',border:plan.popular?'2px solid #2563eb':'1px solid #e2e8f0',position:'relative',display:'flex',flexDirection:'column'}}>
              ...
              <button
                ...
                style={{width:'100%',background:plan.popular?'#2563eb':loading===plan.priceId?'#94a3b8':'transparent',color:plan.popular?'white':loading===plan.priceId?'white':plan.color,border:`2px solid ${plan.color}`,borderRadius:'8px',padding:'10px',fontWeight:'600',cursor:loading===plan.priceId?'not-allowed':'pointer',fontSize:'14px'}}
              >
        ...
        <div style={{background:'white',borderRadius:'12px',padding:'2rem',border:'1px solid #e2e8f0',textAlign:'center'}}>
          ...
          <p style={{fontSize:'14px',color:'#64748b',marginBottom:'1rem'}}>Start with the free trial — all subjects included for 7 days with no credit card required.</p>
          <a href="/signup" style={{background:'#0a1628',color:'white',borderRadius:'8px',padding:'12px 32px',textDecoration:'none',fontWeight:'600',fontSize:'15px',display:'inline-block'}}>Start free trial →</a>
        </div>
      </div>
