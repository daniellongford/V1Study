      ...
      <nav style={{background:'white',borderBottom:'1px solid #e2e8f0',padding:'1rem 2rem',display:'flex',alignItems:'center',justifyContent:'space-between'}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:'1rem'}}>
          ...
          <button
            ...
            style={{background:'none',border:'1px solid #e2e8f0',borderRadius:'8px',padding:'6px 14px',fontSize:'13px',cursor:'pointer',color:'#64748b'}}
          >
            Sign out
          </button>
        </div>
          ...
          {Object.keys(subjects).map((licence) => (
            <button
              ...
              style={{
                ...
                fontSize:'14px',
                cursor:'pointer',
                background: selectedLicence === licence ? '#2563eb' : '#e2e8f0',
